# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM - Create symbol and physical representation for RF mixer and oscillator
...
Create original, electrically unambiguous schematic and recognizable physical representations for **RF mixer and oscillator**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-shared-f0-sym.md`
...
- One original `sym-rf-communications-rf-mixer-oscillator` schematic definition with anchors for `IN:RF_IN` (passive; rf/electrical/communications), `OUT:RF_OUT` (passive; rf/electrical/communications), `GND:GROUND` (reference; rf/electrical/communications).
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM`: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, fidelity `F0`, concern `SYM`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, `F0`, and `SYM`.
