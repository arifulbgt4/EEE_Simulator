# CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION - Validate Vacuum tube F5
...
Produce independent validation evidence for **Vacuum tube** at **F5** without modifying the model under test.
...
- Stable family: `fam-deferred-research-vacuum-tube` (Vacuum tube); task scope: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`; fidelity `F5`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F5 rule: Research tier: execute only through the declared isolated, pinned research adapter and retain its full configuration/provenance; baseline: F5 behavior is supplied only by an approved external vacuum-tube compact/physical model with pinned equations, parameters, provenance, and envelope.
...
- `docs/tasks/models/cmp-deferred-research-vacuum-tube-shared-f5-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RSH-VACUUM_TUBE-NOMINAL`, `GOLD-RSH-VACUUM_TUBE-BOUNDARY`, `GOLD-RSH-VACUUM_TUBE-FAILURE` at `F5`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION`: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, fidelity `F5`, concern `VALIDATION`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-VALIDATION` exists and is limited to shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, `F5`, and `VALIDATION`.
