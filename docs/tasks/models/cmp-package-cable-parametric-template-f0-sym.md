# CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-SYM - Create Parametric cable physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-cable-parametric` - Parametric cable |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-cable-parametric` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-cable-parametric-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-SYM-FAILURE`
