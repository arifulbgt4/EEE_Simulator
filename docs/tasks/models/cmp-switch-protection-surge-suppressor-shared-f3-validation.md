# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION - Validate Surge and ESD suppressor F3
...
Produce independent validation evidence for **Surge and ESD suppressor** at **F3** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected MOV/TVS/GDT/ESD variant uses a bounded nonlinear clamp or trigger relation with explicit leakage, breakdown, energy, and recovery behavior.
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-SURGE_SUPPRESSOR-NOMINAL`, `GOLD-SWP-SURGE_SUPPRESSOR-BOUNDARY`, `GOLD-SWP-SURGE_SUPPRESSOR-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION`: shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F3`, and `VALIDATION`.
