# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT - Define import mapping for Signal generator
...
Implement and validate only the declared external-model mappings for **Signal generator**.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F2`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f2-import.md`
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F2`, concern `IMPORT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-IMPORT` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F2`, and `IMPORT`.
