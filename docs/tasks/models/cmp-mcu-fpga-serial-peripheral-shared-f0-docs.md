# CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS - Document Serial peripheral
...
Publish user and contributor documentation for **Serial peripheral** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-UART-F0-CAT`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-I2C-F0-CAT`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-CAN-F0-CAT`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-USB-F0-CAT`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-MODEL`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-VALIDATION`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-MODEL`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-MODEL`
- `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION`
...
- Stable family: `fam-mcu-fpga-serial-peripheral` (Serial peripheral); task scope: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-mcu-fpga-serial-peripheral`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-mcu-fpga-serial-peripheral-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-mcu-fpga-serial-peripheral.md` for `fam-mcu-fpga-serial-peripheral`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS`: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, fidelity `F0`, concern `DOCS`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, `F0`, and `DOCS`.
