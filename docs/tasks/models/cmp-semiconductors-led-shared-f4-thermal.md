# CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL - Implement Light-emitting diode electrothermal behavior
...
Implement only the F4 power, temperature and electrothermal feedback concern for **Light-emitting diode**.
...
- Stable family: `fam-semiconductors-led` (Light-emitting diode); task scope: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`; fidelity `F4`; concern `THERMAL`.
...
- `docs/tasks/models/cmp-semiconductors-led-shared-f4-thermal.md`
...
- One F4 thermal-state contract for `fam-semiconductors-led` naming P, T, Tamb, Rth, Cth, initial state, valid range, update order, and unsupported coupling behavior.
- Deterministic steady/transient thermal and runaway/limit evidence tied to the exact family reference vectors.
- Scope is limited to `CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL`: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, fidelity `F4`, concern `THERMAL`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-LED-SHARED-F4-THERMAL` exists and is limited to shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, `F4`, and `THERMAL`.
