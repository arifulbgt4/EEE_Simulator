# CMP-PACKAGE-CSP-TEMPLATE-F0-SYM - Create Chip-scale package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-csp` - Chip-scale package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-CSP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-csp` revision `1.0.0` is the only geometry/default source for this task.
- Concern-specific golden references: GRC-052, GRC-054. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-csp-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-SYM-FAILURE`
