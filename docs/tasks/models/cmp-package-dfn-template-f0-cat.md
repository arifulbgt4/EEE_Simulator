# CMP-PACKAGE-DFN-TEMPLATE-F0-CAT - Specify Dual flat no-lead package template
...
- `docs/tasks/models/cmp-package-dfn-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-CAT-FAILURE`
