# CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE - Implement PWM controller failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **PWM controller**.
...
- Stable family: `fam-power-electronics-pwm-controller` (PWM controller); task scope: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-power-electronics-pwm-controller-shared-f4-failure.md`
...
- Scope is limited to `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE`: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, `F4`, and `FAILURE`.
