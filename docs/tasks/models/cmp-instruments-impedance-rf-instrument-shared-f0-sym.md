# CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM - Create symbol and physical representation for Impedance and RF instrument
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Impedance and RF instrument**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-instruments-impedance-rf-instrument` (Impedance and RF instrument); task scope: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-instruments-impedance-rf-instrument-shared-f0-sym.md`
...
- One original `sym-instruments-impedance-rf-instrument` schematic definition with anchors for `CH+:CHANNEL+` (input; measurement/electrical), `CH-:CHANNEL-` (input; measurement/electrical), `COM:COMMON` (reference; measurement/electrical).
...
- Scope is limited to `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM`: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, fidelity `F0`, concern `SYM`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F0-SYM` exists and is limited to shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, `F0`, and `SYM`.
