# CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL - Implement Light-emitting diode F2 model
...
Implement one model tier, **F2**, for **Light-emitting diode** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-semiconductors-led` (Light-emitting diode); task scope: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`; fidelity `F2`; concern `MODEL`.
...
- `docs/tasks/models/cmp-semiconductors-led-shared-f2-model.md`
...
- One `ModelBinding` for `fam-semiconductors-led` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL`: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, fidelity `F2`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-LED-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, `F2`, and `MODEL`.
