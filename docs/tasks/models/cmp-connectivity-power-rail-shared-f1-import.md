# CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT - Define import mapping for Power rail
...
Implement and validate only the declared external-model mappings for **Power rail**.
...
- Stable family: `fam-connectivity-power-rail` (Power rail); task scope: shared family scope across `var-connectivity-power-rail-parameterized-rail`; fidelity `F1`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-connectivity-power-rail-shared-f1-import.md`
...
- Scope is limited to `CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT`: shared family scope across `var-connectivity-power-rail-parameterized-rail`, fidelity `F1`, concern `IMPORT`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT-NOMINAL`
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-POWER-RAIL-SHARED-F1-IMPORT` exists and is limited to shared family scope across `var-connectivity-power-rail-parameterized-rail`, `F1`, and `IMPORT`.
