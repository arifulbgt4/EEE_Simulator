# CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION - Validate Digital pattern source F4
...
Produce independent validation evidence for **Digital pattern source** at **F4** without modifying the model under test.
...
- Stable family: `fam-sources-loads-digital-pattern-source` (Digital pattern source); task scope: shared family scope across `var-sources-loads-digital-pattern-source-pattern`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-sources-loads-digital-pattern-source-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SRC-DIGITAL_PATTERN_SOURCE-NOMINAL`, `GOLD-SRC-DIGITAL_PATTERN_SOURCE-BOUNDARY`, `GOLD-SRC-DIGITAL_PATTERN_SOURCE-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION`: shared family scope across `var-sources-loads-digital-pattern-source-pattern`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-sources-loads-digital-pattern-source-pattern`, `F4`, and `VALIDATION`.
