# CMP-PACKAGE-SOT-23-TEMPLATE-F0-CAT - Specify SOT-23 family package template
...
- `docs/tasks/models/cmp-package-sot-23-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-CAT-FAILURE`
