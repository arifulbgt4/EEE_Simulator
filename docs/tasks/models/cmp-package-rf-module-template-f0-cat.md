# CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-CAT - Specify RF module package template
...
- `docs/tasks/models/cmp-package-rf-module-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-CAT-FAILURE`
