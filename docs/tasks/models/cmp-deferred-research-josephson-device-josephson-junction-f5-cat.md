...
- Stable family: `fam-deferred-research-josephson-device` (Josephson junction device); task scope: variant `var-deferred-research-josephson-device-josephson-junction` (Josephson Junction); fidelity `F5`; concern `CAT`.
...
- Canonical source: [Josephson junction device family-specific implementation reference](../../catalog/families/fam-deferred-research-josephson-device.md#family-specific-implementation-reference), registry row `fam-deferred-research-josephson-device`, and variant `var-deferred-research-josephson-device-josephson-junction` (Josephson Junction).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: F5 behavior uses a pinned Josephson phase/current/voltage relation and external research solver with units, initialization, limits, and provenance.
...
- `docs/tasks/models/cmp-deferred-research-josephson-device-josephson-junction-f5-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-deferred-research-josephson-device-josephson-junction` (Josephson Junction), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-JOSEPHSON-JUNCTION-F5-CAT`: variant `var-deferred-research-josephson-device-josephson-junction` (Josephson Junction), fidelity `F5`, concern `CAT`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-JOSEPHSON-JUNCTION-F5-CAT-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-JOSEPHSON-JUNCTION-F5-CAT-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-JOSEPHSON-JUNCTION-F5-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-JOSEPHSON-JUNCTION-F5-CAT` exists and is limited to variant `var-deferred-research-josephson-device-josephson-junction` (Josephson Junction), `F5`, and `CAT`.
