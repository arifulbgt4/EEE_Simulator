# CMP-PACKAGE-BGA-TEMPLATE-F0-DOCS - Document Ball grid array package
...
- `docs/tasks/models/cmp-package-bga-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-DOCS-FAILURE`
