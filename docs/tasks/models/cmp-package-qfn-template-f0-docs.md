# CMP-PACKAGE-QFN-TEMPLATE-F0-DOCS - Document Quad flat no-lead package
...
- `docs/tasks/models/cmp-package-qfn-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-DOCS-FAILURE`
