# CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION - Validate Transmission line F4
...
Produce independent validation evidence for **Transmission line** at **F4** without modifying the model under test.
...
- Stable family: `fam-passives-transmission-line` (Transmission line); task scope: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-passives-transmission-line-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PAS-TRANSMISSION_LINE-NOMINAL`, `GOLD-PAS-TRANSMISSION_LINE-BOUNDARY`, `GOLD-PAS-TRANSMISSION_LINE-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION`: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, `F4`, and `VALIDATION`.
