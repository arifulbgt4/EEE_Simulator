# CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION - Validate Digital comparator F2
...
Produce independent validation evidence for **Digital comparator** at **F2** without modifying the model under test.
...
- Stable family: `fam-digital-logic-digital-comparator` (Digital comparator); task scope: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`; fidelity `F2`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The selected signed/unsigned equality or magnitude relation maps fixed-width inputs to exact comparison outputs with X propagation.
...
- `docs/tasks/models/cmp-digital-logic-digital-comparator-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-DIG-DIGITAL_COMPARATOR-NOMINAL`, `GOLD-DIG-DIGITAL_COMPARATOR-BOUNDARY`, `GOLD-DIG-DIGITAL_COMPARATOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION`: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, `F2`, and `VALIDATION`.
