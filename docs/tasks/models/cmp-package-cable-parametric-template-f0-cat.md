# CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-CAT - Specify Parametric cable package template
...
- `docs/tasks/models/cmp-package-cable-parametric-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-CAT-FAILURE`
