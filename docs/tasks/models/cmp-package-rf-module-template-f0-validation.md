# CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-VALIDATION - Validate RF module pin map and appearance
...
- `CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-rf-module-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-VALIDATION-FAILURE`
