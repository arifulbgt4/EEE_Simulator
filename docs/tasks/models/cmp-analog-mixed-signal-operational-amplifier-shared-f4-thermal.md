# CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL - Implement Operational amplifier electrothermal behavior
...
Implement only the F4 power, temperature and electrothermal feedback concern for **Operational amplifier**.
...
- `docs/tasks/models/cmp-analog-mixed-signal-operational-amplifier-shared-f4-thermal.md`
...
- One F4 thermal-state contract for `fam-analog-mixed-signal-operational-amplifier` naming P, T, Tamb, Rth, Cth, initial state, valid range, update order, and unsupported coupling behavior.
- Deterministic steady/transient thermal and runaway/limit evidence tied to the exact family reference vectors.
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL`: shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, fidelity `F4`, concern `THERMAL`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F4-THERMAL` exists and is limited to shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, `F4`, and `THERMAL`.
