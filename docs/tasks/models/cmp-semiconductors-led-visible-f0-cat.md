# CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT - Specify Visible catalog preset
...
| Variant | `var-semiconductors-led-visible` - Visible |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Visible** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-semiconductors-led` (Light-emitting diode); task scope: variant `var-semiconductors-led-visible` (Visible); fidelity `F0`; concern `CAT`.
...
- Selected variant tiers: `F0`, `F1`, `F2`, `F3`, `F4`; release target: Realistic Electronics MVP; package references: `pkg-led-round`, `pkg-led-smd`, `pkg-custom-parametric`.
...
- Canonical source: [Light-emitting diode family-specific implementation reference](../../catalog/families/fam-semiconductors-led.md#family-specific-implementation-reference), registry row `fam-semiconductors-led`, and variant `var-semiconductors-led-visible` (Visible).
...
- `docs/tasks/models/cmp-semiconductors-led-visible-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-semiconductors-led-visible` (Visible), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT`: variant `var-semiconductors-led-visible` (Visible), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-LED-VISIBLE-F0-CAT` exists and is limited to variant `var-semiconductors-led-visible` (Visible), `F0`, and `CAT`.
