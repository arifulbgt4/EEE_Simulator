# CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE - Implement Servo failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Servo**.
...
- Stable family: `fam-actuators-hmi-servo` (Servo); task scope: shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-actuators-hmi-servo-shared-f4-failure.md`
...
- Scope is limited to `CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE`: shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`, fidelity `F4`, concern `FAILURE`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-SERVO-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`, `F4`, and `FAILURE`.
