# CMP-PACKAGE-DPAK-TEMPLATE-F0-SYM - Create DPAK or TO-252 physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-dpak` - DPAK or TO-252 |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-DPAK-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-dpak` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-dpak-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-SYM-FAILURE`
