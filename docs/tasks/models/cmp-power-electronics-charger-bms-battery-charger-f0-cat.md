# CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT - Specify Battery Charger catalog preset
...
| Variant | `var-power-electronics-charger-bms-battery-charger` - Battery Charger |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Battery Charger** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-power-electronics-charger-bms` (Charger and battery management); task scope: variant `var-power-electronics-charger-bms-battery-charger` (Battery Charger); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-power-electronics-charger-bms-battery-charger-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-power-electronics-charger-bms-battery-charger` (Battery Charger), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT`: variant `var-power-electronics-charger-bms-battery-charger` (Battery Charger), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-CHARGER-BMS-BATTERY-CHARGER-F0-CAT` exists and is limited to variant `var-power-electronics-charger-bms-battery-charger` (Battery Charger), `F0`, and `CAT`.
