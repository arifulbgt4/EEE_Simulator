# CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT - Specify Coupler catalog preset
...
| Variant | `var-rf-communications-rf-passive-coupler` - Coupler |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Coupler** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-rf-passive` (RF passive); task scope: variant `var-rf-communications-rf-passive-coupler` (Coupler); fidelity `F1`; concern `CAT`.
...
- Canonical source: [RF passive family-specific implementation reference](../../catalog/families/fam-rf-communications-rf-passive.md#family-specific-implementation-reference), registry row `fam-rf-communications-rf-passive`, and variant `var-rf-communications-rf-passive-coupler` (Coupler).
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-coupler-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-rf-passive-coupler` (Coupler), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT`: variant `var-rf-communications-rf-passive-coupler` (Coupler), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT` exists and is limited to variant `var-rf-communications-rf-passive-coupler` (Coupler), `F1`, and `CAT`.
