# CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-SYM - Create Sensor module physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-sensor-module` - Sensor module |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-sensor-module` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-sensor-module-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-SYM-FAILURE`
