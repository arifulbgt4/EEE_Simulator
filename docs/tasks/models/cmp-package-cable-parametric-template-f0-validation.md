# CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-VALIDATION - Validate Parametric cable pin map and appearance
...
- `CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-cable-parametric-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-VALIDATION-FAILURE`
