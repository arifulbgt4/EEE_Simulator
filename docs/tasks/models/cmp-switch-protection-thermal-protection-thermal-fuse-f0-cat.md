# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT - Specify Thermal Fuse catalog preset
...
| Variant | `var-switch-protection-thermal-protection-thermal-fuse` - Thermal Fuse |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Thermal Fuse** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: variant `var-switch-protection-thermal-protection-thermal-fuse` (Thermal Fuse); fidelity `F0`; concern `CAT`.
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Temperature drives a hysteretic open/closed or limiting state at declared trip/reset thresholds with thermal delay and fail-safe behavior.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-thermal-fuse-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-thermal-protection-thermal-fuse` (Thermal Fuse), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT`: variant `var-switch-protection-thermal-protection-thermal-fuse` (Thermal Fuse), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMAL-FUSE-F0-CAT` exists and is limited to variant `var-switch-protection-thermal-protection-thermal-fuse` (Thermal Fuse), `F0`, and `CAT`.
