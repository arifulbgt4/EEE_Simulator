# CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL - Implement Resistor array electrothermal behavior
...
Implement only the F4 power, temperature and electrothermal feedback concern for **Resistor array**.
...
- Stable family: `fam-passives-resistor-array` (Resistor array); task scope: shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`; fidelity `F4`; concern `THERMAL`.
...
- `docs/tasks/models/cmp-passives-resistor-array-shared-f4-thermal.md`
...
- One F4 thermal-state contract for `fam-passives-resistor-array` naming P, T, Tamb, Rth, Cth, initial state, valid range, update order, and unsupported coupling behavior.
- Deterministic steady/transient thermal and runaway/limit evidence tied to the exact family reference vectors.
- Scope is limited to `CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL`: shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`, fidelity `F4`, concern `THERMAL`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL-NOMINAL`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL-BOUNDARY`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F4-THERMAL` exists and is limited to shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`, `F4`, and `THERMAL`.
