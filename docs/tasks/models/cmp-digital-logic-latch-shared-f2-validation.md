# CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION - Validate Latch F2
...
Produce independent validation evidence for **Latch** at **F2** without modifying the model under test.
...
- Stable family: `fam-digital-logic-latch` (Latch); task scope: shared family scope across `var-digital-logic-latch-sr`, `var-digital-logic-latch-d`, `var-digital-logic-latch-gated`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-digital-logic-latch-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-DIG-LATCH-NOMINAL`, `GOLD-DIG-LATCH-BOUNDARY`, `GOLD-DIG-LATCH-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION`: shared family scope across `var-digital-logic-latch-sr`, `var-digital-logic-latch-d`, `var-digital-logic-latch-gated`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-LATCH-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-digital-logic-latch-sr`, `var-digital-logic-latch-d`, `var-digital-logic-latch-gated`, `F2`, and `VALIDATION`.
