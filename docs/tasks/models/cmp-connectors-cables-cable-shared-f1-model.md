# CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL - Implement Cable F1 model
...
Implement one model tier, **F1**, for **Cable** using the family equations/behavior and no higher-fidelity claims.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Each conductor pair/shield follows the declared connectivity and lumped or distributed RLGC/coupling model with length and termination parameters.
...
- `docs/tasks/models/cmp-connectors-cables-cable-shared-f1-model.md`
...
- One `ModelBinding` for `fam-connectors-cables-cable` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL`: shared family scope across `var-connectors-cables-cable-coaxial`, `var-connectors-cables-cable-ribbon`, `var-connectors-cables-cable-twisted-pair`, `var-connectors-cables-cable-shielded-multicore`, `var-connectors-cables-cable-usb`, `var-connectors-cables-cable-wire-harness`, fidelity `F1`, concern `MODEL`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CABLE-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-connectors-cables-cable-coaxial`, `var-connectors-cables-cable-ribbon`, `var-connectors-cables-cable-twisted-pair`, `var-connectors-cables-cable-shielded-multicore`, `var-connectors-cables-cable-usb`, `var-connectors-cables-cable-wire-harness`, `F1`, and `MODEL`.
