# CMP-PACKAGE-TO-247-TEMPLATE-F0-VALIDATION - Validate TO-247 family pin map and appearance
...
- `CMP-PACKAGE-TO-247-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-to-247-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-VALIDATION-FAILURE`
