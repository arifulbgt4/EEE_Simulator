# CMP-PACKAGE-SOIC-TEMPLATE-F0-SYM - Create Small-outline IC physical renderer
...
- `CMP-PACKAGE-SOIC-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- `docs/tasks/models/cmp-package-soic-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-SYM-FAILURE`
