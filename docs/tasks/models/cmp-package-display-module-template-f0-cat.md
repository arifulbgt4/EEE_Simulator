...
- `docs/tasks/models/cmp-package-display-module-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-CAT-FAILURE`
