# CMP-PACKAGE-LGA-TEMPLATE-F0-VALIDATION - Validate Land grid array pin map and appearance
...
- `CMP-PACKAGE-LGA-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-lga-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-VALIDATION-FAILURE`
