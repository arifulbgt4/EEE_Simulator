# CMP-PACKAGE-PLCC-TEMPLATE-F0-SYM - Create Plastic leaded chip carrier physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-plcc` - Plastic leaded chip carrier |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-PLCC-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-plcc` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-plcc-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-SYM-FAILURE`
