# CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT - Define import mapping for FPGA and HDL block
...
Implement and validate only the declared external-model mappings for **FPGA and HDL block**.
...
- Stable family: `fam-mcu-fpga-fpga-hdl` (FPGA and HDL block); task scope: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-mcu-fpga-fpga-hdl-shared-f3-import.md`
...
- Scope is limited to `CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT`: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, fidelity `F3`, concern `IMPORT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-FPGA-HDL-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, `F3`, and `IMPORT`.
