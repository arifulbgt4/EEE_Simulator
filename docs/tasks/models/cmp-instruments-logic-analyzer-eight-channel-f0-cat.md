# CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT - Specify Eight Channel catalog preset
...
| Variant | `var-instruments-logic-analyzer-eight-channel` - Eight Channel |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Eight Channel** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-instruments-logic-analyzer` (Logic analyzer); task scope: variant `var-instruments-logic-analyzer-eight-channel` (Eight Channel); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Logic analyzer family-specific implementation reference](../../catalog/families/fam-instruments-logic-analyzer.md#family-specific-implementation-reference), registry row `fam-instruments-logic-analyzer`, and variant `var-instruments-logic-analyzer-eight-channel` (Eight Channel).
...
- `docs/tasks/models/cmp-instruments-logic-analyzer-eight-channel-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-instruments-logic-analyzer-eight-channel` (Eight Channel), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT`: variant `var-instruments-logic-analyzer-eight-channel` (Eight Channel), fidelity `F0`, concern `CAT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-LOGIC-ANALYZER-EIGHT-CHANNEL-F0-CAT` exists and is limited to variant `var-instruments-logic-analyzer-eight-channel` (Eight Channel), `F0`, and `CAT`.
