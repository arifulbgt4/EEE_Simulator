# CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL - Implement DC converter F3 model
...
Implement one model tier, **F3**, for **DC converter** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-power-electronics-dc-converter` (DC converter); task scope: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`; fidelity `F3`; concern `MODEL`.
...
- Exact F3 execution rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected buck/boost/buck-boost/flyback/forward/charge-pump profile uses either an explicit switching topology or declared averaged state-space equations.
...
- `docs/tasks/models/cmp-power-electronics-dc-converter-shared-f3-model.md`
...
- One `ModelBinding` for `fam-power-electronics-dc-converter` at `F3` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL`: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, fidelity `F3`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL` exists and is limited to shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, `F3`, and `MODEL`.
