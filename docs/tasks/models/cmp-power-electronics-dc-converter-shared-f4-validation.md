# CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION - Validate DC converter F4
...
Produce independent validation evidence for **DC converter** at **F4** without modifying the model under test.
...
- Stable family: `fam-power-electronics-dc-converter` (DC converter); task scope: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-power-electronics-dc-converter-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-DC_CONVERTER-NOMINAL`, `GOLD-PWR-DC_CONVERTER-BOUNDARY`, `GOLD-PWR-DC_CONVERTER-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION`: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, `F4`, and `VALIDATION`.
