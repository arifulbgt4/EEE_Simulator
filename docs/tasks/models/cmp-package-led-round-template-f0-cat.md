# CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-CAT - Specify Round through-hole LED package template
...
- `docs/tasks/models/cmp-package-led-round-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-CAT-FAILURE`
