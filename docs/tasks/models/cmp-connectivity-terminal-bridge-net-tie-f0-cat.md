# CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT - Specify Net Tie catalog preset
...
| Variant | `var-connectivity-terminal-bridge-net-tie` - Net Tie |
| Fidelity | F0 |
| Concern | CAT |
| Release | R1 |
...
Create the complete, immutable catalog definition for **Net Tie** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectivity-terminal-bridge` (Terminal, net tie, jumper, and domain adapter); task scope: variant `var-connectivity-terminal-bridge-net-tie` (Net Tie); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-connectivity-terminal-bridge-net-tie-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectivity-terminal-bridge-net-tie` (Net Tie), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT`: variant `var-connectivity-terminal-bridge-net-tie` (Net Tie), fidelity `F0`, concern `CAT`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-TERMINAL-BRIDGE-NET-TIE-F0-CAT` exists and is limited to variant `var-connectivity-terminal-bridge-net-tie` (Net Tie), `F0`, and `CAT`.
