# CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT - Define import mapping for Detailed EM and MEMS model
...
Implement and validate only the declared external-model mappings for **Detailed EM and MEMS model**.
...
- Stable family: `fam-deferred-research-em-mems` (Detailed EM and MEMS model); task scope: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`; fidelity `F5`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-deferred-research-em-mems-shared-f5-import.md`
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT`: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, fidelity `F5`, concern `IMPORT`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-IMPORT` exists and is limited to shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, `F5`, and `IMPORT`.
