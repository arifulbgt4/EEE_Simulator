# CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-VALIDATION - Validate Axial two-lead body pin map and appearance
...
- `CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-axial-2-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-VALIDATION-FAILURE`
