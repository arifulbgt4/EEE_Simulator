# CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS - Document Optical sensor
...
Publish user and contributor documentation for **Optical sensor** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-PHOTODIODE-MODULE-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-AMBIENT-LIGHT-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-COLOR-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-INFRARED-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-SYM`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-MODEL`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F1-MODEL`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F1-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F2-MODEL`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F2-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-MODEL`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-THERMAL`
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-sensors-environment-optical-sensor`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-sensors-environment-optical-sensor-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-sensors-environment-optical-sensor.md` for `fam-sensors-environment-optical-sensor`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS`: shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, fidelity `F0`, concern `DOCS`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, `F0`, and `DOCS`.
