# CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT - Specify Triac Output catalog preset
...
| Variant | `var-semiconductors-opto-isolator-triac-output` - Triac Output |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Triac Output** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-semiconductors-opto-isolator` (Optically isolated semiconductor); task scope: variant `var-semiconductors-opto-isolator-triac-output` (Triac Output); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-semiconductors-opto-isolator-triac-output-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-semiconductors-opto-isolator-triac-output` (Triac Output), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT`: variant `var-semiconductors-opto-isolator-triac-output` (Triac Output), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-TRIAC-OUTPUT-F0-CAT` exists and is limited to variant `var-semiconductors-opto-isolator-triac-output` (Triac Output), `F0`, and `CAT`.
