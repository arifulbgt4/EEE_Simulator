# CMP-PACKAGE-TO-92-TEMPLATE-F0-CAT - Specify TO-92 family package template
...
- `docs/tasks/models/cmp-package-to-92-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-CAT-FAILURE`
