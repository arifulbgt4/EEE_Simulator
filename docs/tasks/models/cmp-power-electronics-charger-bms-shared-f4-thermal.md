# CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL - Implement Charger and battery management electrothermal behavior
...
Implement only the F4 power, temperature and electrothermal feedback concern for **Charger and battery management**.
...
- Stable family: `fam-power-electronics-charger-bms` (Charger and battery management); task scope: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`; fidelity `F4`; concern `THERMAL`.
...
- `docs/tasks/models/cmp-power-electronics-charger-bms-shared-f4-thermal.md`
...
- One F4 thermal-state contract for `fam-power-electronics-charger-bms` naming P, T, Tamb, Rth, Cth, initial state, valid range, update order, and unsupported coupling behavior.
- Deterministic steady/transient thermal and runaway/limit evidence tied to the exact family reference vectors.
- Scope is limited to `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL`: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, fidelity `F4`, concern `THERMAL`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-THERMAL` exists and is limited to shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, `F4`, and `THERMAL`.
