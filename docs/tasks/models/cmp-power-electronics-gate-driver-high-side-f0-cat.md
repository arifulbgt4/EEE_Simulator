# CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT - Specify High Side catalog preset
...
| Variant | `var-power-electronics-gate-driver-high-side` - High Side |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **High Side** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-power-electronics-gate-driver` (Gate driver); task scope: variant `var-power-electronics-gate-driver-high-side` (High Side); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Gate driver family-specific implementation reference](../../catalog/families/fam-power-electronics-gate-driver.md#family-specific-implementation-reference), registry row `fam-power-electronics-gate-driver`, and variant `var-power-electronics-gate-driver-high-side` (High Side).
...
- `docs/tasks/models/cmp-power-electronics-gate-driver-high-side-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-power-electronics-gate-driver-high-side` (High Side), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT`: variant `var-power-electronics-gate-driver-high-side` (High Side), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-GATE-DRIVER-HIGH-SIDE-F0-CAT` exists and is limited to variant `var-power-electronics-gate-driver-high-side` (High Side), `F0`, and `CAT`.
