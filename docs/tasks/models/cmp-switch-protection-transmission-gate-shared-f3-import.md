# CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT - Define import mapping for Transmission gate
...
Implement and validate only the declared external-model mappings for **Transmission gate**.
...
- Stable family: `fam-switch-protection-transmission-gate` (Transmission gate); task scope: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-switch-protection-transmission-gate-shared-f3-import.md`
...
- Scope is limited to `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT`: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, fidelity `F3`, concern `IMPORT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, `F3`, and `IMPORT`.
