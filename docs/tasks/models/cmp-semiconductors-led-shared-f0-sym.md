# CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM - Create symbol and physical representation for Light-emitting diode
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Light-emitting diode**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-semiconductors-led` (Light-emitting diode); task scope: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-semiconductors-led-shared-f0-sym.md`
...
- One original `sym-semiconductors-led` schematic definition with anchors for `1:A` (passive; electrical/optical/thermal), `2:K` (passive; electrical/optical/thermal).
...
- Scope is limited to `CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM`: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-LED-SHARED-F0-SYM` exists and is limited to shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, `F0`, and `SYM`.
