# CMP-PACKAGE-BGA-TEMPLATE-F0-CAT - Specify Ball grid array package template
...
- `docs/tasks/models/cmp-package-bga-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-CAT-FAILURE`
