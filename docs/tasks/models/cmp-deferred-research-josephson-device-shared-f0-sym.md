# CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM - Create symbol and physical representation for Josephson junction device
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Josephson junction device**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-deferred-research-josephson-device` (Josephson junction device); task scope: shared family scope across `var-deferred-research-josephson-device-josephson-junction`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-deferred-research-josephson-device-shared-f0-sym.md`
...
- One original `sym-deferred-research-josephson-device` schematic definition with anchors for `1..N:TERMINALS` (multiphysics; research/multiphysics).
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM`: shared family scope across `var-deferred-research-josephson-device-josephson-junction`, fidelity `F0`, concern `SYM`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-JOSEPHSON-DEVICE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-deferred-research-josephson-device-josephson-junction`, `F0`, and `SYM`.
