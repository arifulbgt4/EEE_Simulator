# CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT - Define import mapping for Educational CPU
...
Implement and validate only the declared external-model mappings for **Educational CPU**.
...
- `docs/tasks/models/cmp-computer-gpu-educational-cpu-shared-f2-import.md`
...
- Scope is limited to `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT`: shared family scope across `var-computer-gpu-educational-cpu-one-bit`, `var-computer-gpu-educational-cpu-four-bit`, `var-computer-gpu-educational-cpu-eight-bit`, `var-computer-gpu-educational-cpu-sixteen-bit`, `var-computer-gpu-educational-cpu-small-risc-v`, fidelity `F2`, concern `IMPORT`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-IMPORT` exists and is limited to shared family scope across `var-computer-gpu-educational-cpu-one-bit`, `var-computer-gpu-educational-cpu-four-bit`, `var-computer-gpu-educational-cpu-eight-bit`, `var-computer-gpu-educational-cpu-sixteen-bit`, `var-computer-gpu-educational-cpu-small-risc-v`, `F2`, and `IMPORT`.
