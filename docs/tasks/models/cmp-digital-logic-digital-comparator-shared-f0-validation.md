# CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION - Validate Digital comparator F0
...
Produce independent validation evidence for **Digital comparator** at **F0** without modifying the model under test.
...
- Stable family: `fam-digital-logic-digital-comparator` (Digital comparator); task scope: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: The selected signed/unsigned equality or magnitude relation maps fixed-width inputs to exact comparison outputs with X propagation.
...
- `docs/tasks/models/cmp-digital-logic-digital-comparator-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-DIG-DIGITAL_COMPARATOR-NOMINAL`, `GOLD-DIG-DIGITAL_COMPARATOR-BOUNDARY`, `GOLD-DIG-DIGITAL_COMPARATOR-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION`: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, `F0`, and `VALIDATION`.
