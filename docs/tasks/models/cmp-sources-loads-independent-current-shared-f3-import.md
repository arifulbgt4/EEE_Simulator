# CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F3-IMPORT - Define import mapping for Independent current source
...
Implement and validate only the declared external-model mappings for **Independent current source**.
...
- `docs/tasks/models/cmp-sources-loads-independent-current-shared-f3-import.md`
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-sources-loads-independent-current-dc`, `var-sources-loads-independent-current-ac-small-signal`, `var-sources-loads-independent-current-sine`, `var-sources-loads-independent-current-pulse`, `F3`, and `IMPORT`.
