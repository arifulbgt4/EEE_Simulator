# CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-CAT - Specify Power module package template
...
- `docs/tasks/models/cmp-package-power-module-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-CAT-FAILURE`
