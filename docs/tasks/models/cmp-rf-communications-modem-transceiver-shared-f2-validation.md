# CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION - Validate Modem and transceiver F2
...
Produce independent validation evidence for **Modem and transceiver** at **F2** without modifying the model under test.
...
- Stable family: `fam-rf-communications-modem-transceiver` (Modem and transceiver); task scope: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-rf-communications-modem-transceiver-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-MODEM_TRANSCEIVER-NOMINAL`, `GOLD-RFC-MODEM_TRANSCEIVER-BOUNDARY`, `GOLD-RFC-MODEM_TRANSCEIVER-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION`: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, `F2`, and `VALIDATION`.
