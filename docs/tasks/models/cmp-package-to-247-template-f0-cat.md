# CMP-PACKAGE-TO-247-TEMPLATE-F0-CAT - Specify TO-247 family package template
...
- `docs/tasks/models/cmp-package-to-247-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-CAT-FAILURE`
