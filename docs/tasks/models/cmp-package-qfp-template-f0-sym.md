# CMP-PACKAGE-QFP-TEMPLATE-F0-SYM - Create Quad flat package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-qfp` - Quad flat package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-QFP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-qfp` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-qfp-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-SYM-FAILURE`
