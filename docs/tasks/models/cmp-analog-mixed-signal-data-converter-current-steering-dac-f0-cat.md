# CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT - Specify Current Steering Dac catalog preset
...
| Variant | `var-analog-mixed-signal-data-converter-current-steering-dac` - Current Steering Dac |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Current Steering Dac** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-analog-mixed-signal-data-converter` (Data converter); task scope: variant `var-analog-mixed-signal-data-converter-current-steering-dac` (Current Steering Dac); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Data converter family-specific implementation reference](../../catalog/families/fam-analog-mixed-signal-data-converter.md#family-specific-implementation-reference), registry row `fam-analog-mixed-signal-data-converter`, and variant `var-analog-mixed-signal-data-converter-current-steering-dac` (Current Steering Dac).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: ADC/DAC transfer uses declared reference range, resolution, coding, quantization, clipping, latency, sample timing, and optional nonlinearity.
...
- `docs/tasks/models/cmp-analog-mixed-signal-data-converter-current-steering-dac-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-data-converter-current-steering-dac` (Current Steering Dac), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT`: variant `var-analog-mixed-signal-data-converter-current-steering-dac` (Current Steering Dac), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-DATA-CONVERTER-CURRENT-STEERING-DAC-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-data-converter-current-steering-dac` (Current Steering Dac), `F0`, and `CAT`.
