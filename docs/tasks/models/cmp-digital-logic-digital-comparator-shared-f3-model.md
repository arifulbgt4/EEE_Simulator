# CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL - Implement Digital comparator F3 model
...
Implement one model tier, **F3**, for **Digital comparator** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-digital-logic-digital-comparator` (Digital comparator); task scope: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`; fidelity `F3`; concern `MODEL`.
...
- Exact F3 execution rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected signed/unsigned equality or magnitude relation maps fixed-width inputs to exact comparison outputs with X propagation.
...
- `docs/tasks/models/cmp-digital-logic-digital-comparator-shared-f3-model.md`
...
- One `ModelBinding` for `fam-digital-logic-digital-comparator` at `F3` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL`: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, fidelity `F3`, concern `MODEL`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F3-MODEL` exists and is limited to shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, `F3`, and `MODEL`.
