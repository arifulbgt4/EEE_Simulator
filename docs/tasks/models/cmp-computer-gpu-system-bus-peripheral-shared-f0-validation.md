# CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION - Validate System bus and peripheral F0
...
Produce independent validation evidence for **System bus and peripheral** at **F0** without modifying the model under test.
...
- Stable family: `fam-computer-gpu-system-bus-peripheral` (System bus and peripheral); task scope: shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Transactions follow the selected bus/peripheral request, response, address, data, byte-enable, arbitration, timeout, and error state machine.
...
- `docs/tasks/models/cmp-computer-gpu-system-bus-peripheral-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-CPU-SYSTEM_BUS_PERIPHERAL-NOMINAL`, `GOLD-CPU-SYSTEM_BUS_PERIPHERAL-BOUNDARY`, `GOLD-CPU-SYSTEM_BUS_PERIPHERAL-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION`: shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`, `F0`, and `VALIDATION`.
