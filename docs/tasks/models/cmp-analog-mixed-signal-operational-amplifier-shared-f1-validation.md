# CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION - Validate Operational amplifier F1
...
Produce independent validation evidence for **Operational amplifier** at **F1** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F1 rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: F1 computes Vout = clamp(Aol*(Vplus-Vminus), supply/output limits); higher tiers add poles, slew, bias, noise, common-mode, and output-drive limits.
...
- `docs/tasks/models/cmp-analog-mixed-signal-operational-amplifier-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-AMS-OPERATIONAL_AMPLIFIER-NOMINAL`, `GOLD-AMS-OPERATIONAL_AMPLIFIER-BOUNDARY`, `GOLD-AMS-OPERATIONAL_AMPLIFIER-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION`: shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, `F1`, and `VALIDATION`.
