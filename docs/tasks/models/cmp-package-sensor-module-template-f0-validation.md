# CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-VALIDATION - Validate Sensor module pin map and appearance
...
- `CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-sensor-module-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-VALIDATION-FAILURE`
