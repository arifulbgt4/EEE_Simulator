# CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-DOCS - Document Virtual or schematic-only package
...
- `docs/tasks/models/cmp-package-virtual-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-DOCS-FAILURE`
