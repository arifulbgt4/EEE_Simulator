# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL - Implement Thermal protection F0 model
...
Implement one model tier, **F0**, for **Thermal protection** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`; fidelity `F0`; concern `MODEL`.
...
- Exact F0 execution rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Temperature drives a hysteretic open/closed or limiting state at declared trip/reset thresholds with thermal delay and fail-safe behavior.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-shared-f0-model.md`
...
- One `ModelBinding` for `fam-switch-protection-thermal-protection` at `F0` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL`: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, fidelity `F0`, concern `MODEL`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-MODEL` exists and is limited to shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, `F0`, and `MODEL`.
