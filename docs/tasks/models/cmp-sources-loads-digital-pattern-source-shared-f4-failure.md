# CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE - Implement Digital pattern source failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Digital pattern source**.
...
- Stable family: `fam-sources-loads-digital-pattern-source` (Digital pattern source); task scope: shared family scope across `var-sources-loads-digital-pattern-source-pattern`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-sources-loads-digital-pattern-source-shared-f4-failure.md`
...
- Scope is limited to `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE`: shared family scope across `var-sources-loads-digital-pattern-source-pattern`, fidelity `F4`, concern `FAILURE`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-sources-loads-digital-pattern-source-pattern`, `F4`, and `FAILURE`.
