# CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM - Create symbol and physical representation for Terminal, net tie, jumper, and domain adapter
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Terminal, net tie, jumper, and domain adapter**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-connectivity-terminal-bridge` (Terminal, net tie, jumper, and domain adapter); task scope: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-connectivity-terminal-bridge-shared-f0-sym.md`
...
- One original `sym-connectivity-terminal-bridge` schematic definition with anchors for `1:P` (passive; electrical/schematic), `2:N` (passive; electrical/schematic).
...
- Scope is limited to `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM`: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, fidelity `F0`, concern `SYM`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, `F0`, and `SYM`.
