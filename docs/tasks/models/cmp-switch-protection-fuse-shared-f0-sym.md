# CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM - Create symbol and physical representation for Fuse and resettable protector
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Fuse and resettable protector**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-switch-protection-fuse` (Fuse and resettable protector); task scope: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-switch-protection-fuse-shared-f0-sym.md`
...
- One original `sym-switch-protection-fuse` schematic definition with anchors for `1:P` (passive; electrical/control), `2:N` (passive; electrical/control).
...
- Scope is limited to `CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM`: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, fidelity `F0`, concern `SYM`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-FUSE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, `F0`, and `SYM`.
