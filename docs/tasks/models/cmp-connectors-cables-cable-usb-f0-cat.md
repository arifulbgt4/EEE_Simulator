# CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT - Specify Usb catalog preset
...
| Variant | `var-connectors-cables-cable-usb` - Usb |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Usb** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectors-cables-cable` (Cable); task scope: variant `var-connectors-cables-cable-usb` (Usb); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Cable family-specific implementation reference](../../catalog/families/fam-connectors-cables-cable.md#family-specific-implementation-reference), registry row `fam-connectors-cables-cable`, and variant `var-connectors-cables-cable-usb` (Usb).
...
- `docs/tasks/models/cmp-connectors-cables-cable-usb-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectors-cables-cable-usb` (Usb), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT`: variant `var-connectors-cables-cable-usb` (Usb), fidelity `F0`, concern `CAT`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CABLE-USB-F0-CAT` exists and is limited to variant `var-connectors-cables-cable-usb` (Usb), `F0`, and `CAT`.
