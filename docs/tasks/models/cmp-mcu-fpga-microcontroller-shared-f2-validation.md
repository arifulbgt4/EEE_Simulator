# CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION - Validate Microcontroller F2
...
Produce independent validation evidence for **Microcontroller** at **F2** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-microcontroller` (Microcontroller); task scope: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-mcu-fpga-microcontroller-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-MICROCONTROLLER-NOMINAL`, `GOLD-MCU-MICROCONTROLLER-BOUNDARY`, `GOLD-MCU-MICROCONTROLLER-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION`: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, `F2`, and `VALIDATION`.
