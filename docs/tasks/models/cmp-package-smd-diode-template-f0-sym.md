# CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-SYM - Create SMD diode physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-smd-diode` - SMD diode |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package mappings: pkg-smd-diode
...
- Package registry entry `pkg-smd-diode` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-smd-diode-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-SYM-FAILURE`
