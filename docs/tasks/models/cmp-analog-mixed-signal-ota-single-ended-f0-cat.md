# CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT - Specify Single Ended catalog preset
...
| Variant | `var-analog-mixed-signal-ota-single-ended` - Single Ended |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Single Ended** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-analog-mixed-signal-ota` (Operational transconductance amplifier); task scope: variant `var-analog-mixed-signal-ota-single-ended` (Single Ended); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Operational transconductance amplifier family-specific implementation reference](../../catalog/families/fam-analog-mixed-signal-ota.md#family-specific-implementation-reference), registry row `fam-analog-mixed-signal-ota`, and variant `var-analog-mixed-signal-ota-single-ended` (Single Ended).
...
- `docs/tasks/models/cmp-analog-mixed-signal-ota-single-ended-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-ota-single-ended` (Single Ended), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT`: variant `var-analog-mixed-signal-ota-single-ended` (Single Ended), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-OTA-SINGLE-ENDED-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-ota-single-ended` (Single Ended), `F0`, and `CAT`.
