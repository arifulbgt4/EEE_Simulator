# CMP-PACKAGE-TSSOP-TEMPLATE-F0-VALIDATION - Validate Thin shrink small-outline package pin map and appearance
...
- `CMP-PACKAGE-TSSOP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-tssop-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-VALIDATION-FAILURE`
