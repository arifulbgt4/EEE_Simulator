# CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM - Create symbol and physical representation for Charger and battery management
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Charger and battery management**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-power-electronics-charger-bms` (Charger and battery management); task scope: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-power-electronics-charger-bms-shared-f0-sym.md`
...
- Scope is limited to `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM`: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F0-SYM` exists and is limited to shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, `F0`, and `SYM`.
