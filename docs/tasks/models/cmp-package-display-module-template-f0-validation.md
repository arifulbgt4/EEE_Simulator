# CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-VALIDATION - Validate Display module pin map and appearance
...
- `CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-display-module-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-VALIDATION-FAILURE`
