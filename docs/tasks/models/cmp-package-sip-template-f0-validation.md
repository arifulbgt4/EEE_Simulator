# CMP-PACKAGE-SIP-TEMPLATE-F0-VALIDATION - Validate Single in-line package pin map and appearance
...
- `CMP-PACKAGE-SIP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-sip-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-VALIDATION-FAILURE`
