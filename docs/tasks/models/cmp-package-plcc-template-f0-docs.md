# CMP-PACKAGE-PLCC-TEMPLATE-F0-DOCS - Document Plastic leaded chip carrier package
...
- `docs/tasks/models/cmp-package-plcc-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-DOCS-FAILURE`
