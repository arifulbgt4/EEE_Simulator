# CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT - Define import mapping for Flip-flop
...
Implement and validate only the declared external-model mappings for **Flip-flop**.
...
- Stable family: `fam-digital-logic-flip-flop` (Flip-flop); task scope: shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-digital-logic-flip-flop-shared-f3-import.md`
...
- Scope is limited to `CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT`: shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`, `F3`, and `IMPORT`.
