# CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL - Implement Antenna F1 model
...
Implement one model tier, **F1**, for **Antenna** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-antenna` (Antenna); task scope: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The antenna uses a declared port impedance/S-parameter plus radiation gain/pattern/polarization/efficiency profile over its validated frequency envelope.
...
- `docs/tasks/models/cmp-rf-communications-antenna-shared-f1-model.md`
...
- One `ModelBinding` for `fam-rf-communications-antenna` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL`: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, fidelity `F1`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, `F1`, and `MODEL`.
