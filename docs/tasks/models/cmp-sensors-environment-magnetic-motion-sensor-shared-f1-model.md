# CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL - Implement Magnetic and motion sensor F1 model
...
Implement one model tier, **F1**, for **Magnetic and motion sensor** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-sensors-environment-magnetic-motion-sensor` (Magnetic and motion sensor); task scope: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Output follows the selected magnetic/acceleration/angular-rate/position transfer and axis transform with bandwidth, bias, range, and noise.
...
- `docs/tasks/models/cmp-sensors-environment-magnetic-motion-sensor-shared-f1-model.md`
...
- One `ModelBinding` for `fam-sensors-environment-magnetic-motion-sensor` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL`: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, fidelity `F1`, concern `MODEL`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, `F1`, and `MODEL`.
