# CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL - Implement Generic semiconductor black box F2 model
...
Implement one model tier, **F2**, for **Generic semiconductor black box** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-semiconductors-semiconductor-generic` (Generic semiconductor black box); task scope: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`; fidelity `F2`; concern `MODEL`.
...
- `docs/tasks/models/cmp-semiconductors-semiconductor-generic-shared-f2-model.md`
...
- One `ModelBinding` for `fam-semiconductors-semiconductor-generic` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL`: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, fidelity `F2`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, `F2`, and `MODEL`.
