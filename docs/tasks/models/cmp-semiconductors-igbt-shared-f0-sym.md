...
- Stable family: `fam-semiconductors-igbt` (Insulated-gate bipolar transistor); task scope: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-semiconductors-igbt-shared-f0-sym.md`
...
- One original `sym-semiconductors-igbt` schematic definition with anchors for `1:D` (passive; electrical/optical/thermal), `2:G` (input; electrical/optical/thermal), `3:S` (passive; electrical/optical/thermal), `4:B` (optional; electrical/optical/thermal).
...
- Scope is limited to `CMP-SEMICONDUCTORS-IGBT-SHARED-F0-SYM`: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-IGBT-SHARED-F0-SYM` exists and is limited to shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, `F0`, and `SYM`.
