# CMP-PACKAGE-DPAK-TEMPLATE-F0-VALIDATION - Validate DPAK or TO-252 pin map and appearance
...
- `CMP-PACKAGE-DPAK-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-dpak-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-VALIDATION-FAILURE`
