# CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS - Document RF passive
...
Publish user and contributor documentation for **RF passive** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-ATTENUATOR-F1-CAT`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-BALUN-F1-CAT`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-COUPLER-F1-CAT`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SPLITTER-COMBINER-F1-CAT`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-SYM`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-MODEL`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-MODEL`
- `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-VALIDATION`
...
- Stable family: `fam-rf-communications-rf-passive` (RF passive); task scope: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`; fidelity `F0`; concern `DOCS`.
...
- Canonical source: [RF passive family-specific implementation reference](../../catalog/families/fam-rf-communications-rf-passive.md#family-specific-implementation-reference), registry row `fam-rf-communications-rf-passive`, and shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-rf-communications-rf-passive`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-rf-communications-rf-passive.md` for `fam-rf-communications-rf-passive`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS`: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, fidelity `F0`, concern `DOCS`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, `F0`, and `DOCS`.
