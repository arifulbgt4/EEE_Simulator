# CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION - Validate Transimpedance amplifier F3
...
Produce independent validation evidence for **Transimpedance amplifier** at **F3** without modifying the model under test.
...
- Stable family: `fam-analog-mixed-signal-transimpedance-amplifier` (Transimpedance amplifier); task scope: shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: Output is the bounded transfer Vout = Vref - Iin*Zfeedback over the declared bandwidth, including stability/noise constraints.
...
- `docs/tasks/models/cmp-analog-mixed-signal-transimpedance-amplifier-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-AMS-TRANSIMPEDANCE_AMPLIFIER-NOMINAL`, `GOLD-AMS-TRANSIMPEDANCE_AMPLIFIER-BOUNDARY`, `GOLD-AMS-TRANSIMPEDANCE_AMPLIFIER-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION`: shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`, `F3`, and `VALIDATION`.
