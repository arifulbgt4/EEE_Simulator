# CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-SYM - Create Rectangular through-hole LED physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-led-rectangular` - Rectangular through-hole LED |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-led-rectangular` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-led-rectangular-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-SYM-FAILURE`
