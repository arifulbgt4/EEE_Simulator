# CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION - Validate Educational CPU F2
...
Produce independent validation evidence for **Educational CPU** at **F2** without modifying the model under test.
...
- `docs/tasks/models/cmp-computer-gpu-educational-cpu-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-CPU-EDUCATIONAL_CPU-NOMINAL`, `GOLD-CPU-EDUCATIONAL_CPU-BOUNDARY`, `GOLD-CPU-EDUCATIONAL_CPU-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION`: shared family scope across `var-computer-gpu-educational-cpu-one-bit`, `var-computer-gpu-educational-cpu-four-bit`, `var-computer-gpu-educational-cpu-eight-bit`, `var-computer-gpu-educational-cpu-sixteen-bit`, `var-computer-gpu-educational-cpu-small-risc-v`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-computer-gpu-educational-cpu-one-bit`, `var-computer-gpu-educational-cpu-four-bit`, `var-computer-gpu-educational-cpu-eight-bit`, `var-computer-gpu-educational-cpu-sixteen-bit`, `var-computer-gpu-educational-cpu-small-risc-v`, `F2`, and `VALIDATION`.
