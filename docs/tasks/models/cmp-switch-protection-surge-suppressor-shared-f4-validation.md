# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION - Validate Surge and ESD suppressor F4
...
Produce independent validation evidence for **Surge and ESD suppressor** at **F4** without modifying the model under test.
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-SURGE_SUPPRESSOR-NOMINAL`, `GOLD-SWP-SURGE_SUPPRESSOR-BOUNDARY`, `GOLD-SWP-SURGE_SUPPRESSOR-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION`: shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F4`, and `VALIDATION`.
