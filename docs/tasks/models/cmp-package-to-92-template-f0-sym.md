# CMP-PACKAGE-TO-92-TEMPLATE-F0-SYM - Create TO-92 family physical renderer
...
- `CMP-PACKAGE-TO-92-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-to-92` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-to-92-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-SYM-FAILURE`
