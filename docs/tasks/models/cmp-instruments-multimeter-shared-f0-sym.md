# CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM - Create symbol and physical representation for Multimeter
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Multimeter**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-instruments-multimeter` (Multimeter); task scope: shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-instruments-multimeter-shared-f0-sym.md`
...
- One original `sym-instruments-multimeter` schematic definition with anchors for `CH+:CHANNEL+` (input; measurement/electrical), `CH-:CHANNEL-` (input; measurement/electrical), `COM:COMMON` (reference; measurement/electrical).
...
- Scope is limited to `CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM`: shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`, fidelity `F0`, concern `SYM`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-MULTIMETER-SHARED-F0-SYM` exists and is limited to shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`, `F0`, and `SYM`.
