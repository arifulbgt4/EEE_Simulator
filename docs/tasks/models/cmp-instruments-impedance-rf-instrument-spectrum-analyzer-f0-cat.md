# CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT - Specify Spectrum Analyzer catalog preset
...
| Variant | `var-instruments-impedance-rf-instrument-spectrum-analyzer` - Spectrum Analyzer |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Spectrum Analyzer** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-instruments-impedance-rf-instrument` (Impedance and RF instrument); task scope: variant `var-instruments-impedance-rf-instrument-spectrum-analyzer` (Spectrum Analyzer); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Impedance and RF instrument family-specific implementation reference](../../catalog/families/fam-instruments-impedance-rf-instrument.md#family-specific-implementation-reference), registry row `fam-instruments-impedance-rf-instrument`, and variant `var-instruments-impedance-rf-instrument-spectrum-analyzer` (Spectrum Analyzer).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected LCR/spectrum/network measurement computes impedance, spectrum, or S-parameters over the declared stimulus, port, window, and calibration contract.
...
- `docs/tasks/models/cmp-instruments-impedance-rf-instrument-spectrum-analyzer-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-instruments-impedance-rf-instrument-spectrum-analyzer` (Spectrum Analyzer), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT`: variant `var-instruments-impedance-rf-instrument-spectrum-analyzer` (Spectrum Analyzer), fidelity `F0`, concern `CAT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SPECTRUM-ANALYZER-F0-CAT` exists and is limited to variant `var-instruments-impedance-rf-instrument-spectrum-analyzer` (Spectrum Analyzer), `F0`, and `CAT`.
