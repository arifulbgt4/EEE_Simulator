# CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE - Implement Insulated-gate bipolar transistor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Insulated-gate bipolar transistor**.
...
- Stable family: `fam-semiconductors-igbt` (Insulated-gate bipolar transistor); task scope: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-semiconductors-igbt-shared-f4-failure.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE`: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, `F4`, and `FAILURE`.
