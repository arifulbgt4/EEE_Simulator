# CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT - Define import mapping for Bench supply
...
Implement and validate only the declared external-model mappings for **Bench supply**.
...
- Stable family: `fam-instruments-bench-supply` (Bench supply); task scope: shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`; fidelity `F2`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-instruments-bench-supply-shared-f2-import.md`
...
- Scope is limited to `CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT`: shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`, fidelity `F2`, concern `IMPORT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F2-IMPORT` exists and is limited to shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`, `F2`, and `IMPORT`.
