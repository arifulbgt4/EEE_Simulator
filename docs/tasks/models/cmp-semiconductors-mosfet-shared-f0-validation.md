# CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION - Validate MOSFET F0
...
Produce independent validation evidence for **MOSFET** at **F0** without modifying the model under test.
...
- Stable family: `fam-semiconductors-mosfet` (MOSFET); task scope: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: F1 uses explicit cutoff/linear/saturation channel equations with body diode; F3 binds a pinned compact model and preserves terminal orientation.
...
- `docs/tasks/models/cmp-semiconductors-mosfet-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEM-MOSFET-NOMINAL`, `GOLD-SEM-MOSFET-BOUNDARY`, `GOLD-SEM-MOSFET-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION`: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, `F0`, and `VALIDATION`.
