# CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-VALIDATION - Validate Parametric connector pin map and appearance
...
- `CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-connector-parametric-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-VALIDATION-FAILURE`
