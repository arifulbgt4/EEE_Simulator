# CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS - Document Gate driver
...
Publish user and contributor documentation for **Gate driver** without changing its model, symbol, package, or validation behavior.
...
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-SYM`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-MODEL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-VALIDATION`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F1-MODEL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F1-VALIDATION`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F2-MODEL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F2-VALIDATION`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-MODEL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-VALIDATION`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F4-MODEL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F4-VALIDATION`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F4-THERMAL`
- `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F4-FAILURE`
...
- Stable family: `fam-power-electronics-gate-driver` (Gate driver); task scope: shared family scope across `var-power-electronics-gate-driver-low-side`, `var-power-electronics-gate-driver-high-side`, `var-power-electronics-gate-driver-isolated`; fidelity `F0`; concern `DOCS`.
...
- `docs/tasks/models/cmp-power-electronics-gate-driver-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-power-electronics-gate-driver.md` for `fam-power-electronics-gate-driver`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS`: shared family scope across `var-power-electronics-gate-driver-low-side`, `var-power-electronics-gate-driver-high-side`, `var-power-electronics-gate-driver-isolated`, fidelity `F0`, concern `DOCS`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-power-electronics-gate-driver-low-side`, `var-power-electronics-gate-driver-high-side`, `var-power-electronics-gate-driver-isolated`, `F0`, and `DOCS`.
