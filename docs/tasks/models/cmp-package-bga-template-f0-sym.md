# CMP-PACKAGE-BGA-TEMPLATE-F0-SYM - Create Ball grid array physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-bga` - Ball grid array |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-BGA-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-bga` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-bga-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-SYM-FAILURE`
