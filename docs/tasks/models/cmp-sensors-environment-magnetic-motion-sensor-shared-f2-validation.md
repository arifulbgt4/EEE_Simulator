# CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION - Validate Magnetic and motion sensor F2
...
Produce independent validation evidence for **Magnetic and motion sensor** at **F2** without modifying the model under test.
...
- Stable family: `fam-sensors-environment-magnetic-motion-sensor` (Magnetic and motion sensor); task scope: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-sensors-environment-magnetic-motion-sensor-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-MAGNETIC_MOTION_SENSOR-NOMINAL`, `GOLD-SEN-MAGNETIC_MOTION_SENSOR-BOUNDARY`, `GOLD-SEN-MAGNETIC_MOTION_SENSOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION`: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, `F2`, and `VALIDATION`.
