# CMP-PACKAGE-SOT-23-TEMPLATE-F0-DOCS - Document SOT-23 family package
...
- `docs/tasks/models/cmp-package-sot-23-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-DOCS-FAILURE`
