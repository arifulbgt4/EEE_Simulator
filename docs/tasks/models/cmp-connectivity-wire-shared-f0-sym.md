# CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM - Create symbol and physical representation for Wire and conductor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Wire and conductor**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-connectivity-wire` (Wire and conductor); task scope: shared family scope across `var-connectivity-wire-conductor`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-connectivity-wire-shared-f0-sym.md`
...
- One original `sym-connectivity-wire` schematic definition with anchors for `1:P` (passive; electrical/schematic), `2:N` (passive; electrical/schematic).
...
- Scope is limited to `CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM`: shared family scope across `var-connectivity-wire-conductor`, fidelity `F0`, concern `SYM`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-WIRE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectivity-wire-conductor`, `F0`, and `SYM`.
