# CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM - Create symbol and physical representation for Connector
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Connector**, including accessible orientation/polarity cues and reusable package mapping.
...
- `PLAT-SYM-007`
- `CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-VALIDATION`
- `CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-VALIDATION`
...
- `docs/tasks/models/cmp-connectors-cables-connector-shared-f0-sym.md`
...
- One original `sym-connectors-cables-connector` schematic definition with anchors for `1..N:CONTACTS` (passive; electrical/mechanical), `S:SHIELD` (passive; electrical/mechanical).
- One scalable physical-view binding for every declared package `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric`, including non-color orientation/polarity/pin-one cues, accessible text, and logical-to-package pin-equivalence evidence.
- Scope is limited to `CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM`: shared family scope across `var-connectors-cables-connector-pin-header`, `var-connectors-cables-connector-terminal-block`, `var-connectors-cables-connector-usb-a`, `var-connectors-cables-connector-usb-c`, `var-connectors-cables-connector-rj45`, `var-connectors-cables-connector-bnc`, `var-connectors-cables-connector-d-sub`, `var-connectors-cables-connector-jst-style`, `var-connectors-cables-connector-molex-style`, `var-connectors-cables-connector-barrel`, `var-connectors-cables-connector-banana`, `var-connectors-cables-connector-edge-card`, fidelity `F0`, concern `SYM`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectors-cables-connector-pin-header`, `var-connectors-cables-connector-terminal-block`, `var-connectors-cables-connector-usb-a`, `var-connectors-cables-connector-usb-c`, `var-connectors-cables-connector-rj45`, `var-connectors-cables-connector-bnc`, `var-connectors-cables-connector-d-sub`, `var-connectors-cables-connector-jst-style`, `var-connectors-cables-connector-molex-style`, `var-connectors-cables-connector-barrel`, `var-connectors-cables-connector-banana`, `var-connectors-cables-connector-edge-card`, `F0`, and `SYM`.
