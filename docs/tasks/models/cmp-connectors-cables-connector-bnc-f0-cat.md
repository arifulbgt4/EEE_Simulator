# CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT - Specify Bnc catalog preset
...
| Variant | `var-connectors-cables-connector-bnc` - Bnc |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Bnc** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectors-cables-connector` (Connector); task scope: variant `var-connectors-cables-connector-bnc` (Bnc); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Connector family-specific implementation reference](../../catalog/families/fam-connectors-cables-connector.md#family-specific-implementation-reference), registry row `fam-connectors-cables-connector`, and variant `var-connectors-cables-connector-bnc` (Bnc).
...
- `docs/tasks/models/cmp-connectors-cables-connector-bnc-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectors-cables-connector-bnc` (Bnc), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT`: variant `var-connectors-cables-connector-bnc` (Bnc), fidelity `F0`, concern `CAT`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CONNECTOR-BNC-F0-CAT` exists and is limited to variant `var-connectors-cables-connector-bnc` (Bnc), `F0`, and `CAT`.
