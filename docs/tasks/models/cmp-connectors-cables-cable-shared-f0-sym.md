# CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM - Create symbol and physical representation for Cable
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Cable**, including accessible orientation/polarity cues and reusable package mapping.
...
- `docs/tasks/models/cmp-connectors-cables-cable-shared-f0-sym.md`
...
- One original `sym-connectors-cables-cable` schematic definition with anchors for `1..N:CONTACTS` (passive; electrical/mechanical), `S:SHIELD` (passive; electrical/mechanical).
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM`: shared family scope across `var-connectors-cables-cable-coaxial`, `var-connectors-cables-cable-ribbon`, `var-connectors-cables-cable-twisted-pair`, `var-connectors-cables-cable-shielded-multicore`, `var-connectors-cables-cable-usb`, `var-connectors-cables-cable-wire-harness`, fidelity `F0`, concern `SYM`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CABLE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectors-cables-cable-coaxial`, `var-connectors-cables-cable-ribbon`, `var-connectors-cables-cable-twisted-pair`, `var-connectors-cables-cable-shielded-multicore`, `var-connectors-cables-cable-usb`, `var-connectors-cables-cable-wire-harness`, `F0`, and `SYM`.
