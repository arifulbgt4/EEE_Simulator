...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-SOUND_DISTANCE_SENSOR-NOMINAL`, `GOLD-SEN-SOUND_DISTANCE_SENSOR-BOUNDARY`, `GOLD-SEN-SOUND_DISTANCE_SENSOR-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, `F4`, and `VALIDATION`.
