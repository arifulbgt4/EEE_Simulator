# CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM - Create symbol and physical representation for Serial peripheral
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Serial peripheral**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-mcu-fpga-serial-peripheral` (Serial peripheral); task scope: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-mcu-fpga-serial-peripheral-shared-f0-sym.md`
...
- One original `sym-mcu-fpga-serial-peripheral` schematic definition with anchors for `IO:GPIO` (bidirectional; digital/firmware/power), `RST:RESET` (input; digital/firmware/power), `CLK:CLOCK` (input; digital/firmware/power), `VDD:VDD` (power; digital/firmware/power), `VSS:VSS` (power; digital/firmware/power).
...
- Scope is limited to `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM`: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, fidelity `F0`, concern `SYM`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F0-SYM` exists and is limited to shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, `F0`, and `SYM`.
