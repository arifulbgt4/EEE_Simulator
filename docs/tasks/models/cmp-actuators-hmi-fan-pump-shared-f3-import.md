# CMP-ACTUATORS-HMI-FAN-PUMP-SHARED-F3-IMPORT - Define import mapping for Fan and pump
...
Implement and validate only the declared external-model mappings for **Fan and pump**.
...
- Stable family: `fam-actuators-hmi-fan-pump` (Fan and pump); task scope: shared family scope across `var-actuators-hmi-fan-pump-fan`, `var-actuators-hmi-fan-pump-blower`, `var-actuators-hmi-fan-pump-pump`, `var-actuators-hmi-fan-pump-compressor`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-actuators-hmi-fan-pump-shared-f3-import.md`
...
- `TEST-CMP-ACTUATORS-HMI-FAN-PUMP-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-FAN-PUMP-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-FAN-PUMP-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-FAN-PUMP-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-actuators-hmi-fan-pump-fan`, `var-actuators-hmi-fan-pump-blower`, `var-actuators-hmi-fan-pump-pump`, `var-actuators-hmi-fan-pump-compressor`, `F3`, and `IMPORT`.
