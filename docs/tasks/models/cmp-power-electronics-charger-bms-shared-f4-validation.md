# CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION - Validate Charger and battery management F4
...
Produce independent validation evidence for **Charger and battery management** at **F4** without modifying the model under test.
...
- Stable family: `fam-power-electronics-charger-bms` (Charger and battery management); task scope: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-power-electronics-charger-bms-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-CHARGER_BMS-NOMINAL`, `GOLD-PWR-CHARGER_BMS-BOUNDARY`, `GOLD-PWR-CHARGER_BMS-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION`: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, `F4`, and `VALIDATION`.
