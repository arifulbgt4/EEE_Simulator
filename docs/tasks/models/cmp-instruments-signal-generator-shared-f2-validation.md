# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION - Validate Signal generator F2
...
Produce independent validation evidence for **Signal generator** at **F2** without modifying the model under test.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F2`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The generator applies the selected deterministic waveform through declared source impedance, amplitude/offset limits, sweep, and synchronization rules.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-INS-SIGNAL_GENERATOR-NOMINAL`, `GOLD-INS-SIGNAL_GENERATOR-BOUNDARY`, `GOLD-INS-SIGNAL_GENERATOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F2`, and `VALIDATION`.
