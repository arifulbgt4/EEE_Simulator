# CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION - Validate TCAD physical device model F5
...
Produce independent validation evidence for **TCAD physical device model** at **F5** without modifying the model under test.
...
- Stable family: `fam-deferred-research-tcad-physics` (TCAD physical device model); task scope: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`; fidelity `F5`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-deferred-research-tcad-physics-shared-f5-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RSH-TCAD_PHYSICS-NOMINAL`, `GOLD-RSH-TCAD_PHYSICS-BOUNDARY`, `GOLD-RSH-TCAD_PHYSICS-FAILURE` at `F5`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION`: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, fidelity `F5`, concern `VALIDATION`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION` exists and is limited to shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, `F5`, and `VALIDATION`.
