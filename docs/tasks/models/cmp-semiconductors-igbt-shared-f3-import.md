# CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT - Define import mapping for Insulated-gate bipolar transistor
...
Implement and validate only the declared external-model mappings for **Insulated-gate bipolar transistor**.
...
- Stable family: `fam-semiconductors-igbt` (Insulated-gate bipolar transistor); task scope: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-semiconductors-igbt-shared-f3-import.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT`: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-IGBT-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, `F3`, and `IMPORT`.
