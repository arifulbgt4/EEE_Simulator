# CMP-PACKAGE-TO-220-TEMPLATE-F0-SYM - Create TO-220 family physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-to-220` - TO-220 family |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-TO-220-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-to-220` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-to-220-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-SYM-FAILURE`
