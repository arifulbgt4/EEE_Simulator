# CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-VALIDATION - Validate Electromechanical body pin map and appearance
...
- `CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-electromechanical-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-VALIDATION-FAILURE`
