# CMP-PACKAGE-QFN-TEMPLATE-F0-VALIDATION - Validate Quad flat no-lead pin map and appearance
...
- `CMP-PACKAGE-QFN-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-qfn-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-VALIDATION-FAILURE`
