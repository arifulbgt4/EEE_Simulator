# CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION - Validate Generic semiconductor black box F2
...
Produce independent validation evidence for **Generic semiconductor black box** at **F2** without modifying the model under test.
...
- Stable family: `fam-semiconductors-semiconductor-generic` (Generic semiconductor black box); task scope: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-semiconductors-semiconductor-generic-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEM-SEMICONDUCTOR_GENERIC-NOMINAL`, `GOLD-SEM-SEMICONDUCTOR_GENERIC-BOUNDARY`, `GOLD-SEM-SEMICONDUCTOR_GENERIC-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION`: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, `F2`, and `VALIDATION`.
