# CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION - Validate Battery source F4
...
Produce independent validation evidence for **Battery source** at **F4** without modifying the model under test.
...
- Stable family: `fam-sources-loads-battery-source` (Battery source); task scope: shared family scope across `var-sources-loads-battery-source-battery-pack`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-sources-loads-battery-source-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SRC-BATTERY_SOURCE-NOMINAL`, `GOLD-SRC-BATTERY_SOURCE-BOUNDARY`, `GOLD-SRC-BATTERY_SOURCE-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION`: shared family scope across `var-sources-loads-battery-source-battery-pack`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-sources-loads-battery-source-battery-pack`, `F4`, and `VALIDATION`.
