# CMP-PACKAGE-QFP-TEMPLATE-F0-DOCS - Document Quad flat package package
...
- `docs/tasks/models/cmp-package-qfp-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-DOCS-FAILURE`
