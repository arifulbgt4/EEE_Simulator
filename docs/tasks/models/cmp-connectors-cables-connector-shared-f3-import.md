# CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F3-IMPORT - Define import mapping for Connector
...
Implement and validate only the declared external-model mappings for **Connector**.
...
- `docs/tasks/models/cmp-connectors-cables-connector-shared-f3-import.md`
...
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CONNECTOR-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-connectors-cables-connector-pin-header`, `var-connectors-cables-connector-terminal-block`, `var-connectors-cables-connector-usb-a`, `var-connectors-cables-connector-usb-c`, `var-connectors-cables-connector-rj45`, `var-connectors-cables-connector-bnc`, `var-connectors-cables-connector-d-sub`, `var-connectors-cables-connector-jst-style`, `var-connectors-cables-connector-molex-style`, `var-connectors-cables-connector-barrel`, `var-connectors-cables-connector-banana`, `var-connectors-cables-connector-edge-card`, `F3`, and `IMPORT`.
