# CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT - Define import mapping for Multiplexer and code converter
...
Implement and validate only the declared external-model mappings for **Multiplexer and code converter**.
...
- Stable family: `fam-digital-logic-mux-codec` (Multiplexer and code converter); task scope: shared family scope across `var-digital-logic-mux-codec-multiplexer`, `var-digital-logic-mux-codec-demultiplexer`, `var-digital-logic-mux-codec-encoder`, `var-digital-logic-mux-codec-decoder`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-digital-logic-mux-codec-shared-f3-import.md`
...
- Scope is limited to `CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT`: shared family scope across `var-digital-logic-mux-codec-multiplexer`, `var-digital-logic-mux-codec-demultiplexer`, `var-digital-logic-mux-codec-encoder`, `var-digital-logic-mux-codec-decoder`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-MUX-CODEC-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-digital-logic-mux-codec-multiplexer`, `var-digital-logic-mux-codec-demultiplexer`, `var-digital-logic-mux-codec-encoder`, `var-digital-logic-mux-codec-decoder`, `F3`, and `IMPORT`.
