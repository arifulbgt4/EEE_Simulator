# CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-CAT - Specify Sensor module package template
...
- `docs/tasks/models/cmp-package-sensor-module-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-CAT-FAILURE`
