# CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-DOCS - Document Axial two-lead body package
...
- `docs/tasks/models/cmp-package-axial-2-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-DOCS-FAILURE`
