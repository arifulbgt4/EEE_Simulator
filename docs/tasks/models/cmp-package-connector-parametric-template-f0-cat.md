# CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-CAT - Specify Parametric connector package template
...
- `docs/tasks/models/cmp-package-connector-parametric-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-CAT-FAILURE`
