# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-IMPORT - Define import mapping for Surge and ESD suppressor
...
Implement and validate only the declared external-model mappings for **Surge and ESD suppressor**.
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f3-import.md`
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F3`, and `IMPORT`.
