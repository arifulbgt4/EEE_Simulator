# CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION - Validate Serial peripheral F2
...
Produce independent validation evidence for **Serial peripheral** at **F2** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-serial-peripheral` (Serial peripheral); task scope: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-mcu-fpga-serial-peripheral-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-SERIAL_PERIPHERAL-NOMINAL`, `GOLD-MCU-SERIAL_PERIPHERAL-BOUNDARY`, `GOLD-MCU-SERIAL_PERIPHERAL-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION`: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, `F2`, and `VALIDATION`.
