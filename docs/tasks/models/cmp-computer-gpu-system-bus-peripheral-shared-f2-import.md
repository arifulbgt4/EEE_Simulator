# CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT - Define import mapping for System bus and peripheral
...
Implement and validate only the declared external-model mappings for **System bus and peripheral**.
...
- Stable family: `fam-computer-gpu-system-bus-peripheral` (System bus and peripheral); task scope: shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`; fidelity `F2`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-computer-gpu-system-bus-peripheral-shared-f2-import.md`
...
- Scope is limited to `CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT`: shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`, fidelity `F2`, concern `IMPORT`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-SYSTEM-BUS-PERIPHERAL-SHARED-F2-IMPORT` exists and is limited to shared family scope across `var-computer-gpu-system-bus-peripheral-address-bus`, `var-computer-gpu-system-bus-peripheral-data-bus`, `var-computer-gpu-system-bus-peripheral-control-bus`, `var-computer-gpu-system-bus-peripheral-interrupt-bus`, `var-computer-gpu-system-bus-peripheral-dma-controller`, `F2`, and `IMPORT`.
