# CMP-PACKAGE-DIP-TEMPLATE-F0-VALIDATION - Validate Dual in-line package pin map and appearance
...
- `CMP-PACKAGE-DIP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-dip-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-VALIDATION-FAILURE`
