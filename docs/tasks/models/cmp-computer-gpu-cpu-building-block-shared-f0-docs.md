...
- `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-SYM`
- `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-MODEL`
- `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-VALIDATION`
- `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F2-MODEL`
- `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F2-VALIDATION`
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-computer-gpu-cpu-building-block`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-computer-gpu-cpu-building-block-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-computer-gpu-cpu-building-block.md` for `fam-computer-gpu-cpu-building-block`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-DOCS`: shared family scope across `var-computer-gpu-cpu-building-block-alu`, `var-computer-gpu-cpu-building-block-register-file`, `var-computer-gpu-cpu-building-block-control-unit`, `var-computer-gpu-cpu-building-block-datapath`, `var-computer-gpu-cpu-building-block-pipeline`, `var-computer-gpu-cpu-building-block-cache`, `var-computer-gpu-cpu-building-block-mmu`, fidelity `F0`, concern `DOCS`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-CPU-BUILDING-BLOCK-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-computer-gpu-cpu-building-block-alu`, `var-computer-gpu-cpu-building-block-register-file`, `var-computer-gpu-cpu-building-block-control-unit`, `var-computer-gpu-cpu-building-block-datapath`, `var-computer-gpu-cpu-building-block-pipeline`, `var-computer-gpu-cpu-building-block-cache`, `var-computer-gpu-cpu-building-block-mmu`, `F0`, and `DOCS`.
