# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL - Implement RF mixer and oscillator F3 model
...
Implement one model tier, **F3**, for **RF mixer and oscillator** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`; fidelity `F3`; concern `MODEL`.
...
- Exact F3 execution rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected conversion/oscillation relation uses declared frequency plan, phase, gain/loss, noise, spurs, locking, and amplitude limits.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-shared-f3-model.md`
...
- One `ModelBinding` for `fam-rf-communications-rf-mixer-oscillator` at `F3` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL`: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, fidelity `F3`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F3-MODEL` exists and is limited to shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, `F3`, and `MODEL`.
