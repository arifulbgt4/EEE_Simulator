# CMP-PACKAGE-QFP-TEMPLATE-F0-CAT - Specify Quad flat package package template
...
- `docs/tasks/models/cmp-package-qfp-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-CAT-FAILURE`
