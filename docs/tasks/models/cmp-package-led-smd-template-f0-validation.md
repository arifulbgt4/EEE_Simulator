# CMP-PACKAGE-LED-SMD-TEMPLATE-F0-VALIDATION - Validate SMD LED pin map and appearance
...
- `CMP-PACKAGE-LED-SMD-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-led-smd-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-VALIDATION-FAILURE`
