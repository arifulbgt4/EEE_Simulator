# CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM - Create symbol and physical representation for MOSFET
...
Create original, electrically unambiguous schematic and recognizable physical representations for **MOSFET**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-semiconductors-mosfet` (MOSFET); task scope: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-semiconductors-mosfet-shared-f0-sym.md`
...
- One original `sym-semiconductors-mosfet` schematic definition with anchors for `1:D` (passive; electrical/optical/thermal), `2:G` (input; electrical/optical/thermal), `3:S` (passive; electrical/optical/thermal), `4:B` (optional; electrical/optical/thermal).
...
- Scope is limited to `CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM`: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-MOSFET-SHARED-F0-SYM` exists and is limited to shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, `F0`, and `SYM`.
