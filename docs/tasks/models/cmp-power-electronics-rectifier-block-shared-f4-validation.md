# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION - Validate Rectifier block F4
...
Produce independent validation evidence for **Rectifier block** at **F4** without modifying the model under test.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-RECTIFIER_BLOCK-NOMINAL`, `GOLD-PWR-RECTIFIER_BLOCK-BOUNDARY`, `GOLD-PWR-RECTIFIER_BLOCK-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F4`, and `VALIDATION`.
