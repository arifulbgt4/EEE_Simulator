# CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION - Validate Antenna F3
...
Produce independent validation evidence for **Antenna** at **F3** without modifying the model under test.
...
- Stable family: `fam-rf-communications-antenna` (Antenna); task scope: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The antenna uses a declared port impedance/S-parameter plus radiation gain/pattern/polarization/efficiency profile over its validated frequency envelope.
...
- `docs/tasks/models/cmp-rf-communications-antenna-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-ANTENNA-NOMINAL`, `GOLD-RFC-ANTENNA-BOUNDARY`, `GOLD-RFC-ANTENNA-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION`: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, `F3`, and `VALIDATION`.
