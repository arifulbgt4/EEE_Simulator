# CMP-PACKAGE-ZIP-TEMPLATE-F0-CAT - Specify Zig-zag in-line package package template
...
- `docs/tasks/models/cmp-package-zip-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-CAT-FAILURE`
