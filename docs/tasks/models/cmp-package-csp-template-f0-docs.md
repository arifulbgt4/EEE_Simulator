# CMP-PACKAGE-CSP-TEMPLATE-F0-DOCS - Document Chip-scale package package
...
- `docs/tasks/models/cmp-package-csp-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-DOCS-FAILURE`
