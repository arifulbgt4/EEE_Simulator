# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT - Specify Local Oscillator catalog preset
...
| Variant | `var-rf-communications-rf-mixer-oscillator-local-oscillator` - Local Oscillator |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Local Oscillator** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: variant `var-rf-communications-rf-mixer-oscillator-local-oscillator` (Local Oscillator); fidelity `F1`; concern `CAT`.
...
- Canonical source: [RF mixer and oscillator family-specific implementation reference](../../catalog/families/fam-rf-communications-rf-mixer-oscillator.md#family-specific-implementation-reference), registry row `fam-rf-communications-rf-mixer-oscillator`, and variant `var-rf-communications-rf-mixer-oscillator-local-oscillator` (Local Oscillator).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected conversion/oscillation relation uses declared frequency plan, phase, gain/loss, noise, spurs, locking, and amplitude limits.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-local-oscillator-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-rf-mixer-oscillator-local-oscillator` (Local Oscillator), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT`: variant `var-rf-communications-rf-mixer-oscillator-local-oscillator` (Local Oscillator), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-LOCAL-OSCILLATOR-F1-CAT` exists and is limited to variant `var-rf-communications-rf-mixer-oscillator-local-oscillator` (Local Oscillator), `F1`, and `CAT`.
