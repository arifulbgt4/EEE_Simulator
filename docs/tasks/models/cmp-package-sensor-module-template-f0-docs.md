# CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-DOCS - Document Sensor module package
...
- `docs/tasks/models/cmp-package-sensor-module-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SENSOR-MODULE-TEMPLATE-F0-DOCS-FAILURE`
