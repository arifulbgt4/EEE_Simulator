...
- Aliases: Coupled inductor, Coupled Inductor, coupled-inductor
...
- Explicit schematic-symbol, physical-appearance, and package references: pkg-radial-2, pkg-custom-parametric.
