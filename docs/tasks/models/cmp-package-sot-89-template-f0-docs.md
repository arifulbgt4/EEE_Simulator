# CMP-PACKAGE-SOT-89-TEMPLATE-F0-DOCS - Document SOT-89 family package
...
- `docs/tasks/models/cmp-package-sot-89-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-DOCS-FAILURE`
