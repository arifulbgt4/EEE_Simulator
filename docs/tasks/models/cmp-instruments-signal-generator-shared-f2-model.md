# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL - Implement Signal generator F2 model
...
Implement one model tier, **F2**, for **Signal generator** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F2`; concern `MODEL`.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f2-model.md`
...
- One `ModelBinding` for `fam-instruments-signal-generator` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F2`, concern `MODEL`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F2`, and `MODEL`.
