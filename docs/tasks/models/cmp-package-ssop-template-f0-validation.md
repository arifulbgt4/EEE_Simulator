# CMP-PACKAGE-SSOP-TEMPLATE-F0-VALIDATION - Validate Shrink small-outline package pin map and appearance
...
- `CMP-PACKAGE-SSOP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-ssop-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-VALIDATION-FAILURE`
