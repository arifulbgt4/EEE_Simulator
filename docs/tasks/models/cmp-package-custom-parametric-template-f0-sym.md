# CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-SYM - Create Custom parametric package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-custom-parametric` - Custom parametric package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Aliases: Custom parametric package
...
- Golden references: GRC-053, GRC-054
...
- Package registry entry `pkg-custom-parametric` revision `1.0.0` is the only geometry/default source for this task.
- Concern-specific golden references: GRC-053, GRC-054. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-custom-parametric-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-SYM-FAILURE`
