# CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION - Validate MCU peripheral F0
...
Produce independent validation evidence for **MCU peripheral** at **F0** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-mcu-peripheral` (MCU peripheral); task scope: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: The selected timer/PWM/watchdog/interrupt/DMA peripheral uses a versioned register and event state machine with declared clock/reset behavior.
...
- `docs/tasks/models/cmp-mcu-fpga-mcu-peripheral-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-MCU_PERIPHERAL-NOMINAL`, `GOLD-MCU-MCU_PERIPHERAL-BOUNDARY`, `GOLD-MCU-MCU_PERIPHERAL-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION`: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, `F0`, and `VALIDATION`.
