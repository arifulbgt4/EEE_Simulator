# CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION - Validate Terminal, net tie, jumper, and domain adapter F1
...
Produce independent validation evidence for **Terminal, net tie, jumper, and domain adapter** at **F1** without modifying the model under test.
...
- Stable family: `fam-connectivity-terminal-bridge` (Terminal, net tie, jumper, and domain adapter); task scope: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`; fidelity `F1`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-connectivity-terminal-bridge-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-CON-TERMINAL_BRIDGE-NOMINAL`, `GOLD-CON-TERMINAL_BRIDGE-BOUNDARY`, `GOLD-CON-TERMINAL_BRIDGE-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION`: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, `F1`, and `VALIDATION`.
