# CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT - Define import mapping for Static RAM
...
Implement and validate only the declared external-model mappings for **Static RAM**.
...
- Stable family: `fam-memory-storage-sram` (Static RAM); task scope: shared family scope across `var-memory-storage-sram-asynchronous`, `var-memory-storage-sram-synchronous`, `var-memory-storage-sram-dual-port`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-memory-storage-sram-shared-f3-import.md`
...
- Scope is limited to `CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT`: shared family scope across `var-memory-storage-sram-asynchronous`, `var-memory-storage-sram-synchronous`, `var-memory-storage-sram-dual-port`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-025, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-MEMORY-STORAGE-SRAM-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-memory-storage-sram-asynchronous`, `var-memory-storage-sram-synchronous`, `var-memory-storage-sram-dual-port`, `F3`, and `IMPORT`.
