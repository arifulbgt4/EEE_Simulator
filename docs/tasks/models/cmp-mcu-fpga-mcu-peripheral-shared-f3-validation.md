# CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION - Validate MCU peripheral F3
...
Produce independent validation evidence for **MCU peripheral** at **F3** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-mcu-peripheral` (MCU peripheral); task scope: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected timer/PWM/watchdog/interrupt/DMA peripheral uses a versioned register and event state machine with declared clock/reset behavior.
...
- `docs/tasks/models/cmp-mcu-fpga-mcu-peripheral-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-MCU_PERIPHERAL-NOMINAL`, `GOLD-MCU-MCU_PERIPHERAL-BOUNDARY`, `GOLD-MCU-MCU_PERIPHERAL-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION`: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, `F3`, and `VALIDATION`.
