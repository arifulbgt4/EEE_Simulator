# CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT - Specify Power Amplifier catalog preset
...
| Variant | `var-rf-communications-rf-switch-amplifier-power-amplifier` - Power Amplifier |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Power Amplifier** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-rf-switch-amplifier` (RF switch and amplifier); task scope: variant `var-rf-communications-rf-switch-amplifier-power-amplifier` (Power Amplifier); fidelity `F1`; concern `CAT`.
...
- Canonical source: [RF switch and amplifier family-specific implementation reference](../../catalog/families/fam-rf-communications-rf-switch-amplifier.md#family-specific-implementation-reference), registry row `fam-rf-communications-rf-switch-amplifier`, and variant `var-rf-communications-rf-switch-amplifier-power-amplifier` (Power Amplifier).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected state maps ports through declared gain/loss, match, noise, compression, isolation, and switching behavior over frequency and bias.
...
- `docs/tasks/models/cmp-rf-communications-rf-switch-amplifier-power-amplifier-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-rf-switch-amplifier-power-amplifier` (Power Amplifier), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT`: variant `var-rf-communications-rf-switch-amplifier-power-amplifier` (Power Amplifier), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-POWER-AMPLIFIER-F1-CAT` exists and is limited to variant `var-rf-communications-rf-switch-amplifier-power-amplifier` (Power Amplifier), `F1`, and `CAT`.
