# CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-DOCS - Document Custom parametric package package
...
- `docs/tasks/models/cmp-package-custom-parametric-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-DOCS-FAILURE`
