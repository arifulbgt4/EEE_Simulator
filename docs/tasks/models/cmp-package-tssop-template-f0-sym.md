# CMP-PACKAGE-TSSOP-TEMPLATE-F0-SYM - Create Thin shrink small-outline package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-tssop` - Thin shrink small-outline package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-TSSOP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-tssop` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-tssop-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-SYM-FAILURE`
