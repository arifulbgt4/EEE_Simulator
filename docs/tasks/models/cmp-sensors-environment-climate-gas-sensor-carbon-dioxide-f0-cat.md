# CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT - Specify Carbon Dioxide catalog preset
...
| Variant | `var-sensors-environment-climate-gas-sensor-carbon-dioxide` - Carbon Dioxide |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Carbon Dioxide** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-sensors-environment-climate-gas-sensor` (Climate and gas sensor); task scope: variant `var-sensors-environment-climate-gas-sensor-carbon-dioxide` (Carbon Dioxide); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Climate and gas sensor family-specific implementation reference](../../catalog/families/fam-sensors-environment-climate-gas-sensor.md#family-specific-implementation-reference), registry row `fam-sensors-environment-climate-gas-sensor`, and variant `var-sensors-environment-climate-gas-sensor-carbon-dioxide` (Carbon Dioxide).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Output follows the declared humidity/gas concentration transfer with warm-up, cross-sensitivity, saturation, response/recovery, and environmental terms.
...
- `docs/tasks/models/cmp-sensors-environment-climate-gas-sensor-carbon-dioxide-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-sensors-environment-climate-gas-sensor-carbon-dioxide` (Carbon Dioxide), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT`: variant `var-sensors-environment-climate-gas-sensor-carbon-dioxide` (Carbon Dioxide), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-CLIMATE-GAS-SENSOR-CARBON-DIOXIDE-F0-CAT` exists and is limited to variant `var-sensors-environment-climate-gas-sensor-carbon-dioxide` (Carbon Dioxide), `F0`, and `CAT`.
