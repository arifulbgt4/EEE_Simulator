# CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM - Create symbol and physical representation for Display
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Display**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-actuators-hmi-display` (Display); task scope: shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-actuators-hmi-display-shared-f0-sym.md`
...
- One original `sym-actuators-hmi-display` schematic definition with anchors for `1:DRIVE+` (input; electrical/mechanical/optical/acoustic), `2:DRIVE-` (input; electrical/mechanical/optical/acoustic), `M:MECHANICAL_OR_DISPLAY` (physical; electrical/mechanical/optical/acoustic).
...
- Scope is limited to `CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM`: shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`, fidelity `F0`, concern `SYM`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-DISPLAY-SHARED-F0-SYM` exists and is limited to shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`, `F0`, and `SYM`.
