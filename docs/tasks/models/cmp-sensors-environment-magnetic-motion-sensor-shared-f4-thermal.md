# CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL - Implement Magnetic and motion sensor electrothermal behavior
...
Implement only the F4 power, temperature and electrothermal feedback concern for **Magnetic and motion sensor**.
...
- Stable family: `fam-sensors-environment-magnetic-motion-sensor` (Magnetic and motion sensor); task scope: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`; fidelity `F4`; concern `THERMAL`.
...
- `docs/tasks/models/cmp-sensors-environment-magnetic-motion-sensor-shared-f4-thermal.md`
...
- One F4 thermal-state contract for `fam-sensors-environment-magnetic-motion-sensor` naming P, T, Tamb, Rth, Cth, initial state, valid range, update order, and unsupported coupling behavior.
- Deterministic steady/transient thermal and runaway/limit evidence tied to the exact family reference vectors.
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL`: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, fidelity `F4`, concern `THERMAL`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F4-THERMAL` exists and is limited to shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, `F4`, and `THERMAL`.
