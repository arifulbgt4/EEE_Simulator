# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS - Document Surge and ESD suppressor
...
Publish user and contributor documentation for **Surge and ESD suppressor** without changing its model, symbol, package, or validation behavior.
...
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-SYM`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-MODEL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-VALIDATION`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F1-MODEL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F1-VALIDATION`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-MODEL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-MODEL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F3-VALIDATION`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-MODEL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-VALIDATION`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-THERMAL`
- `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE`
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-switch-protection-surge-suppressor.md` for `fam-switch-protection-surge-suppressor`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS`: shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, fidelity `F0`, concern `DOCS`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F0`, and `DOCS`.
