# CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM - Create symbol and physical representation for FPGA and HDL block
...
Create original, electrically unambiguous schematic and recognizable physical representations for **FPGA and HDL block**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-mcu-fpga-fpga-hdl` (FPGA and HDL block); task scope: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-mcu-fpga-fpga-hdl-shared-f0-sym.md`
...
- One original `sym-mcu-fpga-fpga-hdl` schematic definition with anchors for `IO:GPIO` (bidirectional; digital/firmware/power), `RST:RESET` (input; digital/firmware/power), `CLK:CLOCK` (input; digital/firmware/power), `VDD:VDD` (power; digital/firmware/power), `VSS:VSS` (power; digital/firmware/power).
...
- Scope is limited to `CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM`: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, fidelity `F0`, concern `SYM`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-FPGA-HDL-SHARED-F0-SYM` exists and is limited to shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, `F0`, and `SYM`.
