# CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION - Validate Ferrite suppressor F2
...
Produce independent validation evidence for **Ferrite suppressor** at **F2** without modifying the model under test.
...
- Stable family: `fam-passives-ferrite` (Ferrite suppressor); task scope: shared family scope across `var-passives-ferrite-bead`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-passives-ferrite-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PAS-FERRITE-NOMINAL`, `GOLD-PAS-FERRITE-BOUNDARY`, `GOLD-PAS-FERRITE-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION`: shared family scope across `var-passives-ferrite-bead`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-FERRITE-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-passives-ferrite-bead`, `F2`, and `VALIDATION`.
