# CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT - Define import mapping for Microcontroller
...
Implement and validate only the declared external-model mappings for **Microcontroller**.
...
- Stable family: `fam-mcu-fpga-microcontroller` (Microcontroller); task scope: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-mcu-fpga-microcontroller-shared-f3-import.md`
...
- Scope is limited to `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT`: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, fidelity `F3`, concern `IMPORT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, `F3`, and `IMPORT`.
