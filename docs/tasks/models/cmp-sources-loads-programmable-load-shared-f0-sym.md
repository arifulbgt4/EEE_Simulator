# CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM - Create symbol and physical representation for Programmable load
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Programmable load**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-sources-loads-programmable-load` (Programmable load); task scope: shared family scope across `var-sources-loads-programmable-load-profiled-load`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-sources-loads-programmable-load-shared-f0-sym.md`
...
- One original `sym-sources-loads-programmable-load` schematic definition with anchors for `1:P` (passive; electrical/stimulus), `2:N` (passive; electrical/stimulus).
...
- Scope is limited to `CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM`: shared family scope across `var-sources-loads-programmable-load-profiled-load`, fidelity `F0`, concern `SYM`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F0-SYM` exists and is limited to shared family scope across `var-sources-loads-programmable-load-profiled-load`, `F0`, and `SYM`.
