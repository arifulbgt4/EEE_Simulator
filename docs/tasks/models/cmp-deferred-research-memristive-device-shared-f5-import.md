# CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT - Define import mapping for Memristive device
...
Implement and validate only the declared external-model mappings for **Memristive device**.
...
- Stable family: `fam-deferred-research-memristive-device` (Memristive device); task scope: shared family scope across `var-deferred-research-memristive-device-memristor`; fidelity `F5`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-deferred-research-memristive-device-shared-f5-import.md`
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT`: shared family scope across `var-deferred-research-memristive-device-memristor`, fidelity `F5`, concern `IMPORT`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-MEMRISTIVE-DEVICE-SHARED-F5-IMPORT` exists and is limited to shared family scope across `var-deferred-research-memristive-device-memristor`, `F5`, and `IMPORT`.
