# CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION - Validate Independent voltage source F0
...
Produce independent validation evidence for **Independent voltage source** at **F0** without modifying the model under test.
...
- Stable family: `fam-sources-loads-independent-voltage` (Independent voltage source); task scope: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: The branch constraint is v(P) - v(N) = V(t), with V(t) supplied by the selected DC/AC/transient profile.
...
- `docs/tasks/models/cmp-sources-loads-independent-voltage-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SRC-INDEPENDENT_VOLTAGE-NOMINAL`, `GOLD-SRC-INDEPENDENT_VOLTAGE-BOUNDARY`, `GOLD-SRC-INDEPENDENT_VOLTAGE-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION`: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, `F0`, and `VALIDATION`.
