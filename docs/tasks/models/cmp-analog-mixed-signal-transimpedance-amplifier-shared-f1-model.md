# CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL - Implement Transimpedance amplifier F1 model
...
Implement one model tier, **F1**, for **Transimpedance amplifier** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-analog-mixed-signal-transimpedance-amplifier` (Transimpedance amplifier); task scope: shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Output is the bounded transfer Vout = Vref - Iin*Zfeedback over the declared bandwidth, including stability/noise constraints.
...
- `docs/tasks/models/cmp-analog-mixed-signal-transimpedance-amplifier-shared-f1-model.md`
...
- One `ModelBinding` for `fam-analog-mixed-signal-transimpedance-amplifier` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL`: shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`, fidelity `F1`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-analog-mixed-signal-transimpedance-amplifier-ideal`, `var-analog-mixed-signal-transimpedance-amplifier-band-limited`, `F1`, and `MODEL`.
