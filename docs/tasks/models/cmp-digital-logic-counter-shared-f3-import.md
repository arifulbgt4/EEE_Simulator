# CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT - Define import mapping for Counter
...
Implement and validate only the declared external-model mappings for **Counter**.
...
- Stable family: `fam-digital-logic-counter` (Counter); task scope: shared family scope across `var-digital-logic-counter-ripple`, `var-digital-logic-counter-synchronous`, `var-digital-logic-counter-up-down`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-digital-logic-counter-shared-f3-import.md`
...
- Scope is limited to `CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT`: shared family scope across `var-digital-logic-counter-ripple`, `var-digital-logic-counter-synchronous`, `var-digital-logic-counter-up-down`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-COUNTER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-digital-logic-counter-ripple`, `var-digital-logic-counter-synchronous`, `var-digital-logic-counter-up-down`, `F3`, and `IMPORT`.
