# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION - Validate Rectifier block F2
...
Produce independent validation evidence for **Rectifier block** at **F2** without modifying the model under test.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-RECTIFIER_BLOCK-NOMINAL`, `GOLD-PWR-RECTIFIER_BLOCK-BOUNDARY`, `GOLD-PWR-RECTIFIER_BLOCK-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F2`, and `VALIDATION`.
