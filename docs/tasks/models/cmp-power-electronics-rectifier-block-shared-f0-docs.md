# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS - Document Rectifier block
...
Publish user and contributor documentation for **Rectifier block** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-HALF-WAVE-F0-CAT`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-FULL-WAVE-F0-CAT`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-THREE-PHASE-F0-CAT`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-MODEL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-VALIDATION`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-MODEL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-MODEL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F2-VALIDATION`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-MODEL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-MODEL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-VALIDATION`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-THERMAL`
- `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE`
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F0`; concern `DOCS`.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-power-electronics-rectifier-block.md` for `fam-power-electronics-rectifier-block`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F0`, concern `DOCS`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F0`, and `DOCS`.
