# CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT - Define import mapping for PWM controller
...
Implement and validate only the declared external-model mappings for **PWM controller**.
...
- Stable family: `fam-power-electronics-pwm-controller` (PWM controller); task scope: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-power-electronics-pwm-controller-shared-f3-import.md`
...
- Scope is limited to `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT`: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, `F3`, and `IMPORT`.
