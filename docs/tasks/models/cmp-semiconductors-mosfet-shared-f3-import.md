# CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT - Define import mapping for MOSFET
...
Implement and validate only the declared external-model mappings for **MOSFET**.
...
- Stable family: `fam-semiconductors-mosfet` (MOSFET); task scope: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-semiconductors-mosfet-shared-f3-import.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT`: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-MOSFET-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, `F3`, and `IMPORT`.
