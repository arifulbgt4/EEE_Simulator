# CMP-PACKAGE-DIP-TEMPLATE-F0-CAT - Specify Dual in-line package package template
...
- `docs/tasks/models/cmp-package-dip-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-CAT-FAILURE`
