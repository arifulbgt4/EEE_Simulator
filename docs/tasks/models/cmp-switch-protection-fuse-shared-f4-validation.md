# CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION - Validate Fuse and resettable protector F4
...
Produce independent validation evidence for **Fuse and resettable protector** at **F4** without modifying the model under test.
...
- Stable family: `fam-switch-protection-fuse` (Fuse and resettable protector); task scope: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-switch-protection-fuse-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-FUSE-NOMINAL`, `GOLD-SWP-FUSE-BOUNDARY`, `GOLD-SWP-FUSE-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION`: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, `F4`, and `VALIDATION`.
