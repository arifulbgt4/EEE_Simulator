# CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE - Implement Display failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Display**.
...
- Stable family: `fam-actuators-hmi-display` (Display); task scope: shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-actuators-hmi-display-shared-f4-failure.md`
...
- Scope is limited to `CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE`: shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`, fidelity `F4`, concern `FAILURE`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-DISPLAY-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-actuators-hmi-display-seven-segment`, `var-actuators-hmi-display-dot-matrix`, `var-actuators-hmi-display-lcd`, `var-actuators-hmi-display-oled`, `var-actuators-hmi-display-e-paper`, `F4`, and `FAILURE`.
