# CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS - Document TCAD physical device model
...
Publish user and contributor documentation for **TCAD physical device model** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SEMICONDUCTOR-DEVICE-F5-CAT`
- `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-PHOTONIC-DEVICE-F5-CAT`
- `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM`
- `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-MODEL`
- `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-VALIDATION`
...
- Stable family: `fam-deferred-research-tcad-physics` (TCAD physical device model); task scope: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-deferred-research-tcad-physics`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-deferred-research-tcad-physics-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-deferred-research-tcad-physics.md` for `fam-deferred-research-tcad-physics`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS`: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, fidelity `F0`, concern `DOCS`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, `F0`, and `DOCS`.
