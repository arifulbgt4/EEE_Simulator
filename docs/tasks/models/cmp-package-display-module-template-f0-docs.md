# CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-DOCS - Document Display module package
...
- `docs/tasks/models/cmp-package-display-module-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-DISPLAY-MODULE-TEMPLATE-F0-DOCS-FAILURE`
