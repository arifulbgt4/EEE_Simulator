# CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT - Define import mapping for Vacuum tube
...
Implement and validate only the declared external-model mappings for **Vacuum tube**.
...
- Stable family: `fam-deferred-research-vacuum-tube` (Vacuum tube); task scope: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`; fidelity `F5`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-deferred-research-vacuum-tube-shared-f5-import.md`
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT`: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, fidelity `F5`, concern `IMPORT`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-IMPORT` exists and is limited to shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, `F5`, and `IMPORT`.
