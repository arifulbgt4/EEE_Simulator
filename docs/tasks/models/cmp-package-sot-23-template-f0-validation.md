# CMP-PACKAGE-SOT-23-TEMPLATE-F0-VALIDATION - Validate SOT-23 family pin map and appearance
...
- `CMP-PACKAGE-SOT-23-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-sot-23-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-23-TEMPLATE-F0-VALIDATION-FAILURE`
