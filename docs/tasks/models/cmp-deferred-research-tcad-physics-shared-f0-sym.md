# CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM - Create symbol and physical representation for TCAD physical device model
...
Create original, electrically unambiguous schematic and recognizable physical representations for **TCAD physical device model**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-deferred-research-tcad-physics` (TCAD physical device model); task scope: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-deferred-research-tcad-physics-shared-f0-sym.md`
...
- One original `sym-deferred-research-tcad-physics` schematic definition with anchors for `1..N:TERMINALS` (multiphysics; research/multiphysics).
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM`: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, fidelity `F0`, concern `SYM`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F0-SYM` exists and is limited to shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, `F0`, and `SYM`.
