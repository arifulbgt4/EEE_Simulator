# CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-VALIDATION - Validate Virtual or schematic-only pin map and appearance
...
- `CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-virtual-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-VALIDATION-FAILURE`
