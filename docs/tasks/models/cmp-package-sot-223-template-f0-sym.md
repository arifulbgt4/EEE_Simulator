# CMP-PACKAGE-SOT-223-TEMPLATE-F0-SYM - Create SOT-223 family physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-sot-223` - SOT-223 family |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-SOT-223-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-sot-223` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-sot-223-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-SYM-FAILURE`
