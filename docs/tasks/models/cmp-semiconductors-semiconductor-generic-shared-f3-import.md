# CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT - Define import mapping for Generic semiconductor black box
...
Implement and validate only the declared external-model mappings for **Generic semiconductor black box**.
...
- Stable family: `fam-semiconductors-semiconductor-generic` (Generic semiconductor black box); task scope: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-semiconductors-semiconductor-generic-shared-f3-import.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT`: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, `F3`, and `IMPORT`.
