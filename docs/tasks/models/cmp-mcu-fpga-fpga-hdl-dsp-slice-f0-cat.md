# CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT - Specify Dsp Slice catalog preset
...
| Variant | `var-mcu-fpga-fpga-hdl-dsp-slice` - Dsp Slice |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Dsp Slice** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-mcu-fpga-fpga-hdl` (FPGA and HDL block); task scope: variant `var-mcu-fpga-fpga-hdl-dsp-slice` (Dsp Slice); fidelity `F0`; concern `CAT`.
...
- Canonical source: [FPGA and HDL block family-specific implementation reference](../../catalog/families/fam-mcu-fpga-fpga-hdl.md#family-specific-implementation-reference), registry row `fam-mcu-fpga-fpga-hdl`, and variant `var-mcu-fpga-fpga-hdl-dsp-slice` (Dsp Slice).
...
- `docs/tasks/models/cmp-mcu-fpga-fpga-hdl-dsp-slice-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-mcu-fpga-fpga-hdl-dsp-slice` (Dsp Slice), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT`: variant `var-mcu-fpga-fpga-hdl-dsp-slice` (Dsp Slice), fidelity `F0`, concern `CAT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT-NOMINAL`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-FPGA-HDL-DSP-SLICE-F0-CAT` exists and is limited to variant `var-mcu-fpga-fpga-hdl-dsp-slice` (Dsp Slice), `F0`, and `CAT`.
