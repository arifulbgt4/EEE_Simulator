# CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION - Validate Transmission line F0
...
Produce independent validation evidence for **Transmission line** at **F0** without modifying the model under test.
...
- Stable family: `fam-passives-transmission-line` (Transmission line); task scope: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Voltage/current propagation follows the declared characteristic impedance and delay or RLGC telegrapher model; terminations and reference direction are explicit.
...
- `docs/tasks/models/cmp-passives-transmission-line-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PAS-TRANSMISSION_LINE-NOMINAL`, `GOLD-PAS-TRANSMISSION_LINE-BOUNDARY`, `GOLD-PAS-TRANSMISSION_LINE-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION`: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, `F0`, and `VALIDATION`.
