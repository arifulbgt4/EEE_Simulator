# CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT - Specify Clock Pattern catalog preset
...
| Variant | `var-instruments-signal-generator-clock-pattern` - Clock Pattern |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Clock Pattern** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: variant `var-instruments-signal-generator-clock-pattern` (Clock Pattern); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Signal generator family-specific implementation reference](../../catalog/families/fam-instruments-signal-generator.md#family-specific-implementation-reference), registry row `fam-instruments-signal-generator`, and variant `var-instruments-signal-generator-clock-pattern` (Clock Pattern).
...
- `docs/tasks/models/cmp-instruments-signal-generator-clock-pattern-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-instruments-signal-generator-clock-pattern` (Clock Pattern), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT`: variant `var-instruments-signal-generator-clock-pattern` (Clock Pattern), fidelity `F0`, concern `CAT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-CLOCK-PATTERN-F0-CAT` exists and is limited to variant `var-instruments-signal-generator-clock-pattern` (Clock Pattern), `F0`, and `CAT`.
