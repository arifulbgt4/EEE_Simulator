# CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM - Create symbol and physical representation for Vacuum tube
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Vacuum tube**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-deferred-research-vacuum-tube` (Vacuum tube); task scope: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-deferred-research-vacuum-tube-shared-f0-sym.md`
...
- One original `sym-deferred-research-vacuum-tube` schematic definition with anchors for `1..N:TERMINALS` (multiphysics; research/multiphysics).
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM`: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, fidelity `F0`, concern `SYM`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, `F0`, and `SYM`.
