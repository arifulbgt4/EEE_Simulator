# CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT - Specify Parity catalog preset
...
| Variant | `var-digital-logic-digital-comparator-parity` - Parity |
| Fidelity | F0 |
| Concern | CAT |
| Release | R5 |
...
Create the complete, immutable catalog definition for **Parity** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-digital-logic-digital-comparator` (Digital comparator); task scope: variant `var-digital-logic-digital-comparator-parity` (Parity); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Digital comparator family-specific implementation reference](../../catalog/families/fam-digital-logic-digital-comparator.md#family-specific-implementation-reference), registry row `fam-digital-logic-digital-comparator`, and variant `var-digital-logic-digital-comparator-parity` (Parity).
...
- `docs/tasks/models/cmp-digital-logic-digital-comparator-parity-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-digital-logic-digital-comparator-parity` (Parity), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT`: variant `var-digital-logic-digital-comparator-parity` (Parity), fidelity `F0`, concern `CAT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-PARITY-F0-CAT` exists and is limited to variant `var-digital-logic-digital-comparator-parity` (Parity), `F0`, and `CAT`.
