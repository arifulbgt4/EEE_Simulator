# CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS - Document Sound and distance sensor
...
Publish user and contributor documentation for **Sound and distance sensor** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-MICROPHONE-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-INFRARED-DISTANCE-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-LIDAR-F0-CAT`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F1-MODEL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F1-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-MODEL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F3-MODEL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F3-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-MODEL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-VALIDATION`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-THERMAL`
- `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F4-FAILURE`
...
- Stable family: `fam-sensors-environment-sound-distance-sensor` (Sound and distance sensor); task scope: shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-sensors-environment-sound-distance-sensor`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-sensors-environment-sound-distance-sensor.md` for `fam-sensors-environment-sound-distance-sensor`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS`: shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, fidelity `F0`, concern `DOCS`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, `F0`, and `DOCS`.
