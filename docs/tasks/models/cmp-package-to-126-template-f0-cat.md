# CMP-PACKAGE-TO-126-TEMPLATE-F0-CAT - Specify TO-126 family package template
...
- `docs/tasks/models/cmp-package-to-126-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-CAT-FAILURE`
