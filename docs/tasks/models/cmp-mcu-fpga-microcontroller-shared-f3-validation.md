# CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION - Validate Microcontroller F3
...
Produce independent validation evidence for **Microcontroller** at **F3** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-microcontroller` (Microcontroller); task scope: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected MCU profile advances architectural/firmware state on deterministic ticks and exposes only the declared GPIO, interrupt, peripheral, memory, clock, and reset semantics.
...
- `docs/tasks/models/cmp-mcu-fpga-microcontroller-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-MICROCONTROLLER-NOMINAL`, `GOLD-MCU-MICROCONTROLLER-BOUNDARY`, `GOLD-MCU-MICROCONTROLLER-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION`: shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MICROCONTROLLER-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-microcontroller-generic-8-bit`, `var-mcu-fpga-microcontroller-generic-32-bit`, `var-mcu-fpga-microcontroller-avr-profile`, `var-mcu-fpga-microcontroller-arm-profile`, `var-mcu-fpga-microcontroller-risc-v-profile`, `var-mcu-fpga-microcontroller-pic-profile`, `F3`, and `VALIDATION`.
