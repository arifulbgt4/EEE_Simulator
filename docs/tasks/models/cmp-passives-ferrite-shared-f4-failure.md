# CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE - Implement Ferrite suppressor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Ferrite suppressor**.
...
- Stable family: `fam-passives-ferrite` (Ferrite suppressor); task scope: shared family scope across `var-passives-ferrite-bead`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-passives-ferrite-shared-f4-failure.md`
...
- Scope is limited to `CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE`: shared family scope across `var-passives-ferrite-bead`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-FERRITE-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-passives-ferrite-bead`, `F4`, and `FAILURE`.
