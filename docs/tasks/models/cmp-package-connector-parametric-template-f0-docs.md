# CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-DOCS - Document Parametric connector package
...
- `docs/tasks/models/cmp-package-connector-parametric-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-CONNECTOR-PARAMETRIC-TEMPLATE-F0-DOCS-FAILURE`
