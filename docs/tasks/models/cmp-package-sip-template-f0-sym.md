# CMP-PACKAGE-SIP-TEMPLATE-F0-SYM - Create Single in-line package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-sip` - Single in-line package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-SIP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-sip` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-sip-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-SYM-FAILURE`
