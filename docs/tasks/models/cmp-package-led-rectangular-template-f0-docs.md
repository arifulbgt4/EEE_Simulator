# CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-DOCS - Document Rectangular through-hole LED package
...
- `docs/tasks/models/cmp-package-led-rectangular-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-DOCS-FAILURE`
