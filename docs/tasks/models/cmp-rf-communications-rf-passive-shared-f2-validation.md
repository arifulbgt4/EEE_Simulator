# CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION - Validate RF passive F2
...
Produce independent validation evidence for **RF passive** at **F2** without modifying the model under test.
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-RF_PASSIVE-NOMINAL`, `GOLD-RFC-RF_PASSIVE-BOUNDARY`, `GOLD-RFC-RF_PASSIVE-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION`: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, `F2`, and `VALIDATION`.
