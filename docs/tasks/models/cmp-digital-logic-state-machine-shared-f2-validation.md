# CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION - Validate State machine F2
...
Produce independent validation evidence for **State machine** at **F2** without modifying the model under test.
...
- Stable family: `fam-digital-logic-state-machine` (State machine); task scope: shared family scope across `var-digital-logic-state-machine-moore`, `var-digital-logic-state-machine-mealy`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-digital-logic-state-machine-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-DIG-STATE_MACHINE-NOMINAL`, `GOLD-DIG-STATE_MACHINE-BOUNDARY`, `GOLD-DIG-STATE_MACHINE-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION`: shared family scope across `var-digital-logic-state-machine-moore`, `var-digital-logic-state-machine-mealy`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-STATE-MACHINE-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-digital-logic-state-machine-moore`, `var-digital-logic-state-machine-mealy`, `F2`, and `VALIDATION`.
