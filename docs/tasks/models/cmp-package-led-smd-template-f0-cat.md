# CMP-PACKAGE-LED-SMD-TEMPLATE-F0-CAT - Specify SMD LED package template
...
- `docs/tasks/models/cmp-package-led-smd-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-CAT-FAILURE`
