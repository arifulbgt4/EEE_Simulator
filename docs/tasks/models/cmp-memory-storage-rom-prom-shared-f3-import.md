# CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT - Define import mapping for ROM and PROM
...
Implement and validate only the declared external-model mappings for **ROM and PROM**.
...
- Stable family: `fam-memory-storage-rom-prom` (ROM and PROM); task scope: shared family scope across `var-memory-storage-rom-prom-mask-rom`, `var-memory-storage-rom-prom-prom`, `var-memory-storage-rom-prom-eprom`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-memory-storage-rom-prom-shared-f3-import.md`
...
- Scope is limited to `CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT`: shared family scope across `var-memory-storage-rom-prom-mask-rom`, `var-memory-storage-rom-prom-prom`, `var-memory-storage-rom-prom-eprom`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-025, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-MEMORY-STORAGE-ROM-PROM-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-memory-storage-rom-prom-mask-rom`, `var-memory-storage-rom-prom-prom`, `var-memory-storage-rom-prom-eprom`, `F3`, and `IMPORT`.
