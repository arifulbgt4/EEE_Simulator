# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM - Create symbol and physical representation for Rectifier block
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Rectifier block**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f0-sym.md`
...
- One original `sym-power-electronics-rectifier-block` schematic definition with anchors for `IN+:INPUT+` (power; electrical/control/thermal), `IN-:INPUT-` (power; electrical/control/thermal), `OUT+:OUTPUT+` (power; electrical/control/thermal), `OUT-:OUTPUT-` (power; electrical/control/thermal), `CTRL:CONTROL` (input; electrical/control/thermal).
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F0-SYM` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F0`, and `SYM`.
