# CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-VALIDATION - Validate SMD chip passive pin map and appearance
...
- `CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-smd-chip-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-VALIDATION-FAILURE`
