# CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM - Create symbol and physical representation for Digital pattern source
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Digital pattern source**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-sources-loads-digital-pattern-source` (Digital pattern source); task scope: shared family scope across `var-sources-loads-digital-pattern-source-pattern`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-sources-loads-digital-pattern-source-shared-f0-sym.md`
...
- One original `sym-sources-loads-digital-pattern-source` schematic definition with anchors for `1:P` (passive; electrical/stimulus), `2:N` (passive; electrical/stimulus).
...
- Scope is limited to `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM`: shared family scope across `var-sources-loads-digital-pattern-source-pattern`, fidelity `F0`, concern `SYM`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-DIGITAL-PATTERN-SOURCE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-sources-loads-digital-pattern-source-pattern`, `F0`, and `SYM`.
