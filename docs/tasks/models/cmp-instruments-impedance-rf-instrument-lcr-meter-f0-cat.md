# CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT - Specify Lcr Meter catalog preset
...
| Variant | `var-instruments-impedance-rf-instrument-lcr-meter` - Lcr Meter |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Lcr Meter** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-instruments-impedance-rf-instrument` (Impedance and RF instrument); task scope: variant `var-instruments-impedance-rf-instrument-lcr-meter` (Lcr Meter); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-instruments-impedance-rf-instrument-lcr-meter-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-instruments-impedance-rf-instrument-lcr-meter` (Lcr Meter), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT`: variant `var-instruments-impedance-rf-instrument-lcr-meter` (Lcr Meter), fidelity `F0`, concern `CAT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-LCR-METER-F0-CAT` exists and is limited to variant `var-instruments-impedance-rf-instrument-lcr-meter` (Lcr Meter), `F0`, and `CAT`.
