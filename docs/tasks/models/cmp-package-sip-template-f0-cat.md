# CMP-PACKAGE-SIP-TEMPLATE-F0-CAT - Specify Single in-line package package template
...
- `docs/tasks/models/cmp-package-sip-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-CAT-FAILURE`
