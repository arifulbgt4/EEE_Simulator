# CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-CAT - Specify SMD chip passive package template
...
- `docs/tasks/models/cmp-package-smd-chip-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-CAT-FAILURE`
