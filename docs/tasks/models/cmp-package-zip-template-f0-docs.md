# CMP-PACKAGE-ZIP-TEMPLATE-F0-DOCS - Document Zig-zag in-line package package
...
- `docs/tasks/models/cmp-package-zip-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-DOCS-FAILURE`
