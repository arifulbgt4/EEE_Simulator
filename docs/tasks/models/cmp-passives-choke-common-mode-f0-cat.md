# CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT - Specify Common Mode catalog preset
...
| Variant | `var-passives-choke-common-mode` - Common Mode |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Common Mode** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-passives-choke` (Choke); task scope: variant `var-passives-choke-common-mode` (Common Mode); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Choke family-specific implementation reference](../../catalog/families/fam-passives-choke.md#family-specific-implementation-reference), registry row `fam-passives-choke`, and variant `var-passives-choke-common-mode` (Common Mode).
...
- `docs/tasks/models/cmp-passives-choke-common-mode-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-passives-choke-common-mode` (Common Mode), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT`: variant `var-passives-choke-common-mode` (Common Mode), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT-NOMINAL`
- `TEST-CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT-BOUNDARY`
- `TEST-CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-CHOKE-COMMON-MODE-F0-CAT` exists and is limited to variant `var-passives-choke-common-mode` (Common Mode), `F0`, and `CAT`.
