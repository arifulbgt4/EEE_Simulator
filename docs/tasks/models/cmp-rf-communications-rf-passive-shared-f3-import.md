# CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT - Define import mapping for RF passive
...
Implement and validate only the declared external-model mappings for **RF passive**.
...
- Stable family: `fam-rf-communications-rf-passive` (RF passive); task scope: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-shared-f3-import.md`
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT`: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, fidelity `F3`, concern `IMPORT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, `F3`, and `IMPORT`.
