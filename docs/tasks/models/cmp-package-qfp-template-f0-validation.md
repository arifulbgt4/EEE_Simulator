# CMP-PACKAGE-QFP-TEMPLATE-F0-VALIDATION - Validate Quad flat package pin map and appearance
...
- `CMP-PACKAGE-QFP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-qfp-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-QFP-TEMPLATE-F0-VALIDATION-FAILURE`
