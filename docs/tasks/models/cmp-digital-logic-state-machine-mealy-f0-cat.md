# CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT - Specify Mealy catalog preset
...
| Variant | `var-digital-logic-state-machine-mealy` - Mealy |
| Fidelity | F0 |
| Concern | CAT |
| Release | R5 |
...
Create the complete, immutable catalog definition for **Mealy** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-digital-logic-state-machine` (State machine); task scope: variant `var-digital-logic-state-machine-mealy` (Mealy); fidelity `F0`; concern `CAT`.
...
- Canonical source: [State machine family-specific implementation reference](../../catalog/families/fam-digital-logic-state-machine.md#family-specific-implementation-reference), registry row `fam-digital-logic-state-machine`, and variant `var-digital-logic-state-machine-mealy` (Mealy).
...
- `docs/tasks/models/cmp-digital-logic-state-machine-mealy-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-digital-logic-state-machine-mealy` (Mealy), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT`: variant `var-digital-logic-state-machine-mealy` (Mealy), fidelity `F0`, concern `CAT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-STATE-MACHINE-MEALY-F0-CAT` exists and is limited to variant `var-digital-logic-state-machine-mealy` (Mealy), `F0`, and `CAT`.
