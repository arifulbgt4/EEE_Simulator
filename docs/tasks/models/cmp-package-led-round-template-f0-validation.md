# CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-VALIDATION - Validate Round through-hole LED pin map and appearance
...
- `CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-led-round-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-VALIDATION-FAILURE`
