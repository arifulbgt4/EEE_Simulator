# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION - Validate RF mixer and oscillator F2
...
Produce independent validation evidence for **RF mixer and oscillator** at **F2** without modifying the model under test.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`; fidelity `F2`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The selected conversion/oscillation relation uses declared frequency plan, phase, gain/loss, noise, spurs, locking, and amplitude limits.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-RF_MIXER_OSCILLATOR-NOMINAL`, `GOLD-RFC-RF_MIXER_OSCILLATOR-BOUNDARY`, `GOLD-RFC-RF_MIXER_OSCILLATOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION`: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, `F2`, and `VALIDATION`.
