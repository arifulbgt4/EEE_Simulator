# CMP-PACKAGE-DFN-TEMPLATE-F0-DOCS - Document Dual flat no-lead package
...
- `docs/tasks/models/cmp-package-dfn-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-DOCS-FAILURE`
