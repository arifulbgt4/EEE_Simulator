# CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION - Validate Transmission gate F4
...
Produce independent validation evidence for **Transmission gate** at **F4** without modifying the model under test.
...
- Stable family: `fam-switch-protection-transmission-gate` (Transmission gate); task scope: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-switch-protection-transmission-gate-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-TRANSMISSION_GATE-NOMINAL`, `GOLD-SWP-TRANSMISSION_GATE-BOUNDARY`, `GOLD-SWP-TRANSMISSION_GATE-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION`: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, `F4`, and `VALIDATION`.
