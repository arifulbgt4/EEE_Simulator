# CMP-PACKAGE-PLCC-TEMPLATE-F0-CAT - Specify Plastic leaded chip carrier package template
...
- `docs/tasks/models/cmp-package-plcc-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-CAT-FAILURE`
