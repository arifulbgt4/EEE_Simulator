# CMP-PACKAGE-TO-220-TEMPLATE-F0-DOCS - Document TO-220 family package
...
- `docs/tasks/models/cmp-package-to-220-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-DOCS-FAILURE`
