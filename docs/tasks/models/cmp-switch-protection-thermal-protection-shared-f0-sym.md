# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM - Create symbol and physical representation for Thermal protection
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Thermal protection**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-shared-f0-sym.md`
...
- One original `sym-switch-protection-thermal-protection` schematic definition with anchors for `1:P` (passive; electrical/control), `2:N` (passive; electrical/control).
...
- Scope is limited to `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM`: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, fidelity `F0`, concern `SYM`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F0-SYM` exists and is limited to shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, `F0`, and `SYM`.
