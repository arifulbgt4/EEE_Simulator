# CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM - Create symbol and physical representation for Digital comparator
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Digital comparator**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-digital-logic-digital-comparator` (Digital comparator); task scope: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-digital-logic-digital-comparator-shared-f0-sym.md`
...
- One original `sym-digital-logic-digital-comparator` schematic definition with anchors for `1..N:INPUTS` (input; digital/power), `N+1..M:OUTPUTS` (output; digital/power), `VDD:VDD` (power; digital/power), `VSS:VSS` (power; digital/power).
...
- Scope is limited to `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM`: shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, fidelity `F0`, concern `SYM`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-DIGITAL-COMPARATOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-digital-logic-digital-comparator-magnitude`, `var-digital-logic-digital-comparator-parity`, `F0`, and `SYM`.
