# CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION - Validate RF passive F1
...
Produce independent validation evidence for **RF passive** at **F1** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F1 rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The attenuator/balun/coupler/filter network is defined by its validated S/Y/Z/ABCD relation with reference impedance, port order, loss, and bandwidth.
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-RF_PASSIVE-NOMINAL`, `GOLD-RFC-RF_PASSIVE-BOUNDARY`, `GOLD-RFC-RF_PASSIVE-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION`: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, `F1`, and `VALIDATION`.
