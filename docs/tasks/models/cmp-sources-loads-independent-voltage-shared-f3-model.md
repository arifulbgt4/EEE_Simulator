# CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL - Implement Independent voltage source F3 model
...
Implement one model tier, **F3**, for **Independent voltage source** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-sources-loads-independent-voltage` (Independent voltage source); task scope: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`; fidelity `F3`; concern `MODEL`.
...
- Exact F3 execution rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The branch constraint is v(P) - v(N) = V(t), with V(t) supplied by the selected DC/AC/transient profile.
...
- `docs/tasks/models/cmp-sources-loads-independent-voltage-shared-f3-model.md`
...
- One `ModelBinding` for `fam-sources-loads-independent-voltage` at `F3` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL`: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, fidelity `F3`, concern `MODEL`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F3-MODEL` exists and is limited to shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, `F3`, and `MODEL`.
