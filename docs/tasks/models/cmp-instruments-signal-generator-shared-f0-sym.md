# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM - Create symbol and physical representation for Signal generator
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Signal generator**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f0-sym.md`
...
- One original `sym-instruments-signal-generator` schematic definition with anchors for `CH+:CHANNEL+` (input; measurement/electrical), `CH-:CHANNEL-` (input; measurement/electrical), `COM:COMMON` (reference; measurement/electrical).
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F0`, concern `SYM`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F0`, and `SYM`.
