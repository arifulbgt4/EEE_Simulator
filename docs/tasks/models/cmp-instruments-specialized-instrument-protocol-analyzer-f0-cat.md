...
- Aliases: Specialized instrument, Specialized Instrument, specialized-instrument
...
3. The preset selects only declared model tiers (F0, F1, F2) and never implies manufacturer certification.
