# CMP-PACKAGE-DIP-TEMPLATE-F0-SYM - Create Dual in-line package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-dip` - Dual in-line package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-DIP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-dip` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-dip-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-SYM-FAILURE`
