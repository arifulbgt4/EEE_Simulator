# CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT - Specify Spi catalog preset
...
| Variant | `var-mcu-fpga-serial-peripheral-spi` - Spi |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Spi** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-mcu-fpga-serial-peripheral` (Serial peripheral); task scope: variant `var-mcu-fpga-serial-peripheral-spi` (Spi); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Serial peripheral family-specific implementation reference](../../catalog/families/fam-mcu-fpga-serial-peripheral.md#family-specific-implementation-reference), registry row `fam-mcu-fpga-serial-peripheral`, and variant `var-mcu-fpga-serial-peripheral-spi` (Spi).
...
- `docs/tasks/models/cmp-mcu-fpga-serial-peripheral-spi-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-mcu-fpga-serial-peripheral-spi` (Spi), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT`: variant `var-mcu-fpga-serial-peripheral-spi` (Spi), fidelity `F0`, concern `CAT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT-NOMINAL`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SPI-F0-CAT` exists and is limited to variant `var-mcu-fpga-serial-peripheral-spi` (Spi), `F0`, and `CAT`.
