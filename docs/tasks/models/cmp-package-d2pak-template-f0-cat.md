# CMP-PACKAGE-D2PAK-TEMPLATE-F0-CAT - Specify D2PAK or TO-263 package template
...
- `docs/tasks/models/cmp-package-d2pak-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-CAT-FAILURE`
