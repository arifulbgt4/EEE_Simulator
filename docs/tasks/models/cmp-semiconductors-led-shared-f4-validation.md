# CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION - Validate Light-emitting diode F4
...
Produce independent validation evidence for **Light-emitting diode** at **F4** without modifying the model under test.
...
- Stable family: `fam-semiconductors-led` (Light-emitting diode); task scope: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-semiconductors-led-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEM-LED-NOMINAL`, `GOLD-SEM-LED-BOUNDARY`, `GOLD-SEM-LED-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION`: shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-LED-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-semiconductors-led-visible`, `var-semiconductors-led-rgb`, `var-semiconductors-led-infrared`, `var-semiconductors-led-ultraviolet`, `var-semiconductors-led-high-power`, `F4`, and `VALIDATION`.
