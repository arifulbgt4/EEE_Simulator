# CMP-PACKAGE-ZIP-TEMPLATE-F0-SYM - Create Zig-zag in-line package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-zip` - Zig-zag in-line package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-ZIP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-zip` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-zip-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-SYM-FAILURE`
