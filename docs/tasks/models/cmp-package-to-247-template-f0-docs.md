# CMP-PACKAGE-TO-247-TEMPLATE-F0-DOCS - Document TO-247 family package
...
- `docs/tasks/models/cmp-package-to-247-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-DOCS-FAILURE`
