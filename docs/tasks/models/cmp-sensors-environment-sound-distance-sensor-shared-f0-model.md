# CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL - Implement Sound and distance sensor F0 model
...
Implement one model tier, **F0**, for **Sound and distance sensor** using the family equations/behavior and no higher-fidelity claims.
...
- Exact F0 execution rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Output follows the acoustic pressure or time-of-flight relation with propagation speed, range, blanking, echo/noise, and timeout behavior.
...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-shared-f0-model.md`
...
- One `ModelBinding` for `fam-sensors-environment-sound-distance-sensor` at `F0` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-MODEL` exists and is limited to shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, `F0`, and `MODEL`.
