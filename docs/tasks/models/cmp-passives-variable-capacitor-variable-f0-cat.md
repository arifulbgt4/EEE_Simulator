...
- Aliases: Variable capacitor, Variable Capacitor, variable-capacitor
...
- Explicit schematic-symbol, physical-appearance, and package references: pkg-radial-2, pkg-axial-2, pkg-smd-chip.
