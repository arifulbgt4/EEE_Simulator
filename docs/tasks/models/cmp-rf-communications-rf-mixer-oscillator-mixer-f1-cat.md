# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT - Specify Mixer catalog preset
...
| Variant | `var-rf-communications-rf-mixer-oscillator-mixer` - Mixer |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Mixer** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: variant `var-rf-communications-rf-mixer-oscillator-mixer` (Mixer); fidelity `F1`; concern `CAT`.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-mixer-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-rf-mixer-oscillator-mixer` (Mixer), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT`: variant `var-rf-communications-rf-mixer-oscillator-mixer` (Mixer), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-MIXER-F1-CAT` exists and is limited to variant `var-rf-communications-rf-mixer-oscillator-mixer` (Mixer), `F1`, and `CAT`.
