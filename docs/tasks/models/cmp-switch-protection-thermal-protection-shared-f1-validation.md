# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION - Validate Thermal protection F1
...
Produce independent validation evidence for **Thermal protection** at **F1** without modifying the model under test.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`; fidelity `F1`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F1 rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Temperature drives a hysteretic open/closed or limiting state at declared trip/reset thresholds with thermal delay and fail-safe behavior.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-THERMAL_PROTECTION-NOMINAL`, `GOLD-SWP-THERMAL_PROTECTION-BOUNDARY`, `GOLD-SWP-THERMAL_PROTECTION-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION`: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, `F1`, and `VALIDATION`.
