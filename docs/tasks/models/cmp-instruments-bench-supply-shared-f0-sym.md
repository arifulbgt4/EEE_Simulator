# CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM - Create symbol and physical representation for Bench supply
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Bench supply**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-instruments-bench-supply` (Bench supply); task scope: shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-instruments-bench-supply-shared-f0-sym.md`
...
- One original `sym-instruments-bench-supply` schematic definition with anchors for `CH+:CHANNEL+` (input; measurement/electrical), `CH-:CHANNEL-` (input; measurement/electrical), `COM:COMMON` (reference; measurement/electrical).
...
- Scope is limited to `CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM`: shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`, fidelity `F0`, concern `SYM`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-BENCH-SUPPLY-SHARED-F0-SYM` exists and is limited to shared family scope across `var-instruments-bench-supply-single-output`, `var-instruments-bench-supply-triple-output`, `F0`, and `SYM`.
