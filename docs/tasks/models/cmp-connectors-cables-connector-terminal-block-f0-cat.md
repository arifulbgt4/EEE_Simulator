# CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT - Specify Terminal Block catalog preset
...
|---|---|
| Status | Planned |
| Family | `fam-connectors-cables-connector` - Connector |
| Variant | `var-connectors-cables-connector-terminal-block` - Terminal Block |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Terminal Block** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectors-cables-connector` (Connector); task scope: variant `var-connectors-cables-connector-terminal-block` (Terminal Block); fidelity `F0`; concern `CAT`.
...
- Selected variant tiers: `F0`, `F1`, `F3`; release target: Post-MVP catalog; package references: `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric`.
...
- Canonical source: [Connector family-specific implementation reference](../../catalog/families/fam-connectors-cables-connector.md#family-specific-implementation-reference), registry row `fam-connectors-cables-connector`, and variant `var-connectors-cables-connector-terminal-block` (Terminal Block).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Logical pins map bijectively to connector contacts; F1/F3 may add only declared contact RLC, shielding, coupling, and rating constraints.
...
- `docs/tasks/models/cmp-connectors-cables-connector-terminal-block-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectors-cables-connector-terminal-block` (Terminal Block), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT`: variant `var-connectors-cables-connector-terminal-block` (Terminal Block), fidelity `F0`, concern `CAT`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CONNECTOR-TERMINAL-BLOCK-F0-CAT` exists and is limited to variant `var-connectors-cables-connector-terminal-block` (Terminal Block), `F0`, and `CAT`.
