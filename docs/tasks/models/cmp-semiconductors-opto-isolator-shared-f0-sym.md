# CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM - Create symbol and physical representation for Optically isolated semiconductor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Optically isolated semiconductor**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-semiconductors-opto-isolator` (Optically isolated semiconductor); task scope: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-semiconductors-opto-isolator-shared-f0-sym.md`
...
- One original `sym-semiconductors-opto-isolator` schematic definition with anchors for `1:P` (passive; electrical/optical/thermal), `2:N` (passive; electrical/optical/thermal).
...
- Scope is limited to `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM`: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, `F0`, and `SYM`.
