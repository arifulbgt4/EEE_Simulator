# CMP-PACKAGE-DIP-TEMPLATE-F0-DOCS - Document Dual in-line package package
...
- `docs/tasks/models/cmp-package-dip-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-DIP-TEMPLATE-F0-DOCS-FAILURE`
