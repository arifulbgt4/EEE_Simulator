# CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT - Specify Dipole catalog preset
...
| Variant | `var-rf-communications-antenna-dipole` - Dipole |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Dipole** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-antenna` (Antenna); task scope: variant `var-rf-communications-antenna-dipole` (Dipole); fidelity `F1`; concern `CAT`.
...
- Canonical source: [Antenna family-specific implementation reference](../../catalog/families/fam-rf-communications-antenna.md#family-specific-implementation-reference), registry row `fam-rf-communications-antenna`, and variant `var-rf-communications-antenna-dipole` (Dipole).
...
- `docs/tasks/models/cmp-rf-communications-antenna-dipole-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-antenna-dipole` (Dipole), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT`: variant `var-rf-communications-antenna-dipole` (Dipole), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-ANTENNA-DIPOLE-F1-CAT` exists and is limited to variant `var-rf-communications-antenna-dipole` (Dipole), `F1`, and `CAT`.
