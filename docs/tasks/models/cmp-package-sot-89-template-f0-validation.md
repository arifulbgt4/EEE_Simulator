# CMP-PACKAGE-SOT-89-TEMPLATE-F0-VALIDATION - Validate SOT-89 family pin map and appearance
...
- `CMP-PACKAGE-SOT-89-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-sot-89-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-89-TEMPLATE-F0-VALIDATION-FAILURE`
