# CMP-PACKAGE-D2PAK-TEMPLATE-F0-SYM - Create D2PAK or TO-263 physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-d2pak` - D2PAK or TO-263 |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-D2PAK-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-d2pak` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-d2pak-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-SYM-FAILURE`
