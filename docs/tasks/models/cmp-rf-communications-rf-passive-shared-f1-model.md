# CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL - Implement RF passive F1 model
...
Implement one model tier, **F1**, for **RF passive** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-rf-passive` (RF passive); task scope: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The attenuator/balun/coupler/filter network is defined by its validated S/Y/Z/ABCD relation with reference impedance, port order, loss, and bandwidth.
...
- `docs/tasks/models/cmp-rf-communications-rf-passive-shared-f1-model.md`
...
- One `ModelBinding` for `fam-rf-communications-rf-passive` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL`: shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, fidelity `F1`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-PASSIVE-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-rf-communications-rf-passive-attenuator`, `var-rf-communications-rf-passive-balun`, `var-rf-communications-rf-passive-coupler`, `var-rf-communications-rf-passive-splitter-combiner`, `F1`, and `MODEL`.
