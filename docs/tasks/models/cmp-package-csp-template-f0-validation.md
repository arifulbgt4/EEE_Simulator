# CMP-PACKAGE-CSP-TEMPLATE-F0-VALIDATION - Validate Chip-scale package pin map and appearance
...
- `CMP-PACKAGE-CSP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-csp-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-VALIDATION-FAILURE`
