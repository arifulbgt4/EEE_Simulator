# CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM - Create symbol and physical representation for Sound and distance sensor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Sound and distance sensor**, including accessible orientation/polarity cues and reusable package mapping.
...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-shared-f0-sym.md`
...
- One original `sym-sensors-environment-sound-distance-sensor` schematic definition with anchors for `S:STIMULUS` (physical; electrical/physical/environmental), `O:OUTPUT` (output; electrical/physical/environmental), `VDD:VDD` (power; electrical/physical/environmental), `GND:GND` (power; electrical/physical/environmental).
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, `F0`, and `SYM`.
