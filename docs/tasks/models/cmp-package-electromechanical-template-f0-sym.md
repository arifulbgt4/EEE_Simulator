# CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-SYM - Create Electromechanical body physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-electromechanical` - Electromechanical body |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-electromechanical` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-electromechanical-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-SYM-FAILURE`
