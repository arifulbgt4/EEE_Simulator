# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE - Implement Surge and ESD suppressor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Surge and ESD suppressor**.
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f4-failure.md`
...
- Scope is limited to `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE`: shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, fidelity `F4`, concern `FAILURE`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F4`, and `FAILURE`.
