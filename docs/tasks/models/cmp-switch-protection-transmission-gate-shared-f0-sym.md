# CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM - Create symbol and physical representation for Transmission gate
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Transmission gate**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-switch-protection-transmission-gate` (Transmission gate); task scope: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-switch-protection-transmission-gate-shared-f0-sym.md`
...
- One original `sym-switch-protection-transmission-gate` schematic definition with anchors for `1:P` (passive; electrical/control), `2:N` (passive; electrical/control).
...
- Scope is limited to `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM`: shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, fidelity `F0`, concern `SYM`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-switch-protection-transmission-gate-cmos`, `var-switch-protection-transmission-gate-bidirectional`, `F0`, and `SYM`.
