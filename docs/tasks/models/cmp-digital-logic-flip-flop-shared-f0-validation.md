# CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION - Validate Flip-flop F0
...
Produce independent validation evidence for **Flip-flop** at **F0** without modifying the model under test.
...
- Stable family: `fam-digital-logic-flip-flop` (Flip-flop); task scope: shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Stored state updates on the declared clock edge from D/JK/T/SR inputs, subject to async controls, setup/hold, clock, and X rules.
...
- `docs/tasks/models/cmp-digital-logic-flip-flop-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-DIG-FLIP_FLOP-NOMINAL`, `GOLD-DIG-FLIP_FLOP-BOUNDARY`, `GOLD-DIG-FLIP_FLOP-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION`: shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-FLIP-FLOP-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-digital-logic-flip-flop-d`, `var-digital-logic-flip-flop-jk`, `var-digital-logic-flip-flop-t`, `var-digital-logic-flip-flop-sr`, `F0`, and `VALIDATION`.
