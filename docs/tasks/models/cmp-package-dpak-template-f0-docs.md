# CMP-PACKAGE-DPAK-TEMPLATE-F0-DOCS - Document DPAK or TO-252 package
...
- `docs/tasks/models/cmp-package-dpak-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-DOCS-FAILURE`
