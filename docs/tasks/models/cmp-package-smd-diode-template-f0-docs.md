# CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-DOCS - Document SMD diode package
...
- `docs/tasks/models/cmp-package-smd-diode-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-DOCS-FAILURE`
