# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS - Document Signal generator
...
Publish user and contributor documentation for **Signal generator** without changing its model, symbol, package, or validation behavior.
...
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-SYM`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-MODEL`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F1-MODEL`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F1-VALIDATION`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-MODEL`
- `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F2-VALIDATION`
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-instruments-signal-generator`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-instruments-signal-generator.md` for `fam-instruments-signal-generator`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F0`, concern `DOCS`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F0`, and `DOCS`.
