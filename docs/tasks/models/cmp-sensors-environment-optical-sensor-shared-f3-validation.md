# CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION - Validate Optical sensor F3
...
Produce independent validation evidence for **Optical sensor** at **F3** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: Output follows the calibrated spectral/illuminance transfer plus declared saturation, response time, dark offset, and noise.
...
- `docs/tasks/models/cmp-sensors-environment-optical-sensor-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-OPTICAL_SENSOR-NOMINAL`, `GOLD-SEN-OPTICAL_SENSOR-BOUNDARY`, `GOLD-SEN-OPTICAL_SENSOR-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION`: shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, `F3`, and `VALIDATION`.
