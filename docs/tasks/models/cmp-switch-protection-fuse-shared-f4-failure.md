# CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE - Implement Fuse and resettable protector failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Fuse and resettable protector**.
...
- Stable family: `fam-switch-protection-fuse` (Fuse and resettable protector); task scope: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-switch-protection-fuse-shared-f4-failure.md`
...
- Scope is limited to `CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE`: shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, fidelity `F4`, concern `FAILURE`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-FUSE-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-switch-protection-fuse-fast-blow`, `var-switch-protection-fuse-slow-blow`, `var-switch-protection-fuse-ptc-resettable`, `F4`, and `FAILURE`.
