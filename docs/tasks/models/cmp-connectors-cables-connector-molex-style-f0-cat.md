# CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT - Specify Molex Style catalog preset
...
| Variant | `var-connectors-cables-connector-molex-style` - Molex Style |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Molex Style** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectors-cables-connector` (Connector); task scope: variant `var-connectors-cables-connector-molex-style` (Molex Style); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Connector family-specific implementation reference](../../catalog/families/fam-connectors-cables-connector.md#family-specific-implementation-reference), registry row `fam-connectors-cables-connector`, and variant `var-connectors-cables-connector-molex-style` (Molex Style).
...
- `docs/tasks/models/cmp-connectors-cables-connector-molex-style-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectors-cables-connector-molex-style` (Molex Style), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT`: variant `var-connectors-cables-connector-molex-style` (Molex Style), fidelity `F0`, concern `CAT`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CONNECTOR-MOLEX-STYLE-F0-CAT` exists and is limited to variant `var-connectors-cables-connector-molex-style` (Molex Style), `F0`, and `CAT`.
