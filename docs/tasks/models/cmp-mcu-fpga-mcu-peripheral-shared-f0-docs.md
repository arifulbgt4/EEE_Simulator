# CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS - Document MCU peripheral
...
|---|---|
| Status | Planned |
| Family | `fam-mcu-fpga-mcu-peripheral` - MCU peripheral |
| Variant | `shared` |
| Fidelity | F0 |
| Concern | DOCS |
| Release | R7 |
...
Publish user and contributor documentation for **MCU peripheral** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-MCU-FPGA-MCU-PERIPHERAL-GPIO-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-TIMER-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-PWM-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-WATCHDOG-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-INTERRUPT-CONTROLLER-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-DMA-F0-CAT`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-SYM`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-MODEL`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-VALIDATION`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F2-MODEL`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F2-VALIDATION`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-MODEL`
- `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-VALIDATION`
...
- Stable family: `fam-mcu-fpga-mcu-peripheral` (MCU peripheral); task scope: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-mcu-fpga-mcu-peripheral`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-mcu-fpga-mcu-peripheral-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-mcu-fpga-mcu-peripheral.md` for `fam-mcu-fpga-mcu-peripheral`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS`: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, fidelity `F0`, concern `DOCS`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, `F0`, and `DOCS`.
