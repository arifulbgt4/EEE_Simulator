# CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-DOCS - Document Power module package
...
- `docs/tasks/models/cmp-package-power-module-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-DOCS-FAILURE`
