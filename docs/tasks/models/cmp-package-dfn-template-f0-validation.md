# CMP-PACKAGE-DFN-TEMPLATE-F0-VALIDATION - Validate Dual flat no-lead pin map and appearance
...
- `CMP-PACKAGE-DFN-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-dfn-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-DFN-TEMPLATE-F0-VALIDATION-FAILURE`
