# CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM - Create symbol and physical representation for Photoresistor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Photoresistor**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-passives-photoresistor` (Photoresistor); task scope: shared family scope across `var-passives-photoresistor-ldr`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-passives-photoresistor-shared-f0-sym.md`
...
- One original `sym-passives-photoresistor` schematic definition with anchors for `1:P` (passive; electrical/thermal), `2:N` (passive; electrical/thermal).
...
- Scope is limited to `CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM`: shared family scope across `var-passives-photoresistor-ldr`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-PHOTORESISTOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-passives-photoresistor-ldr`, `F0`, and `SYM`.
