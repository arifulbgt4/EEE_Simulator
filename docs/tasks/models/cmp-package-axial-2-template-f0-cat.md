# CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-CAT - Specify Axial two-lead body package template
...
- Concern-specific golden references: GRC-049. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-axial-2-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-CAT-FAILURE`
