# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE - Implement Rectifier block failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Rectifier block**.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f4-failure.md`
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F4`, and `FAILURE`.
