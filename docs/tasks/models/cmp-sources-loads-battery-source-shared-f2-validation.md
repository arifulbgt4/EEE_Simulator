# CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION - Validate Battery source F2
...
Produce independent validation evidence for **Battery source** at **F2** without modifying the model under test.
...
- Stable family: `fam-sources-loads-battery-source` (Battery source); task scope: shared family scope across `var-sources-loads-battery-source-battery-pack`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-sources-loads-battery-source-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SRC-BATTERY_SOURCE-NOMINAL`, `GOLD-SRC-BATTERY_SOURCE-BOUNDARY`, `GOLD-SRC-BATTERY_SOURCE-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION`: shared family scope across `var-sources-loads-battery-source-battery-pack`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-sources-loads-battery-source-battery-pack`, `F2`, and `VALIDATION`.
