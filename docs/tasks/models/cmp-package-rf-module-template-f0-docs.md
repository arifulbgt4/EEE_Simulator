# CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-DOCS - Document RF module package
...
- `docs/tasks/models/cmp-package-rf-module-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-DOCS-FAILURE`
