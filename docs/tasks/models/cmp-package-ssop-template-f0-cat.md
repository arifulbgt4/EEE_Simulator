# CMP-PACKAGE-SSOP-TEMPLATE-F0-CAT - Specify Shrink small-outline package package template
...
- `docs/tasks/models/cmp-package-ssop-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-CAT-FAILURE`
