# CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-SYM - Create Axial two-lead body physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-axial-2` - Axial two-lead body |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-axial-2` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-axial-2-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-AXIAL-2-TEMPLATE-F0-SYM-FAILURE`
