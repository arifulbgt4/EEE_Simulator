# CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM - Create symbol and physical representation for Independent voltage source
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Independent voltage source**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-sources-loads-independent-voltage` (Independent voltage source); task scope: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-sources-loads-independent-voltage-shared-f0-sym.md`
...
- One original `sym-sources-loads-independent-voltage` schematic definition with anchors for `1:P` (passive; electrical/stimulus), `2:N` (passive; electrical/stimulus).
...
- Scope is limited to `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM`: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, fidelity `F0`, concern `SYM`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, `F0`, and `SYM`.
