# CMP-PASSIVES-FERRITE-SHARED-F0-SYM - Create symbol and physical representation for Ferrite suppressor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Ferrite suppressor**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-passives-ferrite` (Ferrite suppressor); task scope: shared family scope across `var-passives-ferrite-bead`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-passives-ferrite-shared-f0-sym.md`
...
- One original `sym-passives-ferrite` schematic definition with anchors for `1:P` (passive; electrical/thermal), `2:N` (passive; electrical/thermal).
...
- Scope is limited to `CMP-PASSIVES-FERRITE-SHARED-F0-SYM`: shared family scope across `var-passives-ferrite-bead`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-PASSIVES-FERRITE-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-FERRITE-SHARED-F0-SYM` exists and is limited to shared family scope across `var-passives-ferrite-bead`, `F0`, and `SYM`.
