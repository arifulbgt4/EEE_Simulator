# CMP-PACKAGE-LED-SMD-TEMPLATE-F0-DOCS - Document SMD LED package
...
- `docs/tasks/models/cmp-package-led-smd-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-DOCS-FAILURE`
