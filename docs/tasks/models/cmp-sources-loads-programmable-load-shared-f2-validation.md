# CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION - Validate Programmable load F2
...
Produce independent validation evidence for **Programmable load** at **F2** without modifying the model under test.
...
- Stable family: `fam-sources-loads-programmable-load` (Programmable load); task scope: shared family scope across `var-sources-loads-programmable-load-profiled-load`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-sources-loads-programmable-load-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SRC-PROGRAMMABLE_LOAD-NOMINAL`, `GOLD-SRC-PROGRAMMABLE_LOAD-BOUNDARY`, `GOLD-SRC-PROGRAMMABLE_LOAD-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION`: shared family scope across `var-sources-loads-programmable-load-profiled-load`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-PROGRAMMABLE-LOAD-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-sources-loads-programmable-load-profiled-load`, `F2`, and `VALIDATION`.
