# CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-SYM - Create Round through-hole LED physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-led-round` - Round through-hole LED |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-led-round` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-led-round-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-SYM-FAILURE`
