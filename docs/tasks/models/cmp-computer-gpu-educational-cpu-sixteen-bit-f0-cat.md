# CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT - Specify Sixteen Bit catalog preset
...
| Variant | `var-computer-gpu-educational-cpu-sixteen-bit` - Sixteen Bit |
| Fidelity | F0 |
| Concern | CAT |
| Release | R8 |
...
Create the complete, immutable catalog definition for **Sixteen Bit** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-computer-gpu-educational-cpu` (Educational CPU); task scope: variant `var-computer-gpu-educational-cpu-sixteen-bit` (Sixteen Bit); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Educational CPU family-specific implementation reference](../../catalog/families/fam-computer-gpu-educational-cpu.md#family-specific-implementation-reference), registry row `fam-computer-gpu-educational-cpu`, and variant `var-computer-gpu-educational-cpu-sixteen-bit` (Sixteen Bit).
...
- `docs/tasks/models/cmp-computer-gpu-educational-cpu-sixteen-bit-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-computer-gpu-educational-cpu-sixteen-bit` (Sixteen Bit), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT`: variant `var-computer-gpu-educational-cpu-sixteen-bit` (Sixteen Bit), fidelity `F0`, concern `CAT`, and requirements REQ-025, REQ-027, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT-NOMINAL`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT-BOUNDARY`
- `TEST-CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-COMPUTER-GPU-EDUCATIONAL-CPU-SIXTEEN-BIT-F0-CAT` exists and is limited to variant `var-computer-gpu-educational-cpu-sixteen-bit` (Sixteen Bit), `F0`, and `CAT`.
