...
- Stable family: `fam-mcu-fpga-fpga-hdl` (FPGA and HDL block); task scope: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-mcu-fpga-fpga-hdl-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-FPGA_HDL-NOMINAL`, `GOLD-MCU-FPGA_HDL-BOUNDARY`, `GOLD-MCU-FPGA_HDL-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-FPGA-HDL-SHARED-F2-VALIDATION`: shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-FPGA-HDL-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-fpga-hdl-lut`, `var-mcu-fpga-fpga-hdl-block-ram`, `var-mcu-fpga-fpga-hdl-dsp-slice`, `var-mcu-fpga-fpga-hdl-pll`, `var-mcu-fpga-fpga-hdl-hdl-wrapper`, `F2`, and `VALIDATION`.
