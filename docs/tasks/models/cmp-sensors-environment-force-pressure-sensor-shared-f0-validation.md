# CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION - Validate Force and pressure sensor F0
...
Produce independent validation evidence for **Force and pressure sensor** at **F0** without modifying the model under test.
...
- Stable family: `fam-sensors-environment-force-pressure-sensor` (Force and pressure sensor); task scope: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Output follows the calibrated force/strain/pressure transfer with bridge or transducer excitation, range, hysteresis, creep, and temperature terms.
...
- `docs/tasks/models/cmp-sensors-environment-force-pressure-sensor-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-FORCE_PRESSURE_SENSOR-NOMINAL`, `GOLD-SEN-FORCE_PRESSURE_SENSOR-BOUNDARY`, `GOLD-SEN-FORCE_PRESSURE_SENSOR-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION`: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, `F0`, and `VALIDATION`.
