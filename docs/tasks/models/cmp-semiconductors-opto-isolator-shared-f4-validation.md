# CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION - Validate Optically isolated semiconductor F4
...
Produce independent validation evidence for **Optically isolated semiconductor** at **F4** without modifying the model under test.
...
- Stable family: `fam-semiconductors-opto-isolator` (Optically isolated semiconductor); task scope: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-semiconductors-opto-isolator-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEM-OPTO_ISOLATOR-NOMINAL`, `GOLD-SEM-OPTO_ISOLATOR-BOUNDARY`, `GOLD-SEM-OPTO_ISOLATOR-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION`: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, `F4`, and `VALIDATION`.
