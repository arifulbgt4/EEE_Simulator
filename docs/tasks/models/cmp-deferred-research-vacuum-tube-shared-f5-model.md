...
- Stable family: `fam-deferred-research-vacuum-tube` (Vacuum tube); task scope: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`; fidelity `F5`; concern `MODEL`.
...
- `docs/tasks/models/cmp-deferred-research-vacuum-tube-shared-f5-model.md`
...
- One `ModelBinding` for `fam-deferred-research-vacuum-tube` at `F5` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
- One `AnalysisCapability` result for each of `research-only`, with every unlisted analysis rejected rather than approximated.
- Scope is limited to `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-MODEL`: shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, fidelity `F5`, concern `MODEL`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-MODEL-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-MODEL-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-VACUUM-TUBE-SHARED-F5-MODEL` exists and is limited to shared family scope across `var-deferred-research-vacuum-tube-triode`, `var-deferred-research-vacuum-tube-pentode`, `F5`, and `MODEL`.
