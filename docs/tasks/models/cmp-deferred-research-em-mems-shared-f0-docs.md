# CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS - Document Detailed EM and MEMS model
...
|---|---|
| Status | Deferred |
| Family | `fam-deferred-research-em-mems` - Detailed EM and MEMS model |
| Variant | `shared` |
| Fidelity | F0 |
| Concern | DOCS |
| Release | R13 |
...
Publish user and contributor documentation for **Detailed EM and MEMS model** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-DEFERRED-RESEARCH-EM-MEMS-FULL-WAVE-EM-F5-CAT`
- `CMP-DEFERRED-RESEARCH-EM-MEMS-MULTIPHYSICS-MEMS-F5-CAT`
- `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-SYM`
- `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-MODEL`
- `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION`

Every ID above must be `Done` or its named predecessor gate accepted before this card may become `Ready`.

## Context to read

- [Family specification](../../catalog/families/fam-deferred-research-em-mems.md)
...
- Stable family: `fam-deferred-research-em-mems` (Detailed EM and MEMS model); task scope: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`; fidelity `F0`; concern `DOCS`.
...
- Golden references: `GOLD-RSH-EM_MEMS-NOMINAL`, `GOLD-RSH-EM_MEMS-BOUNDARY`, `GOLD-RSH-EM_MEMS-FAILURE`.
...
- Canonical source: [Detailed EM and MEMS model family-specific implementation reference](../../catalog/families/fam-deferred-research-em-mems.md#family-specific-implementation-reference), registry row `fam-deferred-research-em-mems`, and shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-deferred-research-em-mems`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
- Exact reference vectors: `GOLD-RSH-EM_MEMS-NOMINAL`, `GOLD-RSH-EM_MEMS-BOUNDARY`, `GOLD-RSH-EM_MEMS-FAILURE`. Nominal uses the registry defaults above; boundary evaluates every declared limit and supported state; failure covers each declared failure mode plus invalid/non-finite parameters, pin-map mismatch, unsupported analysis, and unavailable fidelity.
- Numerical comparisons use `docs/quality/NUMERICAL_ACCURACY_TARGETS.md`; missing model-specific constants or independent reference data are a named blocker and may not be guessed.

## Allowed files

- `docs/tasks/models/cmp-deferred-research-em-mems-shared-f0-docs.md`
- `docs/tasks/models/task-manifest.yaml`
- `docs/tasks/models/INDEX.md`
- `docs/catalog/component-registry.yaml`
- `docs/catalog/families/fam-deferred-research-em-mems.md`
...
- One evidence-backed final capability section in `families/fam-deferred-research-em-mems.md` for `fam-deferred-research-em-mems`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS`: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, fidelity `F0`, concern `DOCS`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, `F0`, and `DOCS`.
2. The family-specific relation/state rule, pin vector, parameter defaults/limits, analysis list, and package list above agree with `fam-deferred-research-em-mems` and its family specification.
