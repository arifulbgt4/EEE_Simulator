# CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT - Specify Bussed catalog preset
...
| Variant | `var-passives-resistor-array-bussed` - Bussed |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Bussed** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-passives-resistor-array` (Resistor array); task scope: variant `var-passives-resistor-array-bussed` (Bussed); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Resistor array family-specific implementation reference](../../catalog/families/fam-passives-resistor-array.md#family-specific-implementation-reference), registry row `fam-passives-resistor-array`, and variant `var-passives-resistor-array-bussed` (Bussed).
...
- `docs/tasks/models/cmp-passives-resistor-array-bussed-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-passives-resistor-array-bussed` (Bussed), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT`: variant `var-passives-resistor-array-bussed` (Bussed), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT-NOMINAL`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT-BOUNDARY`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-RESISTOR-ARRAY-BUSSED-F0-CAT` exists and is limited to variant `var-passives-resistor-array-bussed` (Bussed), `F0`, and `CAT`.
