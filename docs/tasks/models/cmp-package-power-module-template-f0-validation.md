# CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-VALIDATION - Validate Power module pin map and appearance
...
- `CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-power-module-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-VALIDATION-FAILURE`
