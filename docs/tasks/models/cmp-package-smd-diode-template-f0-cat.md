# CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-CAT - Specify SMD diode package template
...
- `docs/tasks/models/cmp-package-smd-diode-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-CAT-FAILURE`
