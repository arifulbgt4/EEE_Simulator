# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT - Specify Thermostat catalog preset
...
| Variant | `var-switch-protection-thermal-protection-thermostat` - Thermostat |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Thermostat** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: variant `var-switch-protection-thermal-protection-thermostat` (Thermostat); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-thermostat-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-thermal-protection-thermostat` (Thermostat), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT`: variant `var-switch-protection-thermal-protection-thermostat` (Thermostat), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-THERMOSTAT-F0-CAT` exists and is limited to variant `var-switch-protection-thermal-protection-thermostat` (Thermostat), `F0`, and `CAT`.
