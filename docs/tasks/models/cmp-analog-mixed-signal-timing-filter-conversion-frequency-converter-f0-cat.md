# CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT - Specify Frequency Converter catalog preset
...
| Variant | `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` - Frequency Converter |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Frequency Converter** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-analog-mixed-signal-timing-filter-conversion` (Timing, filter, and converter abstraction); task scope: variant `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` (Frequency Converter); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Timing, filter, and converter abstraction family-specific implementation reference](../../catalog/families/fam-analog-mixed-signal-timing-filter-conversion.md#family-specific-implementation-reference), registry row `fam-analog-mixed-signal-timing-filter-conversion`, and variant `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` (Frequency Converter).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected 555/oscillator/VCO/PLL/filter/level/frequency-converter variant uses its declared state-space, transfer, or timed state-machine contract.
...
- `docs/tasks/models/cmp-analog-mixed-signal-timing-filter-conversion-frequency-converter-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` (Frequency Converter), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT`: variant `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` (Frequency Converter), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-TIMING-FILTER-CONVERSION-FREQUENCY-CONVERTER-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-timing-filter-conversion-frequency-converter` (Frequency Converter), `F0`, and `CAT`.
