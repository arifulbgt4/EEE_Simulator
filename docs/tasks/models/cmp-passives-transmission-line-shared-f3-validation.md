# CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION - Validate Transmission line F3
...
Produce independent validation evidence for **Transmission line** at **F3** without modifying the model under test.
...
- Stable family: `fam-passives-transmission-line` (Transmission line); task scope: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: Voltage/current propagation follows the declared characteristic impedance and delay or RLGC telegrapher model; terminations and reference direction are explicit.
...
- `docs/tasks/models/cmp-passives-transmission-line-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PAS-TRANSMISSION_LINE-NOMINAL`, `GOLD-PAS-TRANSMISSION_LINE-BOUNDARY`, `GOLD-PAS-TRANSMISSION_LINE-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION`: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, `F3`, and `VALIDATION`.
