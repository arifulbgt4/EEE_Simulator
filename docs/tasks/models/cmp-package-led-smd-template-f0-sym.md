# CMP-PACKAGE-LED-SMD-TEMPLATE-F0-SYM - Create SMD LED physical renderer
...
- `CMP-PACKAGE-LED-SMD-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-led-smd` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-led-smd-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-SMD-TEMPLATE-F0-SYM-FAILURE`
