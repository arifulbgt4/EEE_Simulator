# CMP-PACKAGE-DPAK-TEMPLATE-F0-CAT - Specify DPAK or TO-252 package template
...
- `docs/tasks/models/cmp-package-dpak-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-DPAK-TEMPLATE-F0-CAT-FAILURE`
