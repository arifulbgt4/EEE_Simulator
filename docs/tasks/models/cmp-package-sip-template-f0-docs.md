# CMP-PACKAGE-SIP-TEMPLATE-F0-DOCS - Document Single in-line package package
...
- `docs/tasks/models/cmp-package-sip-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SIP-TEMPLATE-F0-DOCS-FAILURE`
