# CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION - Validate Sound and distance sensor F2
...
Produce independent validation evidence for **Sound and distance sensor** at **F2** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: Output follows the acoustic pressure or time-of-flight relation with propagation speed, range, blanking, echo/noise, and timeout behavior.
...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-SOUND_DISTANCE_SENSOR-NOMINAL`, `GOLD-SEN-SOUND_DISTANCE_SENSOR-BOUNDARY`, `GOLD-SEN-SOUND_DISTANCE_SENSOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-sound-distance-sensor-microphone`, `var-sensors-environment-sound-distance-sensor-ultrasonic`, `var-sensors-environment-sound-distance-sensor-infrared-distance`, `var-sensors-environment-sound-distance-sensor-lidar`, `F2`, and `VALIDATION`.
