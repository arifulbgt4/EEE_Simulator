# CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS - Document Antenna
...
Publish user and contributor documentation for **Antenna** without changing its model, symbol, package, or validation behavior.
...
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-SYM`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-MODEL`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F1-VALIDATION`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-MODEL`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-MODEL`
- `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F3-VALIDATION`
...
- Stable family: `fam-rf-communications-antenna` (Antenna); task scope: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-rf-communications-antenna`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-rf-communications-antenna-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-rf-communications-antenna.md` for `fam-rf-communications-antenna`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS`: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, fidelity `F0`, concern `DOCS`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, `F0`, and `DOCS`.
