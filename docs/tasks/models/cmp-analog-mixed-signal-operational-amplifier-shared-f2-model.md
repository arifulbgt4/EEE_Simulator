# CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL - Implement Operational amplifier F2 model
...
Implement one model tier, **F2**, for **Operational amplifier** using the family equations/behavior and no higher-fidelity claims.
...
- Exact F2 execution rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: F1 computes Vout = clamp(Aol*(Vplus-Vminus), supply/output limits); higher tiers add poles, slew, bias, noise, common-mode, and output-drive limits.
...
- `docs/tasks/models/cmp-analog-mixed-signal-operational-amplifier-shared-f2-model.md`
...
- One `ModelBinding` for `fam-analog-mixed-signal-operational-amplifier` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL`: shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, fidelity `F2`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-analog-mixed-signal-operational-amplifier-ideal`, `var-analog-mixed-signal-operational-amplifier-bipolar-general-purpose`, `var-analog-mixed-signal-operational-amplifier-cmos`, `var-analog-mixed-signal-operational-amplifier-rail-to-rail`, `F2`, and `MODEL`.
