...
- Stable family: `fam-power-electronics-motor-driver` (Motor driver); task scope: shared family scope across `var-power-electronics-motor-driver-brushed-dc`, `var-power-electronics-motor-driver-bldc`, `var-power-electronics-motor-driver-stepper`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-power-electronics-motor-driver-shared-f3-import.md`
...
- `TEST-CMP-POWER-ELECTRONICS-MOTOR-DRIVER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-MOTOR-DRIVER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-MOTOR-DRIVER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-MOTOR-DRIVER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-power-electronics-motor-driver-brushed-dc`, `var-power-electronics-motor-driver-bldc`, `var-power-electronics-motor-driver-stepper`, `F3`, and `IMPORT`.
