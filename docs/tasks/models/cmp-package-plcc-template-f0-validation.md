# CMP-PACKAGE-PLCC-TEMPLATE-F0-VALIDATION - Validate Plastic leaded chip carrier pin map and appearance
...
- `CMP-PACKAGE-PLCC-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-plcc-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-PLCC-TEMPLATE-F0-VALIDATION-FAILURE`
