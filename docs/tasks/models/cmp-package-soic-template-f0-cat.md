# CMP-PACKAGE-SOIC-TEMPLATE-F0-CAT - Specify Small-outline IC package template
...
- `docs/tasks/models/cmp-package-soic-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-CAT-FAILURE`
