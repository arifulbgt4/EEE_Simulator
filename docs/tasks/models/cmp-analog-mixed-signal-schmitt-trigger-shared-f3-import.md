# CMP-ANALOG-MIXED-SIGNAL-SCHMITT-TRIGGER-SHARED-F3-IMPORT - Define import mapping for Schmitt trigger
...
Implement and validate only the declared external-model mappings for **Schmitt trigger**.
...
- Stable family: `fam-analog-mixed-signal-schmitt-trigger` (Schmitt trigger); task scope: shared family scope across `var-analog-mixed-signal-schmitt-trigger-inverting`, `var-analog-mixed-signal-schmitt-trigger-non-inverting`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-analog-mixed-signal-schmitt-trigger-shared-f3-import.md`
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SCHMITT-TRIGGER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SCHMITT-TRIGGER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SCHMITT-TRIGGER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-SCHMITT-TRIGGER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-analog-mixed-signal-schmitt-trigger-inverting`, `var-analog-mixed-signal-schmitt-trigger-non-inverting`, `F3`, and `IMPORT`.
