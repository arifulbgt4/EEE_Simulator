# CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION - Validate Signal generator F0
...
Produce independent validation evidence for **Signal generator** at **F0** without modifying the model under test.
...
- Stable family: `fam-instruments-signal-generator` (Signal generator); task scope: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: The generator applies the selected deterministic waveform through declared source impedance, amplitude/offset limits, sweep, and synchronization rules.
...
- `docs/tasks/models/cmp-instruments-signal-generator-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-INS-SIGNAL_GENERATOR-NOMINAL`, `GOLD-INS-SIGNAL_GENERATOR-BOUNDARY`, `GOLD-INS-SIGNAL_GENERATOR-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION`: shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-SIGNAL-GENERATOR-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-instruments-signal-generator-function`, `var-instruments-signal-generator-arbitrary-waveform`, `var-instruments-signal-generator-clock-pattern`, `F0`, and `VALIDATION`.
