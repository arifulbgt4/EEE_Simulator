# CMP-PACKAGE-LGA-TEMPLATE-F0-DOCS - Document Land grid array package
...
- `docs/tasks/models/cmp-package-lga-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-DOCS-FAILURE`
