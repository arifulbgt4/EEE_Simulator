# CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F3-IMPORT - Define import mapping for Socket and prototyping board
...
Implement and validate only the declared external-model mappings for **Socket and prototyping board**.
...
- `docs/tasks/models/cmp-connectors-cables-socket-board-shared-f3-import.md`
...
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-connectors-cables-socket-board-ic-socket`, `var-connectors-cables-socket-board-breadboard`, `var-connectors-cables-socket-board-card-socket`, `var-connectors-cables-socket-board-screw-terminal`, `var-connectors-cables-socket-board-spring-terminal`, `var-connectors-cables-socket-board-pogo-array`, `F3`, and `IMPORT`.
