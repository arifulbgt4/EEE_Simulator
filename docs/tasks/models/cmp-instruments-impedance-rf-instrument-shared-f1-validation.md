# CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION - Validate Impedance and RF instrument F1
...
Produce independent validation evidence for **Impedance and RF instrument** at **F1** without modifying the model under test.
...
- Stable family: `fam-instruments-impedance-rf-instrument` (Impedance and RF instrument); task scope: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`; fidelity `F1`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-instruments-impedance-rf-instrument-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-INS-IMPEDANCE_RF_INSTRUMENT-NOMINAL`, `GOLD-INS-IMPEDANCE_RF_INSTRUMENT-BOUNDARY`, `GOLD-INS-IMPEDANCE_RF_INSTRUMENT-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION`: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, `F1`, and `VALIDATION`.
