# CMP-PACKAGE-LGA-TEMPLATE-F0-CAT - Specify Land grid array package template
...
- `docs/tasks/models/cmp-package-lga-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-CAT-FAILURE`
