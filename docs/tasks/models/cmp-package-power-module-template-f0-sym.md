# CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-SYM - Create Power module physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-power-module` - Power module |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-power-module` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-power-module-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-POWER-MODULE-TEMPLATE-F0-SYM-FAILURE`
