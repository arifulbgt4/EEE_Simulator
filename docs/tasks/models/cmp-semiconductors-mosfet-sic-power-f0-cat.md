# CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT - Specify Sic Power catalog preset
...
| Variant | `var-semiconductors-mosfet-sic-power` - Sic Power |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Sic Power** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-semiconductors-mosfet` (MOSFET); task scope: variant `var-semiconductors-mosfet-sic-power` (Sic Power); fidelity `F0`; concern `CAT`.
...
- Canonical source: [MOSFET family-specific implementation reference](../../catalog/families/fam-semiconductors-mosfet.md#family-specific-implementation-reference), registry row `fam-semiconductors-mosfet`, and variant `var-semiconductors-mosfet-sic-power` (Sic Power).
...
- `docs/tasks/models/cmp-semiconductors-mosfet-sic-power-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-semiconductors-mosfet-sic-power` (Sic Power), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT`: variant `var-semiconductors-mosfet-sic-power` (Sic Power), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-MOSFET-SIC-POWER-F0-CAT` exists and is limited to variant `var-semiconductors-mosfet-sic-power` (Sic Power), `F0`, and `CAT`.
