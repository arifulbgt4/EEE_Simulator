# CMP-PACKAGE-TSSOP-TEMPLATE-F0-DOCS - Document Thin shrink small-outline package package
...
- `docs/tasks/models/cmp-package-tssop-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-DOCS-FAILURE`
