# CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL - Implement RF switch and amplifier F1 model
...
Implement one model tier, **F1**, for **RF switch and amplifier** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-rf-switch-amplifier` (RF switch and amplifier); task scope: shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The selected state maps ports through declared gain/loss, match, noise, compression, isolation, and switching behavior over frequency and bias.
...
- `docs/tasks/models/cmp-rf-communications-rf-switch-amplifier-shared-f1-model.md`
...
- One `ModelBinding` for `fam-rf-communications-rf-switch-amplifier` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL`: shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`, fidelity `F1`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`, `F1`, and `MODEL`.
