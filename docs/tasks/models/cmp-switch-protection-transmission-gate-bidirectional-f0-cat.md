# CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT - Specify Bidirectional catalog preset
...
| Variant | `var-switch-protection-transmission-gate-bidirectional` - Bidirectional |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Bidirectional** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-switch-protection-transmission-gate` (Transmission gate); task scope: variant `var-switch-protection-transmission-gate-bidirectional` (Bidirectional); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Transmission gate family-specific implementation reference](../../catalog/families/fam-switch-protection-transmission-gate.md#family-specific-implementation-reference), registry row `fam-switch-protection-transmission-gate`, and variant `var-switch-protection-transmission-gate-bidirectional` (Bidirectional).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Complementary control selects a bidirectional finite-conductance path; conflicting/unknown controls yield the documented X or high-impedance behavior.
...
- `docs/tasks/models/cmp-switch-protection-transmission-gate-bidirectional-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-transmission-gate-bidirectional` (Bidirectional), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT`: variant `var-switch-protection-transmission-gate-bidirectional` (Bidirectional), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-BIDIRECTIONAL-F0-CAT` exists and is limited to variant `var-switch-protection-transmission-gate-bidirectional` (Bidirectional), `F0`, and `CAT`.
