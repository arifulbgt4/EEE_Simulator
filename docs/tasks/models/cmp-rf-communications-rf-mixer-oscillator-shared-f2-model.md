# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL - Implement RF mixer and oscillator F2 model
...
Implement one model tier, **F2**, for **RF mixer and oscillator** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`; fidelity `F2`; concern `MODEL`.
...
- Exact F2 execution rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The selected conversion/oscillation relation uses declared frequency plan, phase, gain/loss, noise, spurs, locking, and amplitude limits.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-shared-f2-model.md`
...
- One `ModelBinding` for `fam-rf-communications-rf-mixer-oscillator` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL`: shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, fidelity `F2`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-rf-communications-rf-mixer-oscillator-mixer`, `var-rf-communications-rf-mixer-oscillator-local-oscillator`, `var-rf-communications-rf-mixer-oscillator-rf-vco`, `F2`, and `MODEL`.
