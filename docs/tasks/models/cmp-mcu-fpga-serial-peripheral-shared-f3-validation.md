# CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION - Validate Serial peripheral F3
...
Produce independent validation evidence for **Serial peripheral** at **F3** without modifying the model under test.
...
- Stable family: `fam-mcu-fpga-serial-peripheral` (Serial peripheral); task scope: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The selected UART/I2C/SPI/CAN/USB profile maps timed line events to framed protocol state with explicit arbitration, errors, buffering, and clock rules.
...
- `docs/tasks/models/cmp-mcu-fpga-serial-peripheral-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-MCU-SERIAL_PERIPHERAL-NOMINAL`, `GOLD-MCU-SERIAL_PERIPHERAL-BOUNDARY`, `GOLD-MCU-SERIAL_PERIPHERAL-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION`: shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-SERIAL-PERIPHERAL-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-mcu-fpga-serial-peripheral-uart`, `var-mcu-fpga-serial-peripheral-i2c`, `var-mcu-fpga-serial-peripheral-spi`, `var-mcu-fpga-serial-peripheral-can`, `var-mcu-fpga-serial-peripheral-usb`, `F3`, and `VALIDATION`.
