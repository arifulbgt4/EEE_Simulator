# CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT - Specify Ultrasonic catalog preset
...
| Variant | `var-sensors-environment-sound-distance-sensor-ultrasonic` - Ultrasonic |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Ultrasonic** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-sensors-environment-sound-distance-sensor` (Sound and distance sensor); task scope: variant `var-sensors-environment-sound-distance-sensor-ultrasonic` (Ultrasonic); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-sensors-environment-sound-distance-sensor-ultrasonic-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-sensors-environment-sound-distance-sensor-ultrasonic` (Ultrasonic), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT`: variant `var-sensors-environment-sound-distance-sensor-ultrasonic` (Ultrasonic), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-SOUND-DISTANCE-SENSOR-ULTRASONIC-F0-CAT` exists and is limited to variant `var-sensors-environment-sound-distance-sensor-ultrasonic` (Ultrasonic), `F0`, and `CAT`.
