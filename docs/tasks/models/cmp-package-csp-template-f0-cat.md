# CMP-PACKAGE-CSP-TEMPLATE-F0-CAT - Specify Chip-scale package package template
...
- Concern-specific golden references: GRC-052. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-csp-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-CSP-TEMPLATE-F0-CAT-FAILURE`
