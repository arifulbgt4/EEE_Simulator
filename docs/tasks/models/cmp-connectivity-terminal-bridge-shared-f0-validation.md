# CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION - Validate Terminal, net tie, jumper, and domain adapter F0
...
Produce independent validation evidence for **Terminal, net tie, jumper, and domain adapter** at **F0** without modifying the model under test.
...
- Stable family: `fam-connectivity-terminal-bridge` (Terminal, net tie, jumper, and domain adapter); task scope: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`; fidelity `F0`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F0 rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Terminal, net-tie, jumper, and domain-adapter variants use an explicit connection matrix; only matrix entries declared closed may share current or potential.
...
- `docs/tasks/models/cmp-connectivity-terminal-bridge-shared-f0-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-CON-TERMINAL_BRIDGE-NOMINAL`, `GOLD-CON-TERMINAL_BRIDGE-BOUNDARY`, `GOLD-CON-TERMINAL_BRIDGE-FAILURE` at `F0`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION`: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, fidelity `F0`, concern `VALIDATION`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION-NOMINAL`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-VALIDATION` exists and is limited to shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, `F0`, and `VALIDATION`.
