# CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-DOCS - Document Parametric cable package
...
- `docs/tasks/models/cmp-package-cable-parametric-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-CABLE-PARAMETRIC-TEMPLATE-F0-DOCS-FAILURE`
