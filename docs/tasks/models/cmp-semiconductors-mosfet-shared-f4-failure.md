# CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE - Implement MOSFET failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **MOSFET**.
...
- Stable family: `fam-semiconductors-mosfet` (MOSFET); task scope: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-semiconductors-mosfet-shared-f4-failure.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE`: shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-MOSFET-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-semiconductors-mosfet-n-enhancement`, `var-semiconductors-mosfet-p-enhancement`, `var-semiconductors-mosfet-n-depletion`, `var-semiconductors-mosfet-p-depletion`, `var-semiconductors-mosfet-gan-power`, `var-semiconductors-mosfet-sic-power`, `F4`, and `FAILURE`.
