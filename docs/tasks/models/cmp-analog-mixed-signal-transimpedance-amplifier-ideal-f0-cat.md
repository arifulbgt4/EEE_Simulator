# CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT - Specify Ideal catalog preset
...
| Variant | `var-analog-mixed-signal-transimpedance-amplifier-ideal` - Ideal |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
- Stable family: `fam-analog-mixed-signal-transimpedance-amplifier` (Transimpedance amplifier); task scope: variant `var-analog-mixed-signal-transimpedance-amplifier-ideal` (Ideal); fidelity `F0`; concern `CAT`.
...
- `docs/tasks/models/cmp-analog-mixed-signal-transimpedance-amplifier-ideal-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-transimpedance-amplifier-ideal` (Ideal), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT`: variant `var-analog-mixed-signal-transimpedance-amplifier-ideal` (Ideal), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-IDEAL-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-transimpedance-amplifier-ideal` (Ideal), `F0`, and `CAT`.
