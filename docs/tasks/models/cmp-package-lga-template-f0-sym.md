# CMP-PACKAGE-LGA-TEMPLATE-F0-SYM - Create Land grid array physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-lga` - Land grid array |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-LGA-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-lga` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-lga-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-LGA-TEMPLATE-F0-SYM-FAILURE`
