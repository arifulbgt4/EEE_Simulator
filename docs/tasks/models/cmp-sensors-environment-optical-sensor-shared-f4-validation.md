# CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION - Validate Optical sensor F4
...
Produce independent validation evidence for **Optical sensor** at **F4** without modifying the model under test.
...
- `docs/tasks/models/cmp-sensors-environment-optical-sensor-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-OPTICAL_SENSOR-NOMINAL`, `GOLD-SEN-OPTICAL_SENSOR-BOUNDARY`, `GOLD-SEN-OPTICAL_SENSOR-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION`: shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, `F4`, and `VALIDATION`.
