# CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-CAT - Specify Electromechanical body package template
...
- `docs/tasks/models/cmp-package-electromechanical-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-CAT-FAILURE`
