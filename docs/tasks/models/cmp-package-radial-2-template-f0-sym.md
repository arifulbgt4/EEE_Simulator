# CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-SYM - Create Radial two-lead body physical renderer
...
- `CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- `docs/tasks/models/cmp-package-radial-2-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-SYM-FAILURE`
