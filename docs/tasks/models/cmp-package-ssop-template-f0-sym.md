# CMP-PACKAGE-SSOP-TEMPLATE-F0-SYM - Create Shrink small-outline package physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-ssop` - Shrink small-outline package |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-SSOP-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-ssop` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-ssop-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-SYM-FAILURE`
