...
- `docs/tasks/models/cmp-connectors-cables-socket-board-shared-f0-sym.md`
...
- One original `sym-connectors-cables-socket-board` schematic definition with anchors for `1..N:CONTACTS` (passive; electrical/mechanical), `S:SHIELD` (passive; electrical/mechanical).
...
- Scope is limited to `CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F0-SYM`: shared family scope across `var-connectors-cables-socket-board-ic-socket`, `var-connectors-cables-socket-board-breadboard`, `var-connectors-cables-socket-board-card-socket`, `var-connectors-cables-socket-board-screw-terminal`, `var-connectors-cables-socket-board-spring-terminal`, `var-connectors-cables-socket-board-pogo-array`, fidelity `F0`, concern `SYM`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-SOCKET-BOARD-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectors-cables-socket-board-ic-socket`, `var-connectors-cables-socket-board-breadboard`, `var-connectors-cables-socket-board-card-socket`, `var-connectors-cables-socket-board-screw-terminal`, `var-connectors-cables-socket-board-spring-terminal`, `var-connectors-cables-socket-board-pogo-array`, `F0`, and `SYM`.
