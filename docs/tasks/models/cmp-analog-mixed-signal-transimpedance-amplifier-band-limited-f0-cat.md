# CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT - Specify Band Limited catalog preset
...
| Variant | `var-analog-mixed-signal-transimpedance-amplifier-band-limited` - Band Limited |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Band Limited** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-analog-mixed-signal-transimpedance-amplifier` (Transimpedance amplifier); task scope: variant `var-analog-mixed-signal-transimpedance-amplifier-band-limited` (Band Limited); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Transimpedance amplifier family-specific implementation reference](../../catalog/families/fam-analog-mixed-signal-transimpedance-amplifier.md#family-specific-implementation-reference), registry row `fam-analog-mixed-signal-transimpedance-amplifier`, and variant `var-analog-mixed-signal-transimpedance-amplifier-band-limited` (Band Limited).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Output is the bounded transfer Vout = Vref - Iin*Zfeedback over the declared bandwidth, including stability/noise constraints.
...
- `docs/tasks/models/cmp-analog-mixed-signal-transimpedance-amplifier-band-limited-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-transimpedance-amplifier-band-limited` (Band Limited), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT`: variant `var-analog-mixed-signal-transimpedance-amplifier-band-limited` (Band Limited), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-TRANSIMPEDANCE-AMPLIFIER-BAND-LIMITED-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-transimpedance-amplifier-band-limited` (Band Limited), `F0`, and `CAT`.
