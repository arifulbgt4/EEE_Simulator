# CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION - Validate Choke F2
...
Produce independent validation evidence for **Choke** at **F2** without modifying the model under test.
...
- Stable family: `fam-passives-choke` (Choke); task scope: shared family scope across `var-passives-choke-common-mode`, `var-passives-choke-differential-mode`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-passives-choke-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PAS-CHOKE-NOMINAL`, `GOLD-PAS-CHOKE-BOUNDARY`, `GOLD-PAS-CHOKE-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION`: shared family scope across `var-passives-choke-common-mode`, `var-passives-choke-differential-mode`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-CHOKE-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-passives-choke-common-mode`, `var-passives-choke-differential-mode`, `F2`, and `VALIDATION`.
