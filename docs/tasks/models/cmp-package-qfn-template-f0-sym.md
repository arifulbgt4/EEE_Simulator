# CMP-PACKAGE-QFN-TEMPLATE-F0-SYM - Create Quad flat no-lead physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-qfn` - Quad flat no-lead |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-QFN-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-qfn` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-qfn-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-SYM-FAILURE`
