# CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-VALIDATION - Validate Radial two-lead body pin map and appearance
...
- `CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-radial-2-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-VALIDATION-FAILURE`
