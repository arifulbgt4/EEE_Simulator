# CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT - Specify Ook Fsk catalog preset
...
| Variant | `var-rf-communications-modem-transceiver-ook-fsk` - Ook Fsk |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Ook Fsk** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-modem-transceiver` (Modem and transceiver); task scope: variant `var-rf-communications-modem-transceiver-ook-fsk` (Ook Fsk); fidelity `F1`; concern `CAT`.
...
- `docs/tasks/models/cmp-rf-communications-modem-transceiver-ook-fsk-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-modem-transceiver-ook-fsk` (Ook Fsk), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT`: variant `var-rf-communications-modem-transceiver-ook-fsk` (Ook Fsk), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-OOK-FSK-F1-CAT` exists and is limited to variant `var-rf-communications-modem-transceiver-ook-fsk` (Ook Fsk), `F1`, and `CAT`.
