# CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS - Document Bipolar junction transistor
...
Publish user and contributor documentation for **Bipolar junction transistor** without changing its model, symbol, package, or validation behavior.
...
- `CMP-SEMICONDUCTORS-BJT-SHARED-F0-SYM`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F0-MODEL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F0-VALIDATION`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F1-MODEL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F1-VALIDATION`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F2-MODEL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F2-VALIDATION`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F3-MODEL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F3-VALIDATION`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F4-MODEL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F4-VALIDATION`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F4-THERMAL`
- `CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE`
...
- Stable family: `fam-semiconductors-bjt` (Bipolar junction transistor); task scope: shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-semiconductors-bjt`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-semiconductors-bjt-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-semiconductors-bjt.md` for `fam-semiconductors-bjt`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS`: shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`, fidelity `F0`, concern `DOCS`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-BJT-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`, `F0`, and `DOCS`.
