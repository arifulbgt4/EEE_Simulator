# CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM - Create symbol and physical representation for Power rail
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Power rail**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-connectivity-power-rail` (Power rail); task scope: shared family scope across `var-connectivity-power-rail-parameterized-rail`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-connectivity-power-rail-shared-f0-sym.md`
...
- One original `sym-connectivity-power-rail` schematic definition with anchors for `1:NET` (power; electrical/schematic).
...
- Scope is limited to `CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM`: shared family scope across `var-connectivity-power-rail-parameterized-rail`, fidelity `F0`, concern `SYM`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-POWER-RAIL-SHARED-F0-SYM` exists and is limited to shared family scope across `var-connectivity-power-rail-parameterized-rail`, `F0`, and `SYM`.
