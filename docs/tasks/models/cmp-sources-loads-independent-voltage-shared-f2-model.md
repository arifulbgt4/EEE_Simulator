# CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL - Implement Independent voltage source F2 model
...
Implement one model tier, **F2**, for **Independent voltage source** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-sources-loads-independent-voltage` (Independent voltage source); task scope: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`; fidelity `F2`; concern `MODEL`.
...
- Exact F2 execution rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The branch constraint is v(P) - v(N) = V(t), with V(t) supplied by the selected DC/AC/transient profile.
...
- `docs/tasks/models/cmp-sources-loads-independent-voltage-shared-f2-model.md`
...
- One `ModelBinding` for `fam-sources-loads-independent-voltage` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL`: shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, fidelity `F2`, concern `MODEL`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-VOLTAGE-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-sources-loads-independent-voltage-dc`, `var-sources-loads-independent-voltage-ac-small-signal`, `var-sources-loads-independent-voltage-sine`, `var-sources-loads-independent-voltage-pulse`, `F2`, and `MODEL`.
