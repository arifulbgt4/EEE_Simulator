# CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-DOCS - Document Electromechanical body package
...
- `docs/tasks/models/cmp-package-electromechanical-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-ELECTROMECHANICAL-TEMPLATE-F0-DOCS-FAILURE`
