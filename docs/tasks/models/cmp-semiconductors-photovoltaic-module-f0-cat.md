...
- Aliases: Photovoltaic device, Photovoltaic, photovoltaic
...
- Explicit schematic-symbol, physical-appearance, and package references: pkg-axial-2, pkg-smd-diode, pkg-custom-parametric.
