# CMP-PACKAGE-SOT-223-TEMPLATE-F0-CAT - Specify SOT-223 family package template
...
- `docs/tasks/models/cmp-package-sot-223-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-SOT-223-TEMPLATE-F0-CAT-FAILURE`
