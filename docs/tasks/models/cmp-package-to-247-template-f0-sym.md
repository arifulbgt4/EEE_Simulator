# CMP-PACKAGE-TO-247-TEMPLATE-F0-SYM - Create TO-247 family physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-to-247` - TO-247 family |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-TO-247-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package registry entry `pkg-to-247` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-to-247-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-247-TEMPLATE-F0-SYM-FAILURE`
