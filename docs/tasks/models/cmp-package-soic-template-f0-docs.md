# CMP-PACKAGE-SOIC-TEMPLATE-F0-DOCS - Document Small-outline IC package
...
- `docs/tasks/models/cmp-package-soic-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SOIC-TEMPLATE-F0-DOCS-FAILURE`
