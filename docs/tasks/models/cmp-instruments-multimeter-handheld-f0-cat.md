# CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT - Specify Handheld catalog preset
...
| Variant | `var-instruments-multimeter-handheld` - Handheld |
| Fidelity | F0 |
| Concern | CAT |
| Release | R2 |
...
Create the complete, immutable catalog definition for **Handheld** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-instruments-multimeter` (Multimeter); task scope: variant `var-instruments-multimeter-handheld` (Handheld); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Multimeter family-specific implementation reference](../../catalog/families/fam-instruments-multimeter.md#family-specific-implementation-reference), registry row `fam-instruments-multimeter`, and variant `var-instruments-multimeter-handheld` (Handheld).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected V/I/R/continuity function computes the documented measurement with range, burden/input impedance, resolution, and overload behavior.
...
- `docs/tasks/models/cmp-instruments-multimeter-handheld-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-instruments-multimeter-handheld` (Handheld), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT`: variant `var-instruments-multimeter-handheld` (Handheld), fidelity `F0`, concern `CAT`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT-NOMINAL`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-MULTIMETER-HANDHELD-F0-CAT` exists and is limited to variant `var-instruments-multimeter-handheld` (Handheld), `F0`, and `CAT`.
