# CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-DOCS - Document Round through-hole LED package
...
- `docs/tasks/models/cmp-package-led-round-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-ROUND-TEMPLATE-F0-DOCS-FAILURE`
