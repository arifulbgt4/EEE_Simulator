# CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-CAT - Specify Rectangular through-hole LED package template
...
- Concern-specific golden references: GRC-050. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-led-rectangular-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-LED-RECTANGULAR-TEMPLATE-F0-CAT-FAILURE`
