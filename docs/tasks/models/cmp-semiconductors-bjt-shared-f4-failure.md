# CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE - Implement Bipolar junction transistor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Bipolar junction transistor**.
...
- Stable family: `fam-semiconductors-bjt` (Bipolar junction transistor); task scope: shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-semiconductors-bjt-shared-f4-failure.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE`: shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-BJT-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-semiconductors-bjt-npn`, `var-semiconductors-bjt-pnp`, `var-semiconductors-bjt-darlington-npn`, `var-semiconductors-bjt-darlington-pnp`, `F4`, and `FAILURE`.
