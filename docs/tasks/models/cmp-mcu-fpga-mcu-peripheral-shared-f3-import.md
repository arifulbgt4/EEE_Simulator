# CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT - Define import mapping for MCU peripheral
...
Implement and validate only the declared external-model mappings for **MCU peripheral**.
...
- Stable family: `fam-mcu-fpga-mcu-peripheral` (MCU peripheral); task scope: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-mcu-fpga-mcu-peripheral-shared-f3-import.md`
...
- Scope is limited to `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT`: shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, fidelity `F3`, concern `IMPORT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MCU-PERIPHERAL-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-mcu-fpga-mcu-peripheral-gpio`, `var-mcu-fpga-mcu-peripheral-timer`, `var-mcu-fpga-mcu-peripheral-pwm`, `var-mcu-fpga-mcu-peripheral-watchdog`, `var-mcu-fpga-mcu-peripheral-interrupt-controller`, `var-mcu-fpga-mcu-peripheral-dma`, `F3`, and `IMPORT`.
