# CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION - Validate Detailed EM and MEMS model F5
...
Produce independent validation evidence for **Detailed EM and MEMS model** at **F5** without modifying the model under test.
...
- Stable family: `fam-deferred-research-em-mems` (Detailed EM and MEMS model); task scope: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`; fidelity `F5`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-deferred-research-em-mems-shared-f5-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RSH-EM_MEMS-NOMINAL`, `GOLD-RSH-EM_MEMS-BOUNDARY`, `GOLD-RSH-EM_MEMS-FAILURE` at `F5`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION`: shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, fidelity `F5`, concern `VALIDATION`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-EM-MEMS-SHARED-F5-VALIDATION` exists and is limited to shared family scope across `var-deferred-research-em-mems-full-wave-em`, `var-deferred-research-em-mems-multiphysics-mems`, `F5`, and `VALIDATION`.
