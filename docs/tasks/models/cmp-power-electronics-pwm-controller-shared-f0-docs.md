# CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS - Document PWM controller
...
Publish user and contributor documentation for **PWM controller** without changing its model, symbol, package, or validation behavior.

## Exact prerequisites

- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-CONFIGURABLE-PWM-F0-CAT`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-SYM`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-MODEL`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-VALIDATION`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F1-MODEL`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F1-VALIDATION`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F2-MODEL`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F2-VALIDATION`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-MODEL`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F3-VALIDATION`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-MODEL`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-VALIDATION`
- `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F4-THERMAL`
...
- Stable family: `fam-power-electronics-pwm-controller` (PWM controller); task scope: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-power-electronics-pwm-controller`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-power-electronics-pwm-controller-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-power-electronics-pwm-controller.md` for `fam-power-electronics-pwm-controller`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS`: shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, fidelity `F0`, concern `DOCS`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-PWM-CONTROLLER-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-power-electronics-pwm-controller-configurable-pwm`, `F0`, and `DOCS`.
