# CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT - Define import mapping for Servo
...
Implement and validate only the declared external-model mappings for **Servo**.
...
- Stable family: `fam-actuators-hmi-servo` (Servo); task scope: shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-actuators-hmi-servo-shared-f3-import.md`
...
- Scope is limited to `CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT`: shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`, fidelity `F3`, concern `IMPORT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-SERVO-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-actuators-hmi-servo-positional`, `var-actuators-hmi-servo-continuous-rotation`, `F3`, and `IMPORT`.
