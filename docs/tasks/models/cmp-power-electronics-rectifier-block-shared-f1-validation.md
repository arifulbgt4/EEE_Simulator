# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION - Validate Rectifier block F1
...
Produce independent validation evidence for **Rectifier block** at **F1** without modifying the model under test.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F1`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F1 rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The block expands to the selected diode/controlled-switch topology and preserves its explicit branch equations, conduction order, and DC/ripple outputs.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-RECTIFIER_BLOCK-NOMINAL`, `GOLD-PWR-RECTIFIER_BLOCK-BOUNDARY`, `GOLD-PWR-RECTIFIER_BLOCK-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F1`, and `VALIDATION`.
