# CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM - Create symbol and physical representation for RF switch and amplifier
...
Create original, electrically unambiguous schematic and recognizable physical representations for **RF switch and amplifier**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-rf-communications-rf-switch-amplifier` (RF switch and amplifier); task scope: shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-rf-communications-rf-switch-amplifier-shared-f0-sym.md`
...
- One original `sym-rf-communications-rf-switch-amplifier` schematic definition with anchors for `IN:RF_IN` (passive; rf/electrical/communications), `OUT:RF_OUT` (passive; rf/electrical/communications), `GND:GROUND` (reference; rf/electrical/communications).
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM`: shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`, fidelity `F0`, concern `SYM`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-SWITCH-AMPLIFIER-SHARED-F0-SYM` exists and is limited to shared family scope across `var-rf-communications-rf-switch-amplifier-rf-switch`, `var-rf-communications-rf-switch-amplifier-lna`, `var-rf-communications-rf-switch-amplifier-power-amplifier`, `F0`, and `SYM`.
