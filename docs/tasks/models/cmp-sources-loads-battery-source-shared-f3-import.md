# CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT - Define import mapping for Battery source
...
Implement and validate only the declared external-model mappings for **Battery source**.
...
- Stable family: `fam-sources-loads-battery-source` (Battery source); task scope: shared family scope across `var-sources-loads-battery-source-battery-pack`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-sources-loads-battery-source-shared-f3-import.md`
...
- Scope is limited to `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT`: shared family scope across `var-sources-loads-battery-source-battery-pack`, fidelity `F3`, concern `IMPORT`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-BATTERY-SOURCE-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-sources-loads-battery-source-battery-pack`, `F3`, and `IMPORT`.
