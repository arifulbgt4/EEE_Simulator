# CMP-PACKAGE-BGA-TEMPLATE-F0-VALIDATION - Validate Ball grid array pin map and appearance
...
- `CMP-PACKAGE-BGA-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-bga-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-BGA-TEMPLATE-F0-VALIDATION-FAILURE`
