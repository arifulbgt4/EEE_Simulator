# CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-DOCS - Document SMD chip passive package
...
- `docs/tasks/models/cmp-package-smd-chip-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-CHIP-TEMPLATE-F0-DOCS-FAILURE`
