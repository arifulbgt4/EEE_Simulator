# CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM - Create symbol and physical representation for Generic semiconductor black box
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Generic semiconductor black box**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-semiconductors-semiconductor-generic` (Generic semiconductor black box); task scope: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-semiconductors-semiconductor-generic-shared-f0-sym.md`
...
- One original `sym-semiconductors-semiconductor-generic` schematic definition with anchors for `1:P` (passive; electrical/optical/thermal), `2:N` (passive; electrical/optical/thermal).
...
- Scope is limited to `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM`: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, fidelity `F0`, concern `SYM`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F0-SYM` exists and is limited to shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, `F0`, and `SYM`.
