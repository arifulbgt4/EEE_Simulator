# CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL - Implement Impedance and RF instrument F1 model
...
Implement one model tier, **F1**, for **Impedance and RF instrument** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-instruments-impedance-rf-instrument` (Impedance and RF instrument); task scope: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: The selected LCR/spectrum/network measurement computes impedance, spectrum, or S-parameters over the declared stimulus, port, window, and calibration contract.
...
- `docs/tasks/models/cmp-instruments-impedance-rf-instrument-shared-f1-model.md`
...
- One `ModelBinding` for `fam-instruments-impedance-rf-instrument` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL`: shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, fidelity `F1`, concern `MODEL`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-IMPEDANCE-RF-INSTRUMENT-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-instruments-impedance-rf-instrument-lcr-meter`, `var-instruments-impedance-rf-instrument-spectrum-analyzer`, `var-instruments-impedance-rf-instrument-network-analyzer`, `F1`, and `MODEL`.
