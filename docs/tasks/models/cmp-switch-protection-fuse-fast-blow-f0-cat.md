# CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT - Specify Fast Blow catalog preset
...
| Variant | `var-switch-protection-fuse-fast-blow` - Fast Blow |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Fast Blow** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-switch-protection-fuse` (Fuse and resettable protector); task scope: variant `var-switch-protection-fuse-fast-blow` (Fast Blow); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Fuse and resettable protector family-specific implementation reference](../../catalog/families/fam-switch-protection-fuse.md#family-specific-implementation-reference), registry row `fam-switch-protection-fuse`, and variant `var-switch-protection-fuse-fast-blow` (Fast Blow).
...
- `docs/tasks/models/cmp-switch-protection-fuse-fast-blow-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-fuse-fast-blow` (Fast Blow), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT`: variant `var-switch-protection-fuse-fast-blow` (Fast Blow), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-FUSE-FAST-BLOW-F0-CAT` exists and is limited to variant `var-switch-protection-fuse-fast-blow` (Fast Blow), `F0`, and `CAT`.
