# CMP-PACKAGE-D2PAK-TEMPLATE-F0-DOCS - Document D2PAK or TO-263 package
...
- `docs/tasks/models/cmp-package-d2pak-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-DOCS-FAILURE`
