# CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL - Implement Transmission line F1 model
...
Implement one model tier, **F1**, for **Transmission line** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-passives-transmission-line` (Transmission line); task scope: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`; fidelity `F1`; concern `MODEL`.
...
- Exact F1 execution rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Voltage/current propagation follows the declared characteristic impedance and delay or RLGC telegrapher model; terminations and reference direction are explicit.
...
- `docs/tasks/models/cmp-passives-transmission-line-shared-f1-model.md`
...
- One `ModelBinding` for `fam-passives-transmission-line` at `F1` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL`: shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, fidelity `F1`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL-NOMINAL`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL-BOUNDARY`
- `TEST-CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-TRANSMISSION-LINE-SHARED-F1-MODEL` exists and is limited to shared family scope across `var-passives-transmission-line-lossless`, `var-passives-transmission-line-lossy`, `var-passives-transmission-line-time-delay`, `F1`, and `MODEL`.
