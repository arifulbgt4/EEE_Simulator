# CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT - Specify Cmos catalog preset
...
| Variant | `var-switch-protection-transmission-gate-cmos` - Cmos |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
- Stable family: `fam-switch-protection-transmission-gate` (Transmission gate); task scope: variant `var-switch-protection-transmission-gate-cmos` (Cmos); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Transmission gate family-specific implementation reference](../../catalog/families/fam-switch-protection-transmission-gate.md#family-specific-implementation-reference), registry row `fam-switch-protection-transmission-gate`, and variant `var-switch-protection-transmission-gate-cmos` (Cmos).
...
- `docs/tasks/models/cmp-switch-protection-transmission-gate-cmos-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-transmission-gate-cmos` (Cmos), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT`: variant `var-switch-protection-transmission-gate-cmos` (Cmos), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-TRANSMISSION-GATE-CMOS-F0-CAT` exists and is limited to variant `var-switch-protection-transmission-gate-cmos` (Cmos), `F0`, and `CAT`.
