# CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL - Implement Force and pressure sensor F4 model
...
Implement one model tier, **F4**, for **Force and pressure sensor** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-sensors-environment-force-pressure-sensor` (Force and pressure sensor); task scope: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`; fidelity `F4`; concern `MODEL`.
...
- `docs/tasks/models/cmp-sensors-environment-force-pressure-sensor-shared-f4-model.md`
...
- One `ModelBinding` for `fam-sensors-environment-force-pressure-sensor` at `F4` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL`: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, fidelity `F4`, concern `MODEL`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-MODEL` exists and is limited to shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, `F4`, and `MODEL`.
