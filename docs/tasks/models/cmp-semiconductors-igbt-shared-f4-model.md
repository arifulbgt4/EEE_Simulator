# CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL - Implement Insulated-gate bipolar transistor F4 model
...
Implement one model tier, **F4**, for **Insulated-gate bipolar transistor** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-semiconductors-igbt` (Insulated-gate bipolar transistor); task scope: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`; fidelity `F4`; concern `MODEL`.
...
- `docs/tasks/models/cmp-semiconductors-igbt-shared-f4-model.md`
...
- One `ModelBinding` for `fam-semiconductors-igbt` at `F4` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL`: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, fidelity `F4`, concern `MODEL`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-MODEL` exists and is limited to shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, `F4`, and `MODEL`.
