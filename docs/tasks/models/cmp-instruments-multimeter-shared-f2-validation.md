# CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION - Validate Multimeter F2
...
Produce independent validation evidence for **Multimeter** at **F2** without modifying the model under test.
...
- Stable family: `fam-instruments-multimeter` (Multimeter); task scope: shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`; fidelity `F2`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-instruments-multimeter-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-INS-MULTIMETER-NOMINAL`, `GOLD-INS-MULTIMETER-BOUNDARY`, `GOLD-INS-MULTIMETER-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION`: shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-007, REQ-021, REQ-022, REQ-023, REQ-034, REQ-037.
...
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-INSTRUMENTS-MULTIMETER-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-instruments-multimeter-handheld`, `var-instruments-multimeter-bench`, `var-instruments-multimeter-clamp`, `F2`, and `VALIDATION`.
