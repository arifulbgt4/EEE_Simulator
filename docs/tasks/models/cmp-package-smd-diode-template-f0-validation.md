# CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-VALIDATION - Validate SMD diode pin map and appearance
...
- `CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-smd-diode-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-SMD-DIODE-TEMPLATE-F0-VALIDATION-FAILURE`
