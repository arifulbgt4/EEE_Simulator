# CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL - Implement Terminal, net tie, jumper, and domain adapter F0 model
...
Implement one model tier, **F0**, for **Terminal, net tie, jumper, and domain adapter** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-connectivity-terminal-bridge` (Terminal, net tie, jumper, and domain adapter); task scope: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`; fidelity `F0`; concern `MODEL`.
...
- Exact F0 execution rule: Connectivity-only: validate declared pins, domains, width/direction, hierarchy, and package mapping; do not claim numerical behavior. Family baseline: Terminal, net-tie, jumper, and domain-adapter variants use an explicit connection matrix; only matrix entries declared closed may share current or potential.
...
- `docs/tasks/models/cmp-connectivity-terminal-bridge-shared-f0-model.md`
...
- One `ModelBinding` for `fam-connectivity-terminal-bridge` at `F0` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL`: shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, fidelity `F0`, concern `MODEL`, and requirements REQ-004, REQ-005, REQ-008, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL-NOMINAL`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL-BOUNDARY`
- `TEST-CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTIVITY-TERMINAL-BRIDGE-SHARED-F0-MODEL` exists and is limited to shared family scope across `var-connectivity-terminal-bridge-terminal`, `var-connectivity-terminal-bridge-net-tie`, `var-connectivity-terminal-bridge-jumper`, `var-connectivity-terminal-bridge-domain-adapter`, `F0`, and `MODEL`.
