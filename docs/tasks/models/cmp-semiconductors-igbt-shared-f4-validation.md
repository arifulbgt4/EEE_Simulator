# CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION - Validate Insulated-gate bipolar transistor F4
...
Produce independent validation evidence for **Insulated-gate bipolar transistor** at **F4** without modifying the model under test.
...
- Stable family: `fam-semiconductors-igbt` (Insulated-gate bipolar transistor); task scope: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`; fidelity `F4`; concern `VALIDATION`.
...
- `docs/tasks/models/cmp-semiconductors-igbt-shared-f4-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEM-IGBT-NOMINAL`, `GOLD-SEM-IGBT-BOUNDARY`, `GOLD-SEM-IGBT-FAILURE` at `F4`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION`: shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, fidelity `F4`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-IGBT-SHARED-F4-VALIDATION` exists and is limited to shared family scope across `var-semiconductors-igbt-n-channel`, `var-semiconductors-igbt-p-channel`, `F4`, and `VALIDATION`.
