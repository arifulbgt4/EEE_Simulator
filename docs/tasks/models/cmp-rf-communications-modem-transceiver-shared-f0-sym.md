...
- Stable family: `fam-rf-communications-modem-transceiver` (Modem and transceiver); task scope: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-rf-communications-modem-transceiver-shared-f0-sym.md`
...
- One original `sym-rf-communications-modem-transceiver` schematic definition with anchors for `IN:RF_IN` (passive; rf/electrical/communications), `OUT:RF_OUT` (passive; rf/electrical/communications), `GND:GROUND` (reference; rf/electrical/communications).
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F0-SYM`: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, fidelity `F0`, concern `SYM`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F0-SYM` exists and is limited to shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, `F0`, and `SYM`.
