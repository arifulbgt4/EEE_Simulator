# CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-VALIDATION - Validate Custom parametric package pin map and appearance
...
- `CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-custom-parametric-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-VALIDATION-FAILURE`
