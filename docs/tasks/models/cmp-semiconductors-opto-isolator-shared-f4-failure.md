# CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE - Implement Optically isolated semiconductor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Optically isolated semiconductor**.
...
- Stable family: `fam-semiconductors-opto-isolator` (Optically isolated semiconductor); task scope: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-semiconductors-opto-isolator-shared-f4-failure.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE`: shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-OPTO-ISOLATOR-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-semiconductors-opto-isolator-phototransistor-output`, `var-semiconductors-opto-isolator-triac-output`, `F4`, and `FAILURE`.
