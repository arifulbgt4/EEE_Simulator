# CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT - Specify Shielded Multicore catalog preset
...
| Variant | `var-connectors-cables-cable-shielded-multicore` - Shielded Multicore |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Shielded Multicore** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-connectors-cables-cable` (Cable); task scope: variant `var-connectors-cables-cable-shielded-multicore` (Shielded Multicore); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Cable family-specific implementation reference](../../catalog/families/fam-connectors-cables-cable.md#family-specific-implementation-reference), registry row `fam-connectors-cables-cable`, and variant `var-connectors-cables-cable-shielded-multicore` (Shielded Multicore).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: Each conductor pair/shield follows the declared connectivity and lumped or distributed RLGC/coupling model with length and termination parameters.
...
- `docs/tasks/models/cmp-connectors-cables-cable-shielded-multicore-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-connectors-cables-cable-shielded-multicore` (Shielded Multicore), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT`: variant `var-connectors-cables-cable-shielded-multicore` (Shielded Multicore), fidelity `F0`, concern `CAT`, and requirements REQ-005, REQ-014, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT-NOMINAL`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT-BOUNDARY`
- `TEST-CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-CONNECTORS-CABLES-CABLE-SHIELDED-MULTICORE-F0-CAT` exists and is limited to variant `var-connectors-cables-cable-shielded-multicore` (Shielded Multicore), `F0`, and `CAT`.
