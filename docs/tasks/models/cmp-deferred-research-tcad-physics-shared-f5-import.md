...
- Stable family: `fam-deferred-research-tcad-physics` (TCAD physical device model); task scope: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`; fidelity `F5`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-deferred-research-tcad-physics-shared-f5-import.md`
...
- Scope is limited to `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-IMPORT`: shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, fidelity `F5`, concern `IMPORT`, and requirements REQ-001, REQ-002, REQ-022, REQ-023, REQ-028, REQ-034, REQ-037, REQ-038.
...
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-IMPORT-NOMINAL`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-IMPORT-BOUNDARY`
- `TEST-CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DEFERRED-RESEARCH-TCAD-PHYSICS-SHARED-F5-IMPORT` exists and is limited to shared family scope across `var-deferred-research-tcad-physics-semiconductor-device`, `var-deferred-research-tcad-physics-photonic-device`, `F5`, and `IMPORT`.
