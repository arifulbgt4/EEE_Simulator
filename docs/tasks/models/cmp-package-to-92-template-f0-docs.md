# CMP-PACKAGE-TO-92-TEMPLATE-F0-DOCS - Document TO-92 family package
...
- `docs/tasks/models/cmp-package-to-92-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-92-TEMPLATE-F0-DOCS-FAILURE`
