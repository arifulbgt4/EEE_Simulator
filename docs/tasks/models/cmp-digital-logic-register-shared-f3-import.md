# CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT - Define import mapping for Register
...
Implement and validate only the declared external-model mappings for **Register**.
...
- Stable family: `fam-digital-logic-register` (Register); task scope: shared family scope across `var-digital-logic-register-shift`, `var-digital-logic-register-parallel`, `var-digital-logic-register-serial-converter`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-digital-logic-register-shared-f3-import.md`
...
- Scope is limited to `CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT`: shared family scope across `var-digital-logic-register-shift`, `var-digital-logic-register-parallel`, `var-digital-logic-register-serial-converter`, fidelity `F3`, concern `IMPORT`, and requirements REQ-018, REQ-021, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-DIGITAL-LOGIC-REGISTER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-digital-logic-register-shift`, `var-digital-logic-register-parallel`, `var-digital-logic-register-serial-converter`, `F3`, and `IMPORT`.
