# CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F3-IMPORT - Define import mapping for Charger and battery management
...
Implement and validate only the declared external-model mappings for **Charger and battery management**.
...
- Stable family: `fam-power-electronics-charger-bms` (Charger and battery management); task scope: shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-power-electronics-charger-bms-shared-f3-import.md`
...
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-CHARGER-BMS-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-power-electronics-charger-bms-battery-charger`, `var-power-electronics-charger-bms-bms`, `F3`, and `IMPORT`.
