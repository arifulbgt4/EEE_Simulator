# CMP-PACKAGE-SSOP-TEMPLATE-F0-DOCS - Document Shrink small-outline package package
...
- `docs/tasks/models/cmp-package-ssop-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-SSOP-TEMPLATE-F0-DOCS-FAILURE`
