# CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT - Specify Hdl Wrapper catalog preset
...
| Variant | `var-mcu-fpga-fpga-hdl-hdl-wrapper` - Hdl Wrapper |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Hdl Wrapper** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-mcu-fpga-fpga-hdl` (FPGA and HDL block); task scope: variant `var-mcu-fpga-fpga-hdl-hdl-wrapper` (Hdl Wrapper); fidelity `F0`; concern `CAT`.
...
- Canonical source: [FPGA and HDL block family-specific implementation reference](../../catalog/families/fam-mcu-fpga-fpga-hdl.md#family-specific-implementation-reference), registry row `fam-mcu-fpga-fpga-hdl`, and variant `var-mcu-fpga-fpga-hdl-hdl-wrapper` (Hdl Wrapper).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The selected LUT/BRAM/DSP/PLL/HDL block executes its declared RTL/event relation under a pinned HDL toolchain and explicit clock/reset/pin mapping.
...
- `docs/tasks/models/cmp-mcu-fpga-fpga-hdl-hdl-wrapper-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-mcu-fpga-fpga-hdl-hdl-wrapper` (Hdl Wrapper), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT`: variant `var-mcu-fpga-fpga-hdl-hdl-wrapper` (Hdl Wrapper), fidelity `F0`, concern `CAT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT-NOMINAL`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-FPGA-HDL-HDL-WRAPPER-F0-CAT` exists and is limited to variant `var-mcu-fpga-fpga-hdl-hdl-wrapper` (Hdl Wrapper), `F0`, and `CAT`.
