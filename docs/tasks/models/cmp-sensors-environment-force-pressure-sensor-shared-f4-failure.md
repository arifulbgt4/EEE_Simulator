# CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE - Implement Force and pressure sensor failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Force and pressure sensor**.
...
- Stable family: `fam-sensors-environment-force-pressure-sensor` (Force and pressure sensor); task scope: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-sensors-environment-force-pressure-sensor-shared-f4-failure.md`
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE`: shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, fidelity `F4`, concern `FAILURE`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-FORCE-PRESSURE-SENSOR-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-sensors-environment-force-pressure-sensor-strain-gauge`, `var-sensors-environment-force-pressure-sensor-load-cell`, `var-sensors-environment-force-pressure-sensor-absolute-pressure`, `var-sensors-environment-force-pressure-sensor-differential-pressure`, `F4`, and `FAILURE`.
