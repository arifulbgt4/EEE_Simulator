# CMP-PACKAGE-TO-220-TEMPLATE-F0-VALIDATION - Validate TO-220 family pin map and appearance
...
- `CMP-PACKAGE-TO-220-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-to-220-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-220-TEMPLATE-F0-VALIDATION-FAILURE`
