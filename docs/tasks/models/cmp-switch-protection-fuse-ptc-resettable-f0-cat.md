# CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT - Specify Ptc Resettable catalog preset
...
| Variant | `var-switch-protection-fuse-ptc-resettable` - Ptc Resettable |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Ptc Resettable** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-switch-protection-fuse` (Fuse and resettable protector); task scope: variant `var-switch-protection-fuse-ptc-resettable` (Ptc Resettable); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Fuse and resettable protector family-specific implementation reference](../../catalog/families/fam-switch-protection-fuse.md#family-specific-implementation-reference), registry row `fam-switch-protection-fuse`, and variant `var-switch-protection-fuse-ptc-resettable` (Ptc Resettable).
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: The element integrates the declared I^2*t or thermal damage measure and transitions irreversibly or resetably to its open/high-resistance state at threshold.
...
- `docs/tasks/models/cmp-switch-protection-fuse-ptc-resettable-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-switch-protection-fuse-ptc-resettable` (Ptc Resettable), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT`: variant `var-switch-protection-fuse-ptc-resettable` (Ptc Resettable), fidelity `F0`, concern `CAT`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-FUSE-PTC-RESETTABLE-F0-CAT` exists and is limited to variant `var-switch-protection-fuse-ptc-resettable` (Ptc Resettable), `F0`, and `CAT`.
