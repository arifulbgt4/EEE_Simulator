# CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-SYM - Create RF module physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-rf-module` - RF module |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Package mappings: pkg-rf-module
...
- Package registry entry `pkg-rf-module` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-rf-module-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-RF-MODULE-TEMPLATE-F0-SYM-FAILURE`
