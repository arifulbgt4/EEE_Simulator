# CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL - Implement Optical sensor F4 model
...
Implement one model tier, **F4**, for **Optical sensor** using the family equations/behavior and no higher-fidelity claims.
...
- `docs/tasks/models/cmp-sensors-environment-optical-sensor-shared-f4-model.md`
...
- One `ModelBinding` for `fam-sensors-environment-optical-sensor` at `F4` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL`: shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, fidelity `F4`, concern `MODEL`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-OPTICAL-SENSOR-SHARED-F4-MODEL` exists and is limited to shared family scope across `var-sensors-environment-optical-sensor-photodiode-module`, `var-sensors-environment-optical-sensor-ambient-light`, `var-sensors-environment-optical-sensor-color`, `var-sensors-environment-optical-sensor-infrared`, `F4`, and `MODEL`.
