# CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-CAT - Specify Virtual or schematic-only package template
...
- `docs/tasks/models/cmp-package-virtual-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-CAT-FAILURE`
