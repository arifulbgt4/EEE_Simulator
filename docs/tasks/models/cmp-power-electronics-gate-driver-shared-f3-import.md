# CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-IMPORT - Define import mapping for Gate driver
...
Implement and validate only the declared external-model mappings for **Gate driver**.
...
- Stable family: `fam-power-electronics-gate-driver` (Gate driver); task scope: shared family scope across `var-power-electronics-gate-driver-low-side`, `var-power-electronics-gate-driver-high-side`, `var-power-electronics-gate-driver-isolated`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-power-electronics-gate-driver-shared-f3-import.md`
...
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-GATE-DRIVER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-power-electronics-gate-driver-low-side`, `var-power-electronics-gate-driver-high-side`, `var-power-electronics-gate-driver-isolated`, `F3`, and `IMPORT`.
