# CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT - Specify Risc V Profile catalog preset
...
| Variant | `var-mcu-fpga-microcontroller-risc-v-profile` - Risc V Profile |
| Fidelity | F0 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Risc V Profile** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-mcu-fpga-microcontroller` (Microcontroller); task scope: variant `var-mcu-fpga-microcontroller-risc-v-profile` (Risc V Profile); fidelity `F0`; concern `CAT`.
...
- Canonical source: [Microcontroller family-specific implementation reference](../../catalog/families/fam-mcu-fpga-microcontroller.md#family-specific-implementation-reference), registry row `fam-mcu-fpga-microcontroller`, and variant `var-mcu-fpga-microcontroller-risc-v-profile` (Risc V Profile).
...
- `docs/tasks/models/cmp-mcu-fpga-microcontroller-risc-v-profile-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-mcu-fpga-microcontroller-risc-v-profile` (Risc V Profile), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT`: variant `var-mcu-fpga-microcontroller-risc-v-profile` (Risc V Profile), fidelity `F0`, concern `CAT`, and requirements REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT-NOMINAL`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT-BOUNDARY`
- `TEST-CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-MCU-FPGA-MICROCONTROLLER-RISC-V-PROFILE-F0-CAT` exists and is limited to variant `var-mcu-fpga-microcontroller-risc-v-profile` (Risc V Profile), `F0`, and `CAT`.
