# CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT - Define import mapping for DC converter
...
Implement and validate only the declared external-model mappings for **DC converter**.
...
- Stable family: `fam-power-electronics-dc-converter` (DC converter); task scope: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-power-electronics-dc-converter-shared-f3-import.md`
...
- Scope is limited to `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT`: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, `F3`, and `IMPORT`.
