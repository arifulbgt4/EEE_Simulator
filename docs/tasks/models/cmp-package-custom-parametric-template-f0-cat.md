# CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-CAT - Specify Custom parametric package package template
...
- Concern-specific golden references: GRC-053. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-custom-parametric-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-CUSTOM-PARAMETRIC-TEMPLATE-F0-CAT-FAILURE`
