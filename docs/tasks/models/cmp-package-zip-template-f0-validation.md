# CMP-PACKAGE-ZIP-TEMPLATE-F0-VALIDATION - Validate Zig-zag in-line package pin map and appearance
...
- `CMP-PACKAGE-ZIP-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-zip-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-ZIP-TEMPLATE-F0-VALIDATION-FAILURE`
