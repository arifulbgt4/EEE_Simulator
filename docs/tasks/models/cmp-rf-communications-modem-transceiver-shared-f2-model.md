# CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL - Implement Modem and transceiver F2 model
...
Implement one model tier, **F2**, for **Modem and transceiver** using the family equations/behavior and no higher-fidelity claims.
...
- Stable family: `fam-rf-communications-modem-transceiver` (Modem and transceiver); task scope: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`; fidelity `F2`; concern `MODEL`.
...
- Exact F2 execution rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: Bits/symbols map through the selected modulation, coding, framing, timing, RF/baseband, synchronization, and error state machine.
...
- `docs/tasks/models/cmp-rf-communications-modem-transceiver-shared-f2-model.md`
...
- One `ModelBinding` for `fam-rf-communications-modem-transceiver` at `F2` implementing the exact tier rule above, its initialization/state/stamp/event behavior, power reporting, and structured diagnostics.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL`: shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, fidelity `F2`, concern `MODEL`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-MODEM-TRANSCEIVER-SHARED-F2-MODEL` exists and is limited to shared family scope across `var-rf-communications-modem-transceiver-analog-modem`, `var-rf-communications-modem-transceiver-ook-fsk`, `var-rf-communications-modem-transceiver-qam-ofdm`, `F2`, and `MODEL`.
