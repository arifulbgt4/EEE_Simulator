# CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM - Create symbol and physical representation for Stepper motor
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Stepper motor**, including accessible orientation/polarity cues and reusable package mapping.
...
- Stable family: `fam-actuators-hmi-stepper-motor` (Stepper motor); task scope: shared family scope across `var-actuators-hmi-stepper-motor-unipolar`, `var-actuators-hmi-stepper-motor-bipolar`, `var-actuators-hmi-stepper-motor-hybrid`; fidelity `F0`; concern `SYM`.
...
- `docs/tasks/models/cmp-actuators-hmi-stepper-motor-shared-f0-sym.md`
...
- One original `sym-actuators-hmi-stepper-motor` schematic definition with anchors for `1:DRIVE+` (input; electrical/mechanical/optical/acoustic), `2:DRIVE-` (input; electrical/mechanical/optical/acoustic), `M:MECHANICAL_OR_DISPLAY` (physical; electrical/mechanical/optical/acoustic).
...
- Scope is limited to `CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM`: shared family scope across `var-actuators-hmi-stepper-motor-unipolar`, `var-actuators-hmi-stepper-motor-bipolar`, `var-actuators-hmi-stepper-motor-hybrid`, fidelity `F0`, concern `SYM`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-ACTUATORS-HMI-STEPPER-MOTOR-SHARED-F0-SYM` exists and is limited to shared family scope across `var-actuators-hmi-stepper-motor-unipolar`, `var-actuators-hmi-stepper-motor-bipolar`, `var-actuators-hmi-stepper-motor-hybrid`, `F0`, and `SYM`.
