# CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT - Define import mapping for Sample and hold
...
Implement and validate only the declared external-model mappings for **Sample and hold**.
...
- Stable family: `fam-analog-mixed-signal-sample-hold` (Sample and hold); task scope: shared family scope across `var-analog-mixed-signal-sample-hold-track-and-hold`, `var-analog-mixed-signal-sample-hold-sample-and-hold`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-analog-mixed-signal-sample-hold-shared-f3-import.md`
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT`: shared family scope across `var-analog-mixed-signal-sample-hold-track-and-hold`, `var-analog-mixed-signal-sample-hold-sample-and-hold`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-SAMPLE-HOLD-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-analog-mixed-signal-sample-hold-track-and-hold`, `var-analog-mixed-signal-sample-hold-sample-and-hold`, `F3`, and `IMPORT`.
