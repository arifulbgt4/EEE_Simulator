# CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION - Validate Rectifier block F3
...
Produce independent validation evidence for **Rectifier block** at **F3** without modifying the model under test.
...
- Stable family: `fam-power-electronics-rectifier-block` (Rectifier block); task scope: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`; fidelity `F3`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F3 rule: Compact/macro/external tier: bind a pinned model or executable relation that preserves ordered pins and the validated envelope; the governing family relation is: The block expands to the selected diode/controlled-switch topology and preserves its explicit branch equations, conduction order, and DC/ripple outputs.
...
- `docs/tasks/models/cmp-power-electronics-rectifier-block-shared-f3-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-PWR-RECTIFIER_BLOCK-NOMINAL`, `GOLD-PWR-RECTIFIER_BLOCK-BOUNDARY`, `GOLD-PWR-RECTIFIER_BLOCK-FAILURE` at `F3`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION`: shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, fidelity `F3`, concern `VALIDATION`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-RECTIFIER-BLOCK-SHARED-F3-VALIDATION` exists and is limited to shared family scope across `var-power-electronics-rectifier-block-half-wave`, `var-power-electronics-rectifier-block-full-wave`, `var-power-electronics-rectifier-block-three-phase`, `F3`, and `VALIDATION`.
