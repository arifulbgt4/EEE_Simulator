# CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION - Validate Magnetic and motion sensor F1
...
Produce independent validation evidence for **Magnetic and motion sensor** at **F1** without modifying the model under test.
...
- Stable family: `fam-sensors-environment-magnetic-motion-sensor` (Magnetic and motion sensor); task scope: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`; fidelity `F1`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F1 rule: Ideal/equation tier: implement exactly this family baseline and its declared parameter limits: Output follows the selected magnetic/acceleration/angular-rate/position transfer and axis transform with bandwidth, bias, range, and noise.
...
- `docs/tasks/models/cmp-sensors-environment-magnetic-motion-sensor-shared-f1-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SEN-MAGNETIC_MOTION_SENSOR-NOMINAL`, `GOLD-SEN-MAGNETIC_MOTION_SENSOR-BOUNDARY`, `GOLD-SEN-MAGNETIC_MOTION_SENSOR-FAILURE` at `F1`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION`: shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, fidelity `F1`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION-NOMINAL`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION-BOUNDARY`
- `TEST-CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SENSORS-ENVIRONMENT-MAGNETIC-MOTION-SENSOR-SHARED-F1-VALIDATION` exists and is limited to shared family scope across `var-sensors-environment-magnetic-motion-sensor-hall`, `var-sensors-environment-magnetic-motion-sensor-reed`, `var-sensors-environment-magnetic-motion-sensor-accelerometer`, `var-sensors-environment-magnetic-motion-sensor-gyroscope`, `var-sensors-environment-magnetic-motion-sensor-magnetometer`, `F1`, and `VALIDATION`.
