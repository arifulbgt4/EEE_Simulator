# CMP-PACKAGE-QFN-TEMPLATE-F0-CAT - Specify Quad flat no-lead package template
...
- `docs/tasks/models/cmp-package-qfn-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-QFN-TEMPLATE-F0-CAT-FAILURE`
