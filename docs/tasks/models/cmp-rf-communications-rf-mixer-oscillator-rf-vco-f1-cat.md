# CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT - Specify Rf Vco catalog preset
...
| Variant | `var-rf-communications-rf-mixer-oscillator-rf-vco` - Rf Vco |
| Fidelity | F1 |
| Concern | CAT |
| Release | R7 |
...
Create the complete, immutable catalog definition for **Rf Vco** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-rf-communications-rf-mixer-oscillator` (RF mixer and oscillator); task scope: variant `var-rf-communications-rf-mixer-oscillator-rf-vco` (Rf Vco); fidelity `F1`; concern `CAT`.
...
- `docs/tasks/models/cmp-rf-communications-rf-mixer-oscillator-rf-vco-f1-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-rf-communications-rf-mixer-oscillator-rf-vco` (Rf Vco), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT`: variant `var-rf-communications-rf-mixer-oscillator-rf-vco` (Rf Vco), fidelity `F1`, concern `CAT`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-RF-MIXER-OSCILLATOR-RF-VCO-F1-CAT` exists and is limited to variant `var-rf-communications-rf-mixer-oscillator-rf-vco` (Rf Vco), `F1`, and `CAT`.
