# CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE - Implement Generic semiconductor black box failure behavior
...
Implement only the declared F4 failure states and controlled failure injection for **Generic semiconductor black box**.
...
- Stable family: `fam-semiconductors-semiconductor-generic` (Generic semiconductor black box); task scope: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`; fidelity `F4`; concern `FAILURE`.
...
- `docs/tasks/models/cmp-semiconductors-semiconductor-generic-shared-f4-failure.md`
...
- Scope is limited to `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE`: shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, fidelity `F4`, concern `FAILURE`, and requirements REQ-009, REQ-010, REQ-011, REQ-012, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE-NOMINAL`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE-BOUNDARY`
- `TEST-CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE-FAILURE`

## Acceptance

1. The exact output for `CMP-SEMICONDUCTORS-SEMICONDUCTOR-GENERIC-SHARED-F4-FAILURE` exists and is limited to shared family scope across `var-semiconductors-semiconductor-generic-equation-model`, `F4`, and `FAILURE`.
