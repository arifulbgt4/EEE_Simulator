# CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-SYM - Create Virtual or schematic-only physical renderer
...
|---|---|
| Status | Planned |
| Family | `pkg-virtual` - Virtual or schematic-only |
| Variant | `template` |
| Fidelity | F0 |
| Concern | SYM |
| Release | R1 |
...
- `CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-CAT`
- `PLAT-SYM-007`
...
- Aliases: Virtual or schematic-only
...
- Package registry entry `pkg-virtual` revision `1.0.0` is the only geometry/default source for this task.
...
- `docs/tasks/models/cmp-package-virtual-template-f0-sym.md`
...
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-SYM-NOMINAL`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-SYM-BOUNDARY`
- `TEST-CMP-PACKAGE-VIRTUAL-TEMPLATE-F0-SYM-FAILURE`
