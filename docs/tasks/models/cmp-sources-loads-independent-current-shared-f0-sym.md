# CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM - Create symbol and physical representation for Independent current source
...
Create original, electrically unambiguous schematic and recognizable physical representations for **Independent current source**, including accessible orientation/polarity cues and reusable package mapping.
...
- `docs/tasks/models/cmp-sources-loads-independent-current-shared-f0-sym.md`
...
- One original `sym-sources-loads-independent-current` schematic definition with anchors for `1:P` (passive; electrical/stimulus), `2:N` (passive; electrical/stimulus).
...
- Scope is limited to `CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM`: shared family scope across `var-sources-loads-independent-current-dc`, `var-sources-loads-independent-current-ac-small-signal`, `var-sources-loads-independent-current-sine`, `var-sources-loads-independent-current-pulse`, fidelity `F0`, concern `SYM`, and requirements REQ-008, REQ-009, REQ-010, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM-NOMINAL`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM-BOUNDARY`
- `TEST-CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM-FAILURE`

## Acceptance

1. The exact output for `CMP-SOURCES-LOADS-INDEPENDENT-CURRENT-SHARED-F0-SYM` exists and is limited to shared family scope across `var-sources-loads-independent-current-dc`, `var-sources-loads-independent-current-ac-small-signal`, `var-sources-loads-independent-current-sine`, `var-sources-loads-independent-current-pulse`, `F0`, and `SYM`.
