# CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT - Specify Rail To Rail catalog preset
...
|---|---|
| Status | Planned |
| Family | `fam-analog-mixed-signal-operational-amplifier` - Operational amplifier |
| Variant | `var-analog-mixed-signal-operational-amplifier-rail-to-rail` - Rail To Rail |
| Fidelity | F0 |
| Concern | CAT |
| Release | R3 |
...
Create the complete, immutable catalog definition for **Rail To Rail** without implementing a different fidelity or sibling preset.
...
- Stable family: `fam-analog-mixed-signal-operational-amplifier` (Operational amplifier); task scope: variant `var-analog-mixed-signal-operational-amplifier-rail-to-rail` (Rail To Rail); fidelity `F0`; concern `CAT`.
...
- This catalog concern has no numerical equation. It freezes the selected variant's inherited/overridden fields against the governing family rule: F1 computes Vout = clamp(Aol*(Vplus-Vminus), supply/output limits); higher tiers add poles, slew, bias, noise, common-mode, and output-drive limits.
...
- `docs/tasks/models/cmp-analog-mixed-signal-operational-amplifier-rail-to-rail-f0-cat.md`
...
- One normalized `ComponentVariant` record for variant `var-analog-mixed-signal-operational-amplifier-rail-to-rail` (Rail To Rail), retaining stable ID, aliases, inherited pins/parameters, declared tier list, package candidates, release target, provenance, and limitations.
...
- Scope is limited to `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT`: variant `var-analog-mixed-signal-operational-amplifier-rail-to-rail` (Rail To Rail), fidelity `F0`, concern `CAT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-018, REQ-020, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT-NOMINAL`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT-BOUNDARY`
- `TEST-CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT-FAILURE`

## Acceptance

1. The exact output for `CMP-ANALOG-MIXED-SIGNAL-OPERATIONAL-AMPLIFIER-RAIL-TO-RAIL-F0-CAT` exists and is limited to variant `var-analog-mixed-signal-operational-amplifier-rail-to-rail` (Rail To Rail), `F0`, and `CAT`.
