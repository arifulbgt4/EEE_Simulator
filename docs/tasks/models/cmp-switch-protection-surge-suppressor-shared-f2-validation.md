# CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION - Validate Surge and ESD suppressor F2
...
Produce independent validation evidence for **Surge and ESD suppressor** at **F2** without modifying the model under test.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The selected MOV/TVS/GDT/ESD variant uses a bounded nonlinear clamp or trigger relation with explicit leakage, breakdown, energy, and recovery behavior.
...
- `docs/tasks/models/cmp-switch-protection-surge-suppressor-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-SWP-SURGE_SUPPRESSOR-NOMINAL`, `GOLD-SWP-SURGE_SUPPRESSOR-BOUNDARY`, `GOLD-SWP-SURGE_SUPPRESSOR-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION`: shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-SURGE-SUPPRESSOR-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-switch-protection-surge-suppressor-mov`, `var-switch-protection-surge-suppressor-tvs`, `var-switch-protection-surge-suppressor-gdt`, `var-switch-protection-surge-suppressor-esd-clamp`, `F2`, and `VALIDATION`.
