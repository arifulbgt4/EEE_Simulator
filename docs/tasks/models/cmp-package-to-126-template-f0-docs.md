# CMP-PACKAGE-TO-126-TEMPLATE-F0-DOCS - Document TO-126 family package
...
- `docs/tasks/models/cmp-package-to-126-template-f0-docs.md`
...
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-DOCS-NOMINAL`
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-DOCS-BOUNDARY`
- `TEST-CMP-PACKAGE-TO-126-TEMPLATE-F0-DOCS-FAILURE`
