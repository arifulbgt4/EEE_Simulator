# CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT - Define import mapping for Resistor array
...
Implement and validate only the declared external-model mappings for **Resistor array**.
...
- Stable family: `fam-passives-resistor-array` (Resistor array); task scope: shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-passives-resistor-array-shared-f3-import.md`
...
- Scope is limited to `CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT`: shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`, fidelity `F3`, concern `IMPORT`, and requirements REQ-009, REQ-010, REQ-011, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037.
...
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-PASSIVES-RESISTOR-ARRAY-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-passives-resistor-array-isolated`, `var-passives-resistor-array-bussed`, `F3`, and `IMPORT`.
