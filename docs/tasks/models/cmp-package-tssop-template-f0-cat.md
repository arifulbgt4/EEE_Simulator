# CMP-PACKAGE-TSSOP-TEMPLATE-F0-CAT - Specify Thin shrink small-outline package package template
...
- Concern-specific golden references: GRC-051. `NUMERICAL_ACCURACY_TARGETS.md` defines comparison and evidence rules.
- This concern has no electrical model equation; geometry and numbering use the declarative package constraints only.

## Allowed files

- `docs/tasks/models/cmp-package-tssop-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-TSSOP-TEMPLATE-F0-CAT-FAILURE`
