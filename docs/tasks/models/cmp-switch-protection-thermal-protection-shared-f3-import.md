# CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F3-IMPORT - Define import mapping for Thermal protection
...
Implement and validate only the declared external-model mappings for **Thermal protection**.
...
- Stable family: `fam-switch-protection-thermal-protection` (Thermal protection); task scope: shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`; fidelity `F3`; concern `IMPORT`.
...
- `docs/tasks/models/cmp-switch-protection-thermal-protection-shared-f3-import.md`
...
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F3-IMPORT-NOMINAL`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F3-IMPORT-BOUNDARY`
- `TEST-CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F3-IMPORT-FAILURE`

## Acceptance

1. The exact output for `CMP-SWITCH-PROTECTION-THERMAL-PROTECTION-SHARED-F3-IMPORT` exists and is limited to shared family scope across `var-switch-protection-thermal-protection-thermal-fuse`, `var-switch-protection-thermal-protection-thermostat`, `F3`, and `IMPORT`.
