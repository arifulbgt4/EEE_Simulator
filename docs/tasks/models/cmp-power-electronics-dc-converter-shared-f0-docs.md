# CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS - Document DC converter
...
Publish user and contributor documentation for **DC converter** without changing its model, symbol, package, or validation behavior.
...
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-SYM`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-MODEL`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-VALIDATION`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F1-MODEL`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F1-VALIDATION`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F2-MODEL`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F2-VALIDATION`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-MODEL`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F3-VALIDATION`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-MODEL`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-VALIDATION`
- `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F4-THERMAL`
...
- Stable family: `fam-power-electronics-dc-converter` (DC converter); task scope: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`; fidelity `F0`; concern `DOCS`.
...
- This documentation concern introduces no equation. It publishes the core behavior supported by completed catalog, symbol, model, validation, thermal, and failure evidence for `fam-power-electronics-dc-converter`. Import mappings are planned extensions and remain explicitly unavailable/unclaimable until the separate IMPORT card is `Done`.
...
- `docs/tasks/models/cmp-power-electronics-dc-converter-shared-f0-docs.md`
...
- One evidence-backed final capability section in `families/fam-power-electronics-dc-converter.md` for `fam-power-electronics-dc-converter`, listing exact variants, tiers, analyses, packages, provenance, limitations, and task/test links.
...
- Scope is limited to `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS`: shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, fidelity `F0`, concern `DOCS`, and requirements REQ-009, REQ-010, REQ-014, REQ-015, REQ-016, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS-NOMINAL`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS-BOUNDARY`
- `TEST-CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS-FAILURE`

## Acceptance

1. The exact output for `CMP-POWER-ELECTRONICS-DC-CONVERTER-SHARED-F0-DOCS` exists and is limited to shared family scope across `var-power-electronics-dc-converter-buck`, `var-power-electronics-dc-converter-boost`, `var-power-electronics-dc-converter-buck-boost`, `var-power-electronics-dc-converter-flyback`, `var-power-electronics-dc-converter-forward`, `var-power-electronics-dc-converter-charge-pump`, `F0`, and `DOCS`.
