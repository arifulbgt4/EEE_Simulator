# CMP-PACKAGE-D2PAK-TEMPLATE-F0-VALIDATION - Validate D2PAK or TO-263 pin map and appearance
...
- `CMP-PACKAGE-D2PAK-TEMPLATE-F0-SYM`
- `PLAT-SYM-012`
- `PLAT-QA-001`
...
- `docs/tasks/models/cmp-package-d2pak-template-f0-validation.md`
...
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-VALIDATION-NOMINAL`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-VALIDATION-BOUNDARY`
- `TEST-CMP-PACKAGE-D2PAK-TEMPLATE-F0-VALIDATION-FAILURE`
