# CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-CAT - Specify Radial two-lead body package template
...
- `docs/tasks/models/cmp-package-radial-2-template-f0-cat.md`
...
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-CAT-NOMINAL`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-CAT-BOUNDARY`
- `TEST-CMP-PACKAGE-RADIAL-2-TEMPLATE-F0-CAT-FAILURE`
