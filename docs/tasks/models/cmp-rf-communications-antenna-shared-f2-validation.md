# CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION - Validate Antenna F2
...
Produce independent validation evidence for **Antenna** at **F2** without modifying the model under test.
...
- Stable family: `fam-rf-communications-antenna` (Antenna); task scope: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`; fidelity `F2`; concern `VALIDATION`.
...
- Candidate and independent reference must evaluate the same F2 rule: Behavioral/timing tier: preserve the family baseline using deterministic integer-tick state/event rules and explicit initialization: The antenna uses a declared port impedance/S-parameter plus radiation gain/pattern/polarization/efficiency profile over its validated frequency envelope.
...
- `docs/tasks/models/cmp-rf-communications-antenna-shared-f2-validation.md`
...
- One immutable candidate/reference evidence bundle for `GOLD-RFC-ANTENNA-NOMINAL`, `GOLD-RFC-ANTENNA-BOUNDARY`, `GOLD-RFC-ANTENNA-FAILURE` at `F2`, containing exact inputs, expected outputs, tolerance, versions, seed, and raw-result digests.
...
- Scope is limited to `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION`: shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, fidelity `F2`, concern `VALIDATION`, and requirements REQ-011, REQ-012, REQ-024, REQ-028, REQ-022, REQ-023, REQ-037, REQ-038.
...
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION-NOMINAL`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION-BOUNDARY`
- `TEST-CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION-FAILURE`

## Acceptance

1. The exact output for `CMP-RF-COMMUNICATIONS-ANTENNA-SHARED-F2-VALIDATION` exists and is limited to shared family scope across `var-rf-communications-antenna-dipole`, `var-rf-communications-antenna-monopole`, `var-rf-communications-antenna-patch`, `var-rf-communications-antenna-array`, `F2`, and `VALIDATION`.
