# VAL-GRC-033 - Validate ADC/DAC loop
...
| Golden fixture | GRC-033 |
| Test ID | TEST-GRC-033 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Quantization, reference scaling, latency** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-033.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-033 fixture row.
...
- Human-readable comparison covering: **Quantization, reference scaling, latency**.
