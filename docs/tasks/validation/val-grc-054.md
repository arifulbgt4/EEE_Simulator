# VAL-GRC-054 - Validate Dual schematic/physical project
...
|---|---|
| Status | Planned |
| Target | Dual schematic/physical project |
...
Produce independent, reproducible evidence for **Same component/model identity, nets and simulation results in both views** without changing the model or feature under test.
