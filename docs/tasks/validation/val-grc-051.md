# VAL-GRC-051 - Validate DIP and SOIC IC packages
...
|---|---|
| Status | Planned |
| Target | DIP and SOIC IC packages |
...
Produce independent, reproducible evidence for **Pin-1 mark, counter-clockwise numbering, dimensions, label placement and symbol/package pin equivalence** without changing the model or feature under test.
