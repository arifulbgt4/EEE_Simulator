...
| Golden fixture | GRC-029 |
| Test ID | TEST-GRC-029 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Set/reset/hold and invalid state** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-029.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-029 fixture row.
...
- Human-readable comparison covering: **Set/reset/hold and invalid state**.
