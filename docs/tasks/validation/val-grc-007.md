...
| Golden fixture | GRC-007 |
| Test ID | TEST-GRC-007 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Current rise, inductor voltage, stored energy** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-007.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-007 fixture row.
...
- Human-readable comparison covering: **Current rise, inductor voltage, stored energy**.
