# VAL-GRC-045 - Validate RTL differential model
...
|---|---|
| Status | Planned |
| Target | RTL differential model |
| Requirements | REQ-001, REQ-026, REQ-027 |
| Golden fixture | GRC-045 |
| Test ID | TEST-GRC-045 |
| Release | R9 |
...
Produce independent, reproducible evidence for **Gate/event model versus Verilated model** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-045.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-045 fixture row.
...
- Human-readable comparison covering: **Gate/event model versus Verilated model**.
