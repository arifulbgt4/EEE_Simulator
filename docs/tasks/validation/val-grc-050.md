# VAL-GRC-050 - Validate Capacitor, diode, LED and transistor physical set
...
|---|---|
| Status | Planned |
| Target | Capacitor, diode, LED and transistor physical set |
...
Produce independent, reproducible evidence for **Polarity/orientation marks, recognizable bodies, lead count and pin labels** without changing the model or feature under test.
