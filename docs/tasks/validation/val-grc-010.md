# VAL-GRC-010 - Validate Transmission-line termination
...
|---|---|
| Status | Planned |
| Target | Transmission-line termination |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-010 |
| Test ID | TEST-GRC-010 |
| Release | R7 |
...
Produce independent, reproducible evidence for **Delay and reflection coefficient** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-010.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-010 fixture row.
...
- Human-readable comparison covering: **Delay and reflection coefficient**.
