# VAL-GRC-018 - Validate Op-amp buffer and inverting amplifier
...
|---|---|
| Status | Planned |
| Target | Op-amp buffer and inverting amplifier |
| Requirements | REQ-009, REQ-010, REQ-011, REQ-014, REQ-017 |
| Golden fixture | GRC-018 |
| Test ID | TEST-GRC-018 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Gain, clipping, slew rate, input/output limits** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-018.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-018 fixture row.
...
- Human-readable comparison covering: **Gain, clipping, slew rate, input/output limits**.
