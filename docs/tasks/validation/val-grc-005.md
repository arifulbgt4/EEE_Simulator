# VAL-GRC-005 - Validate Battery with internal resistance
...
|---|---|
| Status | Planned |
| Target | Battery with internal resistance |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-005 |
| Test ID | TEST-GRC-005 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Open-circuit voltage, loaded voltage, power split** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-005.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-005 fixture row.
...
- Human-readable comparison covering: **Open-circuit voltage, loaded voltage, power split**.
