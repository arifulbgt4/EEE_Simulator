# VAL-GRC-042 - Validate Four-bit ALU
...
| Golden fixture | GRC-042 |
| Test ID | TEST-GRC-042 |
| Release | R8 |
...
Produce independent, reproducible evidence for **Arithmetic, flags, logic, exhaustive vectors** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-042.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-042 fixture row.
...
- Human-readable comparison covering: **Arithmetic, flags, logic, exhaustive vectors**.
