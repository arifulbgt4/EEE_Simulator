# VAL-GRC-034 - Validate Analog/digital threshold adapter
...
|---|---|
| Status | Planned |
| Target | Analog/digital threshold adapter |
| Requirements | REQ-001, REQ-018, REQ-019, REQ-020, REQ-021 |
| Golden fixture | GRC-034 |
| Test ID | TEST-GRC-034 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Threshold band, hysteresis, loading, simultaneous event** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-034.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-034 fixture row.
...
- Human-readable comparison covering: **Threshold band, hysteresis, loading, simultaneous event**.
