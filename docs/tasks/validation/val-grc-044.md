# VAL-GRC-044 - Validate Eight-bit computer
...
|---|---|
| Status | Planned |
| Target | Eight-bit computer |
| Requirements | REQ-026, REQ-027 |
| Golden fixture | GRC-044 |
| Test ID | TEST-GRC-044 |
| Release | R9 |
...
Produce independent, reproducible evidence for **Program, bus, RAM/ROM, timer, UART and display** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-044.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-044 fixture row.
...
- Human-readable comparison covering: **Program, bus, RAM/ROM, timer, UART and display**.
