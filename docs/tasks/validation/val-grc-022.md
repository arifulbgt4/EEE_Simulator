# VAL-GRC-022 - Validate MOSFET thermal runaway
...
|---|---|
| Status | Planned |
| Target | MOSFET thermal runaway |
| Requirements | REQ-013, REQ-014, REQ-015, REQ-016 |
| Golden fixture | GRC-022 |
| Test ID | TEST-GRC-022 |
| Release | R4 |
...
Produce independent, reproducible evidence for **Rds(on), leakage, junction temperature feedback** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-022.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-022 fixture row.
...
- Human-readable comparison covering: **Rds(on), leakage, junction temperature feedback**.
