# VAL-GRC-031 - Validate Counter and shift register
...
|---|---|
| Status | Planned |
| Target | Counter and shift register |
| Requirements | REQ-018, REQ-019, REQ-020, REQ-021 |
| Golden fixture | GRC-031 |
| Test ID | TEST-GRC-031 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Sequential state and reset behavior** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-031.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-031 fixture row.
...
- Human-readable comparison covering: **Sequential state and reset behavior**.
