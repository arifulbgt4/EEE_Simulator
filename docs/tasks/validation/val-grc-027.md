# VAL-GRC-027 - Validate Primitive gate truth tables
...
Produce independent, reproducible evidence for **0/1/X/Z, delay, drive strength** without changing the model or feature under test.
...
- Human-readable comparison covering: **0/1/X/Z, delay, drive strength**.
