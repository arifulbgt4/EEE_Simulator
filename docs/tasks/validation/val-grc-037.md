# VAL-GRC-037 - Validate Load-cell bridge and amplifier
...
|---|---|
| Status | Planned |
| Target | Load-cell bridge and amplifier |
| Requirements | REQ-022, REQ-023, REQ-024 |
| Golden fixture | GRC-037 |
| Test ID | TEST-GRC-037 |
| Release | R7 |
...
Produce independent, reproducible evidence for **Force transfer, offset, saturation** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-037.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-037 fixture row.
...
- Human-readable comparison covering: **Force transfer, offset, saturation**.
