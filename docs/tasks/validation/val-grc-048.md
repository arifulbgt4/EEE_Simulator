# VAL-GRC-048 - Validate GPU compute kernel
...
|---|---|
| Status | Planned |
| Target | GPU compute kernel |
| Requirements | REQ-028 |
| Golden fixture | GRC-048 |
| Test ID | TEST-GRC-048 |
| Release | R13 |
...
Produce independent, reproducible evidence for **Functional output, cycle counters and bandwidth limits** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-048.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-048 fixture row.
...
- Human-readable comparison covering: **Functional output, cycle counters and bandwidth limits**.
