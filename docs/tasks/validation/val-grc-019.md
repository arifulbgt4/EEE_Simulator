# VAL-GRC-019 - Validate Comparator with hysteresis
...
|---|---|
| Status | Planned |
| Target | Comparator with hysteresis |
| Requirements | REQ-009, REQ-010, REQ-011, REQ-014, REQ-017 |
| Golden fixture | GRC-019 |
| Test ID | TEST-GRC-019 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Thresholds, state memory, propagation delay** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-019.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-019 fixture row.
...
- Human-readable comparison covering: **Thresholds, state memory, propagation delay**.
