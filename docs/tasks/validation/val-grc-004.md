# VAL-GRC-004 - Validate VCVS/VCCS/CCVS/CCCS set
...
|---|---|
| Status | Planned |
| Target | VCVS/VCCS/CCVS/CCCS set |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-004 |
| Test ID | TEST-GRC-004 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Gain/transresistance/transconductance and control polarity** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-004.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-004 fixture row.
...
- Human-readable comparison covering: **Gain/transresistance/transconductance and control polarity**.
