# VAL-GRC-014 - Validate LED resistor circuit
...
|---|---|
| Status | Planned |
| Target | LED resistor circuit |
| Requirements | REQ-009, REQ-010, REQ-011, REQ-014, REQ-017, REQ-036 |
| Golden fixture | GRC-014 |
| Test ID | TEST-GRC-014 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Current, optical indicator state, thermal power** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-014.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-014 fixture row.
...
- Human-readable comparison covering: **Current, optical indicator state, thermal power**.
