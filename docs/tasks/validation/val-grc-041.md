# VAL-GRC-041 - Validate One-bit memory and register
...
|---|---|
| Status | Planned |
| Target | One-bit memory and register |
| Requirements | REQ-025, REQ-036 |
| Golden fixture | GRC-041 |
| Test ID | TEST-GRC-041 |
| Release | R6 |
...
Produce independent, reproducible evidence for **Store, retain, read and reset** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-041.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-041 fixture row.
...
- Human-readable comparison covering: **Store, retain, read and reset**.
