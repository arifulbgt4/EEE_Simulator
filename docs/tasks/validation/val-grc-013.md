# VAL-GRC-013 - Validate Half-wave and bridge rectifier
...
|---|---|
| Status | Planned |
| Target | Half-wave and bridge rectifier |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011, REQ-014, REQ-017, REQ-036 |
| Golden fixture | GRC-013 |
| Test ID | TEST-GRC-013 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Conduction intervals, ripple, diode stress** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-013.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-013 fixture row.
...
- Human-readable comparison covering: **Conduction intervals, ripple, diode stress**.
