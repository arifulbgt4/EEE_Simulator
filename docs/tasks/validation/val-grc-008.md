# VAL-GRC-008 - Validate Series and parallel RLC
...
|---|---|
| Status | Planned |
| Target | Series and parallel RLC |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-008 |
| Test ID | TEST-GRC-008 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Resonance, damping, gain, phase** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-008.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-008 fixture row.
...
- Human-readable comparison covering: **Resonance, damping, gain, phase**.
