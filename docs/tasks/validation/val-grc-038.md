# VAL-GRC-038 - Validate DC motor startup
...
|---|---|
| Status | Planned |
| Target | DC motor startup |
| Requirements | REQ-022, REQ-023, REQ-024 |
| Golden fixture | GRC-038 |
| Test ID | TEST-GRC-038 |
| Release | R7 |
...
Produce independent, reproducible evidence for **Inrush, acceleration, back-EMF, stall** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-038.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-038 fixture row.
...
- Human-readable comparison covering: **Inrush, acceleration, back-EMF, stall**.
