# VAL-GRC-001 - Validate DC source and resistor
...
|---|---|
| Status | Planned |
| Target | DC source and resistor |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-001 |
| Test ID | TEST-GRC-001 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Ohm's law, branch current, resistor power** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-001.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-001 fixture row.
...
- Human-readable comparison covering: **Ohm's law, branch current, resistor power**.
