# VAL-GRC-023 - Validate Buck converter
...
|---|---|
| Status | Planned |
| Target | Buck converter |
| Requirements | REQ-013, REQ-014, REQ-015, REQ-016 |
| Golden fixture | GRC-023 |
| Test ID | TEST-GRC-023 |
| Release | R7 |
...
Produce independent, reproducible evidence for **Regulation, ripple, switching loss, efficiency** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-023.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-023 fixture row.
...
- Human-readable comparison covering: **Regulation, ripple, switching loss, efficiency**.
