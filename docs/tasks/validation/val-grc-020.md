# VAL-GRC-020 - Validate 555 astable
...
| Golden fixture | GRC-020 |
| Test ID | TEST-GRC-020 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Frequency, duty cycle, startup** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-020.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-020 fixture row.
...
- Human-readable comparison covering: **Frequency, duty cycle, startup**.
