# VAL-GRC-035 - Validate 6T SRAM cell
...
| Status | Planned |
| Target | 6T SRAM cell |
| Requirements | REQ-018, REQ-019, REQ-020, REQ-021, REQ-025 |
| Golden fixture | GRC-035 |
| Test ID | TEST-GRC-035 |
| Release | R8 |
...
Produce independent, reproducible evidence for **Read, write, hold, noise margin** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-035.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-035 fixture row.
...
- Human-readable comparison covering: **Read, write, hold, noise margin**.
