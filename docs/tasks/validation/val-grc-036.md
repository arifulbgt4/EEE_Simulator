# VAL-GRC-036 - Validate Thermistor divider
...
|---|---|
| Status | Planned |
| Target | Thermistor divider |
| Requirements | REQ-022, REQ-023, REQ-024 |
| Golden fixture | GRC-036 |
| Test ID | TEST-GRC-036 |
| Release | R7 |
...
Produce independent, reproducible evidence for **Temperature-to-voltage transfer and self-heating** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-036.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-036 fixture row.
...
- Human-readable comparison covering: **Temperature-to-voltage transfer and self-heating**.
