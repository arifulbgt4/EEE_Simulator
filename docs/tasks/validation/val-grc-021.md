# VAL-GRC-021 - Validate Overrated resistor
...
|---|---|
| Status | Planned |
| Target | Overrated resistor |
| Requirements | REQ-013, REQ-014, REQ-015, REQ-016, REQ-036 |
| Golden fixture | GRC-021 |
| Test ID | TEST-GRC-021 |
| Release | R4 |
...
Produce independent, reproducible evidence for **Temperature rise, derating warning, open/short injection** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-021.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-021 fixture row.
...
- Human-readable comparison covering: **Temperature rise, derating warning, open/short injection**.
