# VAL-GRC-011 - Validate Forward and reverse diode sweep
...
|---|---|
| Status | Planned |
| Target | Forward and reverse diode sweep |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011, REQ-014, REQ-017 |
| Golden fixture | GRC-011 |
| Test ID | TEST-GRC-011 |
| Release | R3 |
...
Produce independent, reproducible evidence for **I-V curve, leakage, temperature trend** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-011.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-011 fixture row.
...
- Human-readable comparison covering: **I-V curve, leakage, temperature trend**.
