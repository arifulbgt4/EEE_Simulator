# VAL-GRC-002 - Validate Two-resistor divider
...
|---|---|
| Status | Planned |
| Target | Two-resistor divider |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011 |
| Golden fixture | GRC-002 |
| Test ID | TEST-GRC-002 |
| Release | R2 |
...
Produce independent, reproducible evidence for **Node voltage, source power, load effect** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-002.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-002 fixture row.
...
- Human-readable comparison covering: **Node voltage, source power, load effect**.
