# VAL-GRC-049 - Validate Resistor package physical set
...
|---|---|
| Status | Planned |
| Target | Resistor package physical set |
| Requirements | REQ-037 |
| Golden fixture | GRC-049 |
| Test ID | TEST-GRC-049 |
| Release | R1 |
...
Produce independent, reproducible evidence for **axial and SMD body proportions, lead/contact style, color-band/value-code and tolerance mapping, rotation and scale** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-049.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-049 fixture row.
...
- Human-readable comparison covering: **Body proportions, lead style, color-band value/tolerance mapping, rotation and scale**.
