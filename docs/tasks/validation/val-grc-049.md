# VAL-GRC-049 - Validate Axial resistor physical view
...
|---|---|
| Status | Planned |
| Target | Axial resistor physical view |
...
Produce independent, reproducible evidence for **Body proportions, lead style, color-band value/tolerance mapping, rotation and scale** without changing the model or feature under test.
