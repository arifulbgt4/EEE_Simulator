# VAL-GRC-012 - Validate Zener regulator
...
|---|---|
| Status | Planned |
| Target | Zener regulator |
| Requirements | REQ-008, REQ-009, REQ-010, REQ-011, REQ-014, REQ-017 |
| Golden fixture | GRC-012 |
| Test ID | TEST-GRC-012 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Breakdown voltage, dynamic resistance, power** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-012.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-012 fixture row.
...
- Human-readable comparison covering: **Breakdown voltage, dynamic resistance, power**.
