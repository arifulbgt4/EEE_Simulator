# VAL-GRC-006 - Validate RC charge/discharge
...
Produce independent, reproducible evidence for **Time constant and sampled waveform** without changing the model or feature under test.
...
- Human-readable comparison covering: **Time constant and sampled waveform**.
