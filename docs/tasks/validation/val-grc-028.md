# VAL-GRC-028 - Validate NAND ring oscillator
...
|---|---|
| Status | Planned |
| Target | NAND ring oscillator |
| Requirements | REQ-018, REQ-019, REQ-020, REQ-021, REQ-036 |
| Golden fixture | GRC-028 |
| Test ID | TEST-GRC-028 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Event order, oscillation, delay accumulation** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-028.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-028 fixture row.
...
- Human-readable comparison covering: **Event order, oscillation, delay accumulation**.
