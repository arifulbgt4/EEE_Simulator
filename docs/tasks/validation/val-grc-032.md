# VAL-GRC-032 - Validate Half and full adder
...
|---|---|
| Status | Planned |
| Target | Half and full adder |
| Requirements | REQ-018, REQ-019, REQ-020, REQ-021, REQ-036 |
| Golden fixture | GRC-032 |
| Test ID | TEST-GRC-032 |
| Release | R5 |
...
Produce independent, reproducible evidence for **Exhaustive truth table and carry propagation** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-032.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-032 fixture row.
...
- Human-readable comparison covering: **Exhaustive truth table and carry propagation**.
