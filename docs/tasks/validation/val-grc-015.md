# VAL-GRC-015 - Validate BJT common-emitter stage
...
|---|---|
| Status | Planned |
| Target | BJT common-emitter stage |
| Requirements | REQ-009, REQ-010, REQ-011, REQ-014, REQ-017 |
| Golden fixture | GRC-015 |
| Test ID | TEST-GRC-015 |
| Release | R3 |
...
Produce independent, reproducible evidence for **Bias point, gain, cutoff, saturation** without changing the model or feature under test.
...
- `docs/tasks/validation/val-grc-015.md`
...
- This card, `docs/tasks/validation/INDEX.md`, `docs/quality/test-registry.yaml`, and the GRC-015 fixture row.
...
- Human-readable comparison covering: **Bias point, gain, cutoff, saturation**.
