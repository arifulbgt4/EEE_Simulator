...
- A complete implementation and evidence package for: **Implement unsupported syntax and security diagnostics**.
...
1. The task's single outcome is observable and conforms to REQ-024, REQ-032 and the relevant architecture contract.
