# PLAT-API-014 - Validate worker loss and duplicate-delivery recovery
...
| Concern | `validate_worker_loss_and_duplicate_delivery_recovery` |
| Effort | S |
| Depends on | PLAT-API-013 |

## Objective

Validate worker loss and duplicate-delivery recovery. Deliver one reviewable outcome that satisfies the named requirements without expanding into adjacent concerns.
