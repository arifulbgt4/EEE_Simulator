...
- A complete implementation and evidence package for: **Implement package-aware breadboard placement and pin mapping**.
...
1. The task's single outcome is observable and conforms to REQ-004, REQ-005, REQ-037, REQ-038 and the relevant architecture contract.
