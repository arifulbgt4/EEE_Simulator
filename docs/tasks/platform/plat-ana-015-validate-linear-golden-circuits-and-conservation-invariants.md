...
- A complete implementation and evidence package for: **Validate linear golden circuits and conservation invariants**.
...
1. The task's single outcome is observable and conforms to REQ-008, REQ-009, REQ-010, REQ-029, REQ-033 and the relevant architecture contract.
