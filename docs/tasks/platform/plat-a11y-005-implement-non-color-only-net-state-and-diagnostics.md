# PLAT-A11Y-005 - Implement non-color-only net state and diagnostics
...
| Concern | `implement_non_color_only_net_state_and_diagnostics` |
| Effort | S |
| Depends on | PLAT-A11Y-004 |

## Objective

Implement non-color-only net state and diagnostics. Deliver one reviewable outcome that satisfies the named requirements without expanding into adjacent concerns.
