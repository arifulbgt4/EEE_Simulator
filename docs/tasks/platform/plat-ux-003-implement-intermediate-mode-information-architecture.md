...
- A complete implementation and evidence package for: **Implement Intermediate mode information architecture**.
...
1. The task's single outcome is observable and conforms to REQ-003, REQ-034 and the relevant architecture contract.
