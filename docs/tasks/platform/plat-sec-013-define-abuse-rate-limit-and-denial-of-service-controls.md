...
- A complete implementation and evidence package for: **Define abuse rate-limit and denial-of-service controls**.
...
1. The task's single outcome is observable and conforms to REQ-032, REQ-035 and the relevant architecture contract.
