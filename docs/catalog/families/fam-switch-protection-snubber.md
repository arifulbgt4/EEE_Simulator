...
|---|---|---|---|---|
| `var-switch-protection-snubber-rc` | Rc | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-snubber-rcd` | Rcd | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
