...
|---|---|---|---|---|
| `var-switch-protection-analog-switch-spst` | Spst | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-analog-switch-spdt` | Spdt | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-analog-switch-multiplexer` | Multiplexer | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
