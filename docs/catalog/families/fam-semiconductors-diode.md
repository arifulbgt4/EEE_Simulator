...
| `var-semiconductors-diode-tvs` | Tvs | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-diode`, `pkg-custom-parametric` |
| `var-semiconductors-diode-varactor` | Varactor | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-diode`, `pkg-custom-parametric` |
| `var-semiconductors-diode-pin` | Pin | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-diode`, `pkg-custom-parametric` |
| `var-semiconductors-diode-tunnel` | Tunnel | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-diode`, `pkg-custom-parametric` |
