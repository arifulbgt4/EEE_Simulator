...
| `var-passives-resistor-thick-film` | Thick Film | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-chip`, `pkg-radial-2` |
| `var-passives-resistor-current-sense` | Current Sense | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-axial-2`, `pkg-smd-chip`, `pkg-radial-2` |
