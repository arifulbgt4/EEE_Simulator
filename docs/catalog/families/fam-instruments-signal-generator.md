...
| `var-instruments-signal-generator-arbitrary-waveform` | Arbitrary Waveform | F0, F1, F2 | Realistic Electronics MVP | `pkg-virtual` |
| `var-instruments-signal-generator-clock-pattern` | Clock Pattern | F0, F1, F2 | Realistic Electronics MVP | `pkg-virtual` |
