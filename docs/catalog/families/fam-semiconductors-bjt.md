...
| `var-semiconductors-bjt-darlington-npn` | Darlington Npn | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-sot-23`, `pkg-to-92`, `pkg-to-220`, `pkg-qfn`, `pkg-custom-parametric` |
| `var-semiconductors-bjt-darlington-pnp` | Darlington Pnp | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-sot-23`, `pkg-to-92`, `pkg-to-220`, `pkg-qfn`, `pkg-custom-parametric` |
...
|---|---|---|---|
| `C` | passive | Collector | electrical, optical, thermal |
| `B` | input | Base | electrical, optical, thermal |
| `E` | passive | Emitter | electrical, optical, thermal |
