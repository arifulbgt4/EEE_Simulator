...
|---|---|---|---|---|
| `var-switch-protection-fuse-fast-blow` | Fast Blow | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-fuse-slow-blow` | Slow Blow | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-fuse-ptc-resettable` | Ptc Resettable | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
