...
- **Family ID:** `fam-connectors-cables-connector`
...
Connector is the canonical family for the variants listed below. The family boundary is behavioral: package, color, marking, tolerance, and vendor model choices do not create a new electrical family. Vendor-specific parts bind to a variant and an importable model.

## Aliases

Search aliases are **Connector**, **Connector**, and `connector`. Variant names are also aliases. Aliases never replace stable IDs.

## Variants

| Stable variant ID | Display name | Model tiers | Release target | Compatible package profiles |
|---|---|---|---|---|
| `var-connectors-cables-connector-pin-header` | Pin Header | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-terminal-block` | Terminal Block | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-usb-a` | Usb A | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-usb-c` | Usb C | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-rj45` | Rj45 | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-bnc` | Bnc | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-d-sub` | D Sub | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-jst-style` | Jst Style | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-molex-style` | Molex Style | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-barrel` | Barrel | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-banana` | Banana | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
| `var-connectors-cables-connector-edge-card` | Edge Card | F0, F1, F3 | Post-MVP catalog | `pkg-connector-parametric`, `pkg-cable-parametric`, `pkg-custom-parametric` |
...
- Symbol ID: `sym-connectors-cables-connector`. The artwork is original project work aligned with familiar IEC/ANSI conventions; IEC 60617 artwork must not be copied.
...
- `GOLD-CAB-CONNECTOR-NOMINAL`: nominal positive-path behavior.
- `GOLD-CAB-CONNECTOR-BOUNDARY`: declared parameter and operating boundaries.
- `GOLD-CAB-CONNECTOR-FAILURE`: diagnostic and fault behavior.
