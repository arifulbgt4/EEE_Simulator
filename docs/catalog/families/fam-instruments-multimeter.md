...
| `var-instruments-multimeter-bench` | Bench | F0, F1, F2 | Realistic Electronics MVP | `pkg-virtual` |
| `var-instruments-multimeter-clamp` | Clamp | F0, F1, F2 | Realistic Electronics MVP | `pkg-virtual` |
