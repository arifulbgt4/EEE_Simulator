...
- **Family ID:** `fam-sensors-environment-temperature-sensor`
...
Temperature sensor is the canonical family for the variants listed below. The family boundary is behavioral: package, color, marking, tolerance, and vendor model choices do not create a new electrical family. Vendor-specific parts bind to a variant and an importable model.

## Aliases

Search aliases are **Temperature sensor**, **Temperature Sensor**, and `temperature-sensor`. Variant names are also aliases. Aliases never replace stable IDs.

## Variants

| Stable variant ID | Display name | Model tiers | Release target | Compatible package profiles |
|---|---|---|---|---|
| `var-sensors-environment-temperature-sensor-thermocouple` | Thermocouple | F0, F1, F2, F3, F4 | Post-MVP catalog | `pkg-sensor-module`, `pkg-sot-23`, `pkg-qfn`, `pkg-custom-parametric` |
| `var-sensors-environment-temperature-sensor-rtd` | Rtd | F0, F1, F2, F3, F4 | Post-MVP catalog | `pkg-sensor-module`, `pkg-sot-23`, `pkg-qfn`, `pkg-custom-parametric` |
| `var-sensors-environment-temperature-sensor-thermistor-probe` | Thermistor Probe | F0, F1, F2, F3, F4 | Post-MVP catalog | `pkg-sensor-module`, `pkg-sot-23`, `pkg-qfn`, `pkg-custom-parametric` |
| `var-sensors-environment-temperature-sensor-integrated-temperature` | Integrated Temperature | F0, F1, F2, F3, F4 | Post-MVP catalog | `pkg-sensor-module`, `pkg-sot-23`, `pkg-qfn`, `pkg-custom-parametric` |
...
- Symbol ID: `sym-sensors-environment-temperature-sensor`. The artwork is original project work aligned with familiar IEC/ANSI conventions; IEC 60617 artwork must not be copied.
...
- `GOLD-SEN-TEMPERATURE_SENSOR-NOMINAL`: nominal positive-path behavior.
- `GOLD-SEN-TEMPERATURE_SENSOR-BOUNDARY`: declared parameter and operating boundaries.
- `GOLD-SEN-TEMPERATURE_SENSOR-FAILURE`: diagnostic and fault behavior.
