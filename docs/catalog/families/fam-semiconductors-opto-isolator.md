...
|---|---|---|---|---|
| `var-semiconductors-opto-isolator-phototransistor-output` | Phototransistor Output | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-sot-23`, `pkg-to-92`, `pkg-to-220`, `pkg-qfn`, `pkg-custom-parametric` |
| `var-semiconductors-opto-isolator-triac-output` | Triac Output | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-sot-23`, `pkg-to-92`, `pkg-to-220`, `pkg-qfn`, `pkg-custom-parametric` |
