...
|---|---|---|---|---|
| `var-passives-coupled-inductor-two-winding` | Two Winding | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-radial-2`, `pkg-custom-parametric` |
| `var-passives-coupled-inductor-multi-winding` | Multi Winding | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-radial-2`, `pkg-custom-parametric` |
