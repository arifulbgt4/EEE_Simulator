...
|---|---|---|---|---|
| `var-switch-protection-transmission-gate-cmos` | Cmos | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-transmission-gate-bidirectional` | Bidirectional | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
