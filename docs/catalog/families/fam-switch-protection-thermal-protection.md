...
|---|---|---|---|---|
| `var-switch-protection-thermal-protection-thermal-fuse` | Thermal Fuse | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
| `var-switch-protection-thermal-protection-thermostat` | Thermostat | F0, F1, F2, F3, F4 | Realistic Electronics MVP | `pkg-custom-parametric` |
